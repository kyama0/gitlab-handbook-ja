...
## タスク A. Auto DevOps を使った新しい Node JS Express プロジェクトを作成する {#task-a-create-a-new-node-js-express-project-with-auto-devops}
...
## タスク B. 変更をコミットしてパイプラインの実行をトリガーする {#task-b-commit-a-change-to-trigger-a-pipeline-run}
