...
## タスク A. Training Group にアクセスする {#task-a-access-your-training-group}
...
## タスク B. プロジェクトを作成する {#task-b-create-a-project}
...
## タスク C. Issue を作成する {#task-c-create-an-issue}
...
## タスク D. カスタムラベルを作成する {#task-d-create-custom-labels}
...
## タスク E. Issue にラベルを割り当てる {#task-e-assign-labels-to-an-issue}
...
## タスク F. クイックアクションを使う {#task-f-use-a-quick-action}
