...
1. Example Component プロジェクトのリポジトリで **+** ボタンをクリックし、**New Directory** オプションをクリックします。
...
1. すべてのコンポーネントにはプロジェクトの説明が必要です。プロジェクトの説明セクションに「This component is an example component, and is meant for demonstration purposes only.」と入力します。
...
1. Example Component プロジェクトのリポジトリで **+** ボタンをクリックし、**New File** オプションをクリックします。
...
1. **Example component** コンポーネントをクリックします。このコンポーネントはあなただけに表示されます。
...
1. ページの左上の Tanuki ロゴをクリックして CI/CD プロジェクトに移動し、プロジェクト名をクリックします。
