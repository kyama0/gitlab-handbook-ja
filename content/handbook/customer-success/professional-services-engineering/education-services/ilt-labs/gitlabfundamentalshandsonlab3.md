...
1. 左サイドバーで **Settings** を選択します。表示されたドロップダウンリストから **General** を選択します。
...
変更をコミットすると、ファイルが表示されます。これにより、プロジェクトに新しいブランチが作成されました。メインブランチに戻るには、現在 **test-commit** と表示されているドロップダウンリストを選択します。このドロップダウンリストから **main** を選択してメインブランチに戻ります。
