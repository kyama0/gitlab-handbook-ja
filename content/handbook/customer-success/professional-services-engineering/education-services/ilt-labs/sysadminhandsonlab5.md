...
1. GitLab の Prometheus サーバーには TCP ポート 9090 で接続できます。残念ながら、トレーニング環境では現在そのポートへのインバウンドトラフィックがブロックされています。回避策として、次のように SSH トンネルを開くことができます。
...
1. **Outline** の横のドロップダウンリストで **Loki** が選択されていることを確認します。
