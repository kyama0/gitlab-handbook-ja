...
## タスク A. 新しいプロジェクトを作成し、CI/CD 設定ファイルを追加する {#task-a-create-a-new-project-and-add-a-cicd-configuration-file}
...
## タスク B. CI/CD パイプラインを確認する {#task-b-inspect-the-cicd-pipeline}
