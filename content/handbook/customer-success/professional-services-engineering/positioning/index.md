...
彼らは現在のツールを最高レベルで管理するチームを持っており、しばしば SDLC ツールの独自の（より制限の少ない）インスタンスを設定するシャドー IT と競合しています。このチームはおそらく大規模なマイグレーションを管理したことがなく、ロールアウト計画の支援を必要とします。彼らのエンジニアリングチーム（GitLab のエンドユーザー）は、最新の git と GitLab のベストプラクティスに関する知識レベルにばらつきがあります。
