---
title: "GitLab Certified Trainer プログラム"
description: "GitLab がエデュケーションサービスオファリングをデリバリーするためのトレーナーの準備を検証する仕組みを紹介します。"
upstream_path: /handbook/customer-success/professional-services-engineering/gitlab-certified-trainer-process/
upstream_sha: b4eeb07f0d5f46e2fc5f8572be1a2547261aed89
translated_at: "2026-04-26T03:00:00Z"
translator: claude
stale: false
lastmod: "2025-11-21T08:01:26-05:00"
---

## GitLab Certified Trainer

GitLab の学習オファリングの提供キャパシティをスケールできるよう、[GitLab エデュケーションサービス](/handbook/customer-success/professional-services-engineering/education-services/) は、GitLab のスタンダードな Instructor-Led Training（ILT）コースをデリバリーしたい個人向けに認定パスウェイを提供しています。このプログラムは現在、GitLab チームメンバーおよび選定された [GitLab Certified Services Partners](/handbook/resellers/services/) が利用できます。スタンダード ILT コース用の GitLab Train the Trainer（TtT）オプションを注文した顧客は、このプログラムへの参加をリクエストできます。
...
GitLab エデュケーションサービスは、すべてのトレーナーが [エデュケーションサービスオファリング](https://about.gitlab.com/services/education/) をデリバリーするための準備を検証する認定プロセスを管理しています。特定のコースに対する GitLab Certified Trainer 認定を取得するために必要なステップは次のとおりです。
