...
upstream_path: /handbook/customer-success/professional-services-engineering/technical-architect/
upstream_sha: b4eeb07f0d5f46e2fc5f8572be1a2547261aed89
translated_at: "2026-04-26T03:00:00Z"
translator: claude
stale: false
lastmod: "2024-10-28T15:30:12+00:00"
---
...
TA チームは、[MEDDPICC](/handbook/sales/meddppicc/) セールスクオリフィケーション方法論に従って技術セールスをアカウントチーム（例: Account Executive、Solution Architect、Customer Success Manager、Engagement Manager）に支援し、スコーピングプロセス中の信頼できるアドバイザーとして機能します。また、Engagement Manager に対し、Customer Journey から完全なプラットフォーム採用までを強化する戦略的な技術ソリューションを提供します。

## Engagement Manager への専門技術支援

**技術ガイダンスとソリューション設計:**

- [Customer Journey](/handbook/customer-success/customer-success-vision/#high-level-visual-of-gitlab-adoption-journey) を理解する
...
1. Engagement Manager (EM) が TA とエンゲージするには、SFDC の Opportunity とスコーピング Issue が作成されている必要があります。さらに、スコーピング Issue で、EM は `current customer pain points` と `technical or organizational constraints` を明確に説明できなければなりません。これらが揃っていない場合、TA は内部または顧客対面のコールに参加する前に、この情報を収集するよう EM に押し戻すことができます。
...
- 少なくとも 1 営業日前までに、[PS and Sales team mapping](https://docs.google.com/document/d/1sdehii3Eqp_CiYsGT3dDb0nKbbtwpxKQlni7t3ZgfCs/edit#heading=h.1er41qhhpoj5) を使用してアサインされた TA に連絡する。
...
- Delivery 中に [Delivery Kits](https://gitlab.com/gitlab-org/professional-services-automation/delivery-kits) がイテレートされることを確実にする。
- PMO と協力して、プロジェクトステータスが Delivery [Methodology](https://gitlab.com/gitlab-com/customer-success/professional-services-group/ps-leadership-team/ps-delivery-methodology/-/wikis/home) に沿って最新であることを確実にする。
