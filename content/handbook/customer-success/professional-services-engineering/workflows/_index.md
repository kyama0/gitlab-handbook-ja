---
title: "プロフェッショナルサービスエンジニアリングのワークフロー"
upstream_path: /handbook/customer-success/professional-services-engineering/workflows/
...
1. プロフェッショナルサービスマネージャー: SOW が承認されて Closed Won に移行したら、プロフェッショナルサービスエンジニアをアサインします。
...
1. プロフェッショナルサービスエンジニア: ここで定義されているプロセスに沿ってプロジェクトを開始します。
    ...
    - プロジェクトサマリー
1. プロフェッショナルサービスエンジニア: 財務面のクロージングプロセスを開始します。
1. プロフェッショナルサービスマネージャー: [ブレームレスなポストモーテム](/handbook/customer-success/professional-services-engineering/workflows/internal/root-cause-analysis)をスケジュールします。

## 見積もりからサインオフまでのプロセス

これは、顧客のニーズの発見から顧客によるサインオフに至るまでの、サービスエンゲージメント全体のプロセスの概要です。

[プロフェッショナルサービスのビジネスオペレーション](/handbook/customer-success/professional-services-engineering/workflows/internal/biz-ops)を参照してください。
