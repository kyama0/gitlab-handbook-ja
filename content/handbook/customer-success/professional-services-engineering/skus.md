---
title: "PS 標準 SKU"
description: "GitLab プロフェッショナルサービスの標準 SKU を紹介します。"
upstream_path: /handbook/customer-success/professional-services-engineering/skus/
...
<p class="my-3 text-sm text-gray-600 italic">SKU テーブルは <a href="https://handbook.gitlab.com/handbook/customer-success/professional-services-engineering/skus/#skus" rel="external noopener">原文 (英語)</a> を参照してください。</p>
...
エデュケーションリクエストを送信するには、[新しい Issue を作成](https://gitlab.com/gitlab-com/customer-success/professional-services-group/education-services/-/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D=) し、**education-request** テンプレートを選択して必要な詳細を記入してください。
