...
1. Gainsight にログインしてください
2. 顧客の C360 に移動してください
3. アカウント属性（編集可能）セクションまでスクロールしてください
4. 追跡したいユースケースに対応するフィールドを探してください（現在利用可能なのは「CI 採用不足の理由」と「セキュリティ採用不足の理由」の 2 つ）
5. ドロップダウンから最も適切な理由を選択してください
6. 選択内容は自動保存されます
<br>
...
1. Gainsight にログインしてください
2. サイドナビゲーションを使用してダッシュボードに移動してください
3. 左上のピックリストから CSM ポートフォリオダッシュボードを選択してください
