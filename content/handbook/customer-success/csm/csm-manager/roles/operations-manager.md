...
upstream_path: /handbook/customer-success/csm/csm-manager/roles/operations-manager/
...
- サクセスプランの検証、EBR、リスクのあるアカウント、更新、および担当書全体の CSM に適用される CSM モーションを管理するためのオペレーション計画を確立・維持する。
- 組織内の他の部門のリーダー（例: フィールドチームリーダー、製品、サポート）と横断的に連携して、プロセスのギャップや非効率を特定し、効率性・シンプルさ・成果を重視した改善を行う。
- 地域内のチームメンバーまたはマネージャーが主導する Big Rocks & OKR を監督・指導し、地域内チーム全体においてそれらイニシアティブの成果物に対する進捗を追跡する。
- 製品要件に関連する短期的な顧客対応活動（例: ML/AI に関する顧客ベース全体からのフィードバックや要望）を管理・調整する。
