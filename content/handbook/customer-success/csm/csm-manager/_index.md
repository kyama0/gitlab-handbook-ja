...
<tbody>
  ...
  <tr>
    ...
    <td>エスカレーションへのアクティブなマネージャー参加（更新カデンスが満たされ、チームが連携していることを確認することを含む）</td>
  </tr>
</tbody>
</table>
...
- **エンゲージメントまでの時間**は、カデンスコールまたはミーティングタイプのタイムラインエントリが追加されたことで計算されます。
