...
アカウントチーム内で、顧客がライフサイクルの現在のフェーズにおいてイエローとフラグが立てられている理由が十分に理解されている場合があります。CSMがCSMグループ外のチームメンバーからの是正措置とフォローアップが必要と判断した場合、CSMは[リスクありタイムラインエントリ](/handbook/customer-success/csm/health-score-triage/#health-update-template)を作成する必要があります。
...
CSMAは、リスク状態に関わらず、顧客のヘルス更新を定期的にログ記録する必要がありますが、顧客がリスクにさらされているかどうかによって頻度の要件が異なります。
...
> - **DAPジャーニー: 顧客はDAPに関心がありますが、他のAIツールも評価しており、どこから始めればよいか分かっていません。**
...
> - **顧客は競合するAIツールを評価しており、実装してほしいDAP機能のリクエストがいくつかあります。**
...
> *DAPが盛り上がっていない場合*
>
> - **なぜブロックされているか: チームはDAPをどこから始めるべきか、自分たちのチームの具体的なユースケースについて苦労しています**
> - **緩和戦略: 基礎的なエージェント、カスタムエージェント、顧客固有の外部エージェントを確認するハンズオンDAPデモを実施する**
