...
| ------------ | ---- | ---------- | ---------- |
| クリティカル | 顧客がソリューションをデプロイまたは使用する能力に重大な影響を与える主要な問題、ソリューションの損失や使用リスク、顧客の高い損失リスクや大幅な縮小、または関係とブランドへの重大なリスク。 | 毎日 | 営業担当 VP、プロダクト、CRO、CEO、カスタマーサクセス担当 VP、グローバル/公共部門 CSM リーダー |
| 高 | 顧客がソリューションをデプロイまたは使用する能力に重大な影響を与える主要な問題、現在の採用リスク、顧客損失または縮小リスク、アカウントの将来の成長、関係へのダメージ。 | 週に複数回 | 営業担当 VP、プロダクト、CRO、CEO、カスタマーサクセス担当 VP、グローバル/公共部門 CSM リーダー |
