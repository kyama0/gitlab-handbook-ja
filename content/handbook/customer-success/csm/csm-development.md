...
lastmod: "2026-05-22T13:25:37-04:00"
translated_at: "2026-05-23T00:00:00Z"
translator: claude
stale: false
---

GitLab の Customer Success Manager として、あなたは自分自身とキャリアに投資する時間をとることを後押しされるべきであり、[開発のための 70-20-10 ルール](/handbook/people-group/learning-and-development/career-development/#70-20-10-rule-for-development)を活用してください。

継続的改善へのコミットメントを意図的なものにするため、毎暦月の最初の金曜日の午後は、個人としての、また専門職としての開発のために確保し、個人でまたは他の GitLab チームメンバーと協働して使うことが強く推奨されています。

そのためには、自分の個人的・専門的な開発のためにどのようなリソースが利用できるかを理解することが不可欠です。このページの残りの部分は、リーダーシップと CSM が CSM チームの前進と開発のために利用できるリソースを寄稿する場となることを目指しています。
...
1. [CSM Enablement Corner](https://docs.google.com/document/d/1xyaxc37iCDtfeabo2NXCRV31pNOdvieXoVDxJw_aXoM/edit?usp=sharing)（主要な日付と CSM の必須アクションとともに四半期ごとに更新）
...
- [Chorus Playlist](https://chorus.ai/playlists/741604) では、最高の CSM コールの録画にアクセスできます。録画は継続的に更新されるため、ベストプラクティスとしてこのプレイリストをブックマークしておいてください。

#### CSM インターンシップとメンターシップ

- [学習のための CSM インターンシップ](/handbook/customer-success/csm/csm-internship/)
- [CSMA メンターシッププログラム](/handbook/customer-success/csm/csm-mentorship/)
...
- [SQS における Sales & Customer Success ラーニングパス](/handbook/sales/onboarding/sales-learning-path/): [Sales Quick Start (SQS)](/handbook/sales/onboarding/) で予定されているトレーニングセッションと並行して行われ、[ロールベースのコンテンツ](/handbook/sales/onboarding/sales-learning-path/#customer-success-quick-start---role-based-curriculum)を含みます（講師主導セッション）
...
CSM がより戦略的になり、Director、VP、CISO のペルソナにアプローチするよう自らを位置づけてきたなかで、私たちはコミュニケーションスタイルを調整し、エグゼクティブ向けにどう合わせるかを考える必要があります。これらのリソースは、CSM のエグゼクティブとしての存在感とコミュニケーションを支援します。

- L&D には [Crucial Conversations](/handbook/leadership/crucial-conversations/) の認定を受けたチームメンバーが 2 名います。四半期ごとに 1 〜 2 回のセッションがあります。
...
- [Google Doc（積極的に更新中）](https://docs.google.com/document/d/1lkk_25XwOOw9eN-NqxuupZsDWRdWPbmFYD8RP8cWXz8/) - Lee Faus、Brian Wald、Francis Ofungwu が、GitLab のプラットフォームに関してエグゼクティブから聞いているテーマ（4 つの柱）を共有しています
- Sandler の記事
...
- [How to Create and Run a Brilliant Remote Workshop](https://www.linkedin.com/learning/how-to-create-and-run-a-brilliant-remote-workshop/how-to-run-a-brilliant-remote-workshop?autoplay=true&resume=false&u=2255073) - 48 分、Part 2 を聞いてください。ただし、ワークショップで使用するツールについては GitLab がアドバイスすることに留意してください。（LinkedIn Learning）
...
- 自己認定は [GitLab University](https://university.gitlab.com/pages/certifications) で利用できます。各試験には、必要な知識とスキルをカバーする無料の自己ペース型コースが対応しています:
...
- [Introduction to GitLab CI & DevOps with AWS](https://www.youtube.com/watch?v=PGyhBwLyK2U)（YouTube）
  - [Introduction to GitLab CI & DevOps with AWS - Course Notes](https://gitlab.com/gitlab-course-public/freecodecamp-gitlab-ci/-/blob/main/docs/course-notes.md)（Git リポジトリ）
...
## PS テクニカルインストラクターが技術的概念をどう教えるか

これらは、GitLab の Education Services 部門が顧客向けにライブで提供した実際の 8 時間コースの動画です。これらは、技術的概念を構造化された形式で提示する方法の良い例です。

> Education Services チームは、これらのクラス動画のより短く編集されたバージョンに取り組んでいます。編集版が利用可能になり次第、これらのリンクを編集版に置き換える予定です。それまでは、これらの未編集のクラス録画では、ラボや休憩を早送りで飛ばしてください。

アクセスコードと録画リンクは、この[内部ドキュメント](https://docs.google.com/document/d/1WNwz_2TbavLgEVG86eENu4Mf_StjYt77h-d-364l3bM/edit?usp=sharing)にあります。

## キャリア開発

### CSM ジョブファミリー内で

- [CSM Job Family ページ](/job-description-library/sales/customer-success-management/)は、CSM ジョブファミリー内の各レベルのロールと責任で常に最新に保たれています
- [CSM Skills Matrix](https://docs.google.com/spreadsheets/d/1_UEke64Qkz8wSyqfr_E9qqeAF6rX77w4vIH84Ckm_ts/edit#gid=0) により、CSM は次のシニオリティレベルに向けて取り組むうえでの機会となる領域を特定できます

### CS 組織内で

- [SA Job Family ページ](/job-description-library/sales/solutions-architect/)は、SA のロール、責任、技術的な期待で常に最新に保たれています。SA ロールへの移行に興味のある CSM は、必要に応じて技術スキルとセールススキルを伸ばすラーニングパスについてマネージャーと協働できます。

### CS の外側、GitLab 内で

- 他のチームのロールに移るための「公式」はありませんが、私たちは CSM の成長と、GitLab で別の領域を探求したいという意欲を歓迎します。CS の外の別のグループに移りたいと考えている CSM にとって、最初のステップはジョブファミリーの要件を確認し、パスを決めるためにマネージャーとつながることです。マネージャーが当該グループのチームリーダーとつながり、成功の可能性が最も高くなる開発計画を作り上げることが推奨されます。
</content>
