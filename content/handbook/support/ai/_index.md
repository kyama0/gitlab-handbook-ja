...
1. Glean によるチケットの要約
   ...
   サポートエンジニアは [Glean](../../security/customer-support-operations/zendesk/apps/global/#glean) を使って長い顧客チケットを自動的に要約できます。[たとえば、トークン期限切れ通知に関する複雑なチケットが要約され](https://gitlab.com/gitlab-com/support/support-team-meta/-/issues/6302)、次のステップとともに 8 つの重要ポイントにまとめられ、ハンドオフやレビューの時間を大幅に節約しました。
