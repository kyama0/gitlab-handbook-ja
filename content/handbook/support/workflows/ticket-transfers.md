...
translator: claude
stale: false
lastmod: "2026-05-18T10:52:59-05:00"
---
...
GitLab Support には、2 種類のチケット転送があります: **rehomes（再ホーム）** と **handovers（引き継ぎ）** です。以下のセクションでは、これらと、サテライトチケットおよびホット rehome の関連概念を説明します。
