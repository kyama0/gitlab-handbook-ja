...
- ブロックされたユーザーまたはトップレベルグループオーナーは、ブロック解除のためにサポートチケットを送信できます。彼らが [検証された](/handbook/support/workflows/account_verification) 後、ユーザーをブロック解除できます。ユーザーに [admin note](/handbook/support/workflows/admin_note) を残し、ブロック解除されたこと、日付、チケット番号を記載します。
