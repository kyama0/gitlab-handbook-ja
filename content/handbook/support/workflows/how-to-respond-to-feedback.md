...
**注:** サポートエンジニアは自分のチケットに対するフィードバックコメントを確認でき、フィードバックコメントが追加されると Zendesk から通知を受け取ります。彼らやそのマネージャーに通知する必要はありません。
...
1. 顧客が満足した理由や、私たちのサポートが彼らの一日をどのように良くしたかを説明している（素晴らしいストーリーが集まります！）
