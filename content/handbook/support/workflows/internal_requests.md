...
translator: claude
stale: false
lastmod: "2026-05-08T14:39:14-04:00"
---
...
両テンプレートとも [アカウント所有権の確認](/handbook/support/workflows/account_verification) が必要です。アクションが多数のグループメンバーに影響する場合、該当メンバーはエンタープライズユーザーの定義に一致する必要があります。
