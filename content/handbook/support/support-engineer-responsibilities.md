...
### 3. 割り当てられたすべてのチケットで解決まで良好な進捗を維持する
...
### 4. 顧客の期待を管理し、チケットとコールを通じて徹底的にコミュニケーションする
...
- 顧客の本当のニーズを理解する
- 顧客が求めることができないとき、彼らを助けるために自分が **できる** ことを見つける
...
たくさんのことが進行中です。すべてに貢献しようとすると圧倒されるかもしれません。集中して興味のある領域を見つけるのに役立つように、Issue がより大きなイニシアチブにグループ化されている [Support Team Epic](https://gitlab.com/groups/gitlab-com/support/-/epics/) を見てください。Epic にはタイトルの後ろに括弧書きで Directly Responsible Individual（DRI）の名前があります。手助けしたい場合は、彼らに連絡し、マネージャーに相談してください。
