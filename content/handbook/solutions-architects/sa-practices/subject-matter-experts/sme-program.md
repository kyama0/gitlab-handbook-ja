...
各 SME 領域は、2 名の **SME 領域リード／DRI** が代表を務め、SA 組織から 1 名、CS 組織から 1 名が担当します。SMEは各領域の適切な運営に責任を負います。
...
SME 領域リード／DRI は、それぞれの専門領域と SME チームのリードに責任を負います。SMEは、それぞれの SME 領域のプロジェクトマネージャーです。
