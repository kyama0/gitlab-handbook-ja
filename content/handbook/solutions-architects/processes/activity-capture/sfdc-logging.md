...
見込み顧客や顧客による SA ガイド付き技術評価の分析を支援するため、SA チームは Salesforce で4 つの商談フィールドを維持します。これら4 つのフィールドは Rattle または Salesforce 内の商談から更新できます: **SA Validated Tech Evaluation Start Date**、**SA Validated Tech Evaluation End Date**、**SA Validated Tech Evaluation Close Status**、**SA Validated Tech Evaluation Close Details**。
...
- 商談がステージ 3 - 技術評価から移行すべきであることを示します
...
- 利用可能なオプションは以下:
  ...
  - **Stalled**: 技術評価が完了していないが、顧客または見込み顧客がアクティブにソリューションを評価していない - 通常 SA が見込み顧客または顧客との評価関連活動に少なくとも2 週間取り組んでいない場合
...
SA Feasibility はステージ 3〜4で最も適用可能です。ステージ 3 - 技術評価の前に、ソリューションアーキテクトは成功するテクニカルウィンに向けて評価を構築する最善の方法を考えるべきです。ステージ 4 - 提案の後は、技術評価は完了しているはずで、ソリューションアーキテクトはサポート役に移ります。
