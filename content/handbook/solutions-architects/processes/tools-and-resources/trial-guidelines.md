...
### これらの目標に対する成功はどのように測定しますか？ {#how-will-success-be-measured-against-these-objectives}
...
### 意思決定プロセスはどのようなものですか？ {#what-does-the-decision-process-look-like}
...
### 誰が参加すべきですか？ {#who-should-participate}
...
### どのプロジェクトをテストに使用すべきですか？ {#which-projects-should-be-used-for-testing}
...
### 評価をどのように計画しますか？ {#how-to-plan-the-evaluation}
...
### すでに会社のアカウントがある場合 {#i-already-have-a-company-account}

2 つのオプションがあります:

#### 専用のトライアルアカウントを作成する {#create-a-dedicated-trial-account}

前の手順「GitLab を初めて使用する場合」に従い、たとえば「organization-trial」という新しいグループを作成します。

グループにプロジェクトデータを設定するには、次の方法を使用できます:

##### 既存の自社グループ/プロジェクトのコピーを使用する {#use-copies-of-your-own-existing-groupsprojects}
...
### トライアルライセンスに関する注意 {#notes-regarding-trial-licenses}
...
### 既存のトライアルを延長する {#extending-an-existing-trial}
...
## GitLab Duo (AI) のトライアル {#trialing-gitlab-duo-ai}
...
## トライアル終了後はどうなりますか？ {#what-happens-once-the-trial-ends}
