...
translator: codex
stale: false
lastmod: "2026-07-07T13:20:56+00:00"
---
...
- 地上交通機関（タクシー、Uber）は往復 300 ドル、片道 150 ドルを上限とします。
...
- PEO下の拠点のリストは[payroll ページ](/handbook/finance/payroll/)で確認できます。
- チームメンバーはNavanを通じて経費を提出する必要があります。
- すべての経費は、当月の給与に含まれるようにするため、毎月3日以前にAccounts Payableチーム（ポリシー外経費の場合）が提出および承認する必要があります。

**Papaya Italy**

Dirigente 分類でイタリアに雇用されたチームメンバーは、GitLab の経費システムである Navan を通じて経費を提出しますが、Papaya も給与を通じて業務経費を処理するために独自のテンプレートを必要とします。Navan は PEO ワーカーの経費を自動的に支払わないため、Navan に加えて Papaya への手動提出が必要です。

**出張経費の提出プロセス**

1. チームメンバーは、出張または経費ごとに [Papaya の経費テンプレート](https://docs.google.com/spreadsheets/d/1r57rC76gu_0buvpmB1kLgGBz1dbIFWv_/edit?usp=sharing&ouid=105940045311062226254&rtpof=true&sd=true)をダウンロードして記入します。**注**: 各出張は別々のテンプレートで提出する必要があります。複数の出張を 1 つにまとめることはできません。
2. チームメンバーは、記入済みテンプレートを PDF として保存します。
3. チームメンバーは、通常どおり領収書と一緒に PDF を Navan にアップロードします。
4. Payroll は承認済み経費を当月の給与変更に追加し、該当月の合意済み締切日までに処理のため Papaya に提出します。

**出張経費と日常経費**
出張経費（フライト、宿泊など、通常 1 日を超える出張のもの）は、日常経費とは別に提出する必要があります。
出張の場合、テンプレート内の各エントリには、場所、期間、目的、補足スクリーンショット/領収書を含める必要があります。
