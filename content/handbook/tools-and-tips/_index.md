...
私たちには [企業 VPN はありません](/handbook/security/product-security/security-platforms-architecture/security-architecture/zero-trust/#why-we-dont-have-a-corporate-vpn) が、GitLab のために旅行する場合や未知のネットワークを頻繁に使用する場合は、[購入](https://internal.gitlab.com/handbook/finance/expenses/#vpn-subscription) して [個人用 VPN](/handbook/tools-and-tips/personal-vpn/) を利用することを検討してください。
