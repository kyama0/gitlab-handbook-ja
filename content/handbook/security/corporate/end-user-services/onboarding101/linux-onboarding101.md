...
### SentinelOne インストール - ドイツ、オランダ、イタリア、オーストリアのみ {#sentinelone-installation---germany-the-netherlands-italy-and-austria-only}
...
ノートパソコンのセットアップでさらなるサポートが必要な場合は、毎週火曜日に予定されているオンボーディングコールに参加するか（カレンダーをご確認ください！）、Slack の Compass アプリ（上部の検索バーに「Compass」と入力すると見つかります）または it-help@gitlab.com から IT にお問い合わせください。
