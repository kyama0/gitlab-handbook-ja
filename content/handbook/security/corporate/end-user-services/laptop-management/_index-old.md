...
>
> このアカウントが閉鎖される 30 日前にもう 1 回、そして 1 週間前に最終通知をお送りします。このプロセスについてのご質問や、データへのアクセスに関するサポートが必要な場合は、Slack の #it_help チャンネルで Corp IT チームにお気軽にお問い合わせください。
...
>
このアカウントが閉鎖される 1 週間前にもう 1 回通知をお送りします。このプロセスについてのご質問や、データへのアクセスに関するサポートが必要な場合は、Slack の #it_help チャンネルで Corp IT チームにお気軽にお問い合わせください。
...
>
> これは最終通知です。このプロセスについてのご質問や、データへのアクセスに関するサポートが必要な場合は、Slack の #it_help チャンネルで Corp IT チームにお気軽にお問い合わせください。
