...
[コーポレートセキュリティサポート](/handbook/security/corporate/support)および／または[コーポレートセキュリティシステム](/handbook/seecurity/corporate/systems)のハンドブックページにアクセスして、ヘルプを入手してください。

このページでは「何を」提供するかと、当社が提供するサービスや内部プロセスへのリンクを提供します。サポートページではお役に立つ「方法」を提供します。

## 概要

ヘルプデスクサポートアナリストによる 24x5 のカバレッジを提供しており、アクセスリクエスト、アカウントロックアウト、認証問題、ラップトップハードウェア、ラップトップソフトウェアの構成問題、不慣れな技術に関する 1:1 トレーニング、および任意の[コーポレートセキュリティシステム](/handbook/security/corporate/systems)に関する問題のトリアージを支援します。
...
- [アイデンティティおよびアクセス管理](/handbook/security/corporate/services/identity)
  ...
  - [アカウントパスワードと 2FA リセット](/handbook/security/corporate/services/account-resets)
  - [キャリアモビリティ（ムーバー）とロール変更プロビジョニング](/handbook/security/corporate/services/role-changes)
  - [外部コラボレーター（顧客、パートナー、ベンダー）](/handbook/security/corporate/services/external-collaborators)
  - [オンボーディング（ジョイナー）プロビジョニング（ベースラインエンタイトルメント）とユーザーサポート](/handbook/security/corporate/services/onboarding)
  - [オフボーディング（リーバー）デプロビジョニング](/handbook/security/corporate/services/offboarding)
  - [サービスアカウント](/handbook/security/corporate/services/service-accounts)
  - [テンポラリーサービスプロバイダー](/handbook/security/corporate/services/temporary-users/)
