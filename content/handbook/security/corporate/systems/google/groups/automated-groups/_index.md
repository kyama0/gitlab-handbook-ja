...
Okta の変更は通常、数分以内に Google Groups に同期されますが、数時間以上かかる場合もあります。
これは次のことを意味します。
...
新しい Google Groups を作成するための [Issue テンプレートはこちら](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?type=ISSUE&initialCreationContext=list-route&description_template=GoogleGroup_Request) です。
