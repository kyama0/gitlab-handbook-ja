...
すべての SaaS とベンダーソフトウェアは [ベンダーオンボーディングプロセス](/handbook/business-technology/enterprise-applications/guides/zip-guide/#how-to-request-a-new-vendor) を経て、Okta で本番稼働する前にテックスタックに追加される必要があります。
...
(将来の) テックスタックアプリケーションのビジネスオーナーまたはテクニカルオーナーは、変更管理 Issue を作成し、プロセス中に承認とテクニカルレビューを提供する責任があります。
...
- **ベンダーのオンボーディング**
  - 新しいアプリケーションをテックスタックに追加する
  - 変更管理 Issue にテックスタックの詳細を更新し、調達プロセスが完了したことをコメントする。
