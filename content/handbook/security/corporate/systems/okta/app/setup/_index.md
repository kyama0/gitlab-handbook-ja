...
すべての SaaS とベンダーソフトウェアは [ベンダーオンボーディングプロセス](/handbook/business-technology/enterprise-applications/guides/zip-guide/#how-to-request-a-new-vendor) を経て、Okta で本番稼働する前に Tech Stack に追加される必要があります。
