...
CorpSec Devices チームは、チームメンバーのエンドポイントのセキュリティと、それらで実行されるセキュリティツールおよびコントロールを担当します。

## 担当範囲の境界

CorpSec Devices は、以下を含むエンドポイントセキュリティコントロールプレーンを担当します。

1. モバイルデバイス管理（MDM）のアーキテクチャ、設定、登録、セキュリティベースライン
1. エンドポイント検知・対応（EDR）の設定とデプロイ
1. ブラウザセキュリティポリシーとブラウザ拡張機能のガバナンス
1. オペレーティングシステムおよびサードパーティソフトウェアの更新ポリシー
1. エンドポイントセキュリティテレメトリ、コンプライアンス監視、自動修復
