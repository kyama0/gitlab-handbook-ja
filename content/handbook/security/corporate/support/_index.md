...
コーポレートセキュリティが管理していないシステムについては、[Tech Stack](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/tech_stack.yml)でオーナーを確認できます。どこに尋ねればよいか分からない場合は、`#it_help` でお尋ねいただければ、適切な担当者や場所にご案内します。
