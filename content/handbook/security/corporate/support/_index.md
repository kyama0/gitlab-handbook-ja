...
description: "Corporate Security（CorpSec）チームから支援を受ける場所。ヘルプデスクサービス、システム、およびチームメンバーからよく寄せられるリクエストを含みます。"
...
探している情報が見つからない場合は、Slack の Compass アプリ（上部検索バーに「Compass」と入力すると見つかります）または it-help@gitlab.com からご連絡ください。
...
- 👷 [エンジニアリング](/handbook/security/corporate/engineering)
  ...
  - [SaaS エンジニアリング（コーポレート Tech Stack アプリケーションとプラットフォーム）](/handbook/security/corporate/saas/)
...
**Slack の Compass アプリ（上部検索バーに「Compass」と入力すると見つかります）または it-help@gitlab.com からご連絡ください。**

私たちのチームメンバーはオンコールシフトをスケジュールに沿って担当しているため、特定の個人に Slack のダイレクトメッセージを送るのではなく、チャンネルで質問していただくようお願いしています。

コーポレートセキュリティが管理していないシステムについては、[Tech Stack](https://gitlab.com/gitlab-com/www-gitlab-com/-/blob/master/data/tech_stack.yml)でオーナーを確認できます。どこに尋ねればよいか分からない場合は、Slack の Compass アプリ（上部検索バーに「Compass」と入力すると見つかります）または it-help@gitlab.com からご連絡ください。
...
チームメンバーのサポートリクエストについては、Slack の Compass アプリ（上部検索バーに「Compass」と入力すると見つかります）または it-help@gitlab.com からご連絡ください。
...
**ご注意:** 私たちはエンジニアリング Issue について **当日対応はしていません**。私たちの Issue には優先度付きのキューがあり、エンジニアリングマネージャーとプログラムマネージャーが管理しています。各チームには、新しい日々のリクエストを数営業日以内にトリアージできるようにバッファを確保しています。作成する Issue には、適切な優先度ラベルを付けてください。**Slack の Compass アプリ（上部検索バーに「Compass」と入力すると見つかります）または it-help@gitlab.com からご連絡ください。** エスカレーションと優先度付けは社内で対応します。
