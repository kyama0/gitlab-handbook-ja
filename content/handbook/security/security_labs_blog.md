---
title: "GitLab Security Labs ブログカテゴリ"
upstream_path: /handbook/security/security_labs_blog/
...
- [サードパーティ脅威インテリジェンス](https://about.gitlab.com/blog/gitlab-uncovers-bittensor-theft-campaign-via-pypi/)
- [実験的ツールまたは技術](https://about.gitlab.com/blog/gitlab-catches-mongodb-go-module-supply-chain-attack/)
- [サードパーティ脆弱性分析](https://gitlab-com.gitlab.io/gl-security/security-tech-notes/red-team-tech-notes/ollama-driveby/)（責任を持って開示済み）
- [Red Team 向けに枠組みされた攻撃ツールとしての GitLab の使用](https://about.gitlab.com/blog/how-gitlabs-red-team-automates-c2-testing/)（e-group 承認が必要）
- [実験またはセキュリティチームの「学んだ教訓」](https://about.gitlab.com/blog/stealth-operations-the-evolution-of-gitlabs-red-team/)
...
[このテンプレートを使用](https://gitlab.com/gitlab-com/gl-security/security-department-meta/-/issues/new?type=ISSUE&issuable_template=Security%20Labs%20Blog%20Proposal) して Issue を開いてください。プロセスと承認をご案内します。
