---
title: "Identity GitOps アーキテクチャ"
description: "私たちは、Configuration-as-Code および Admin UI で実行可能なあらゆる操作の管理に、GitOps CI/CD パイプラインを組み合わせた Terraform を利用しています。これにより、日々の管理操作とグローバル設定のすべてを、MR 承認ルールと CI/CD 自動化を備えた状態管理へと移行できます。"
upstream_path: /handbook/security/identity/gitops/
