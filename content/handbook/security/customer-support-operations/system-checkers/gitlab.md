...
- 問題の配列内の各情報について、[#css-audit-events Slack チャンネル](https://gitlab.enterprise.slack.com/archives/C04A6E1KB89) に投稿します
...
GitLab のシステムチェッカーに変更を加えるには、プロジェクトリポジトリで MR を作成する必要があります。具体的な変更内容は依頼そのものによって異なります。

ピアによるレビューと承認を受けたら、MR をマージできます（次回のトリガー実行時に変更が適用されます）。
