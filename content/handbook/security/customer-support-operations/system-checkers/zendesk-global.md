...
description: 'Zendesk Global のシステムチェッカーに関するドキュメント'
date: 2026-01-06
upstream_path: /handbook/security/customer-support-operations/system-checkers/zendesk-global/
...
<sup>[gitlab-com/support/support-ops/support-ops-project#1889](https://gitlab.com/gitlab-com/support/support-ops/support-ops-project/-/issues/1889) を経て導入</sup>
...
Zendesk Global のシステムチェッカーは、スケジュール済みパイプラインを使って Zendesk Global のステータスをチェックする仕組みです。[#feed_status-zendesk-global Slack チャンネル](https://gitlab.enterprise.slack.com/archives/C086Z7LAFB2) に投稿します。
...
- [#feed_status-zendesk-global Slack チャンネル](https://gitlab.enterprise.slack.com/archives/C086Z7LAFB2) に新規または更新項目の詳細を投稿します
