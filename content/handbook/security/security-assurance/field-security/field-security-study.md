---
title: "年次 Field Security Study"
upstream_path: /handbook/security/security-assurance/field-security/field-security-study/
...
レポートは [Internal](/handbook/communication/confidentiality-levels/#internal) として扱われます。
...
詳細なレポートが作成され、検討のために関連する[内部](/handbook/communication/confidentiality-levels/#internal)ステークホルダーに提供されます。優先度の高い懸念事項は、Field Security チームによって GitLab Issue にもドキュメント化され、適切なチームメンバーにアサインされます。

- 情報セキュリティに関する Issue は Security Leadership によって評価および管理されます。

## レポート一覧 (内部のみ)

- [FY21 GitLab.com Field Security Study](https://docs.google.com/document/d/1BN979fDYeOwIhKOvrMStyqj5ftDq1w0bc2urcsk3z8U/edit?usp=sharing) レポートおよび [Epic](https://gitlab.com/groups/gitlab-com/-/epics/957)
- FY22 については Field Security Study レポートは提供されませんでした。
- [FY23 Field Security Study](https://docs.google.com/document/d/1QD55PuhfO15hWFaz7BoLiHLxMU7q3JuFJ5EbB57MH9s/edit) レポート。
