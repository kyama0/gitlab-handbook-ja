...
[サインイン制限](https://docs.gitlab.com/ee/administration/settings/sign_in_restrictions.html) により、セルフマネージドの管理者は、Web インターフェースおよび Git over HTTP(S) の認証制限をカスタマイズできます。これらの設定により、以下を強制できます。
