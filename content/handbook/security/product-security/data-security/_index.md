...
[私たちの透明性の価値](/handbook/values/#transparency)に従い、この Issue トラッカーは GitLab の全員に公開されています。*あなたのアイデンティティでタグ付けされない方法で問題を調査するよう依頼する必要があると感じる場合は、チームの誰かに DM を送り、彼らに Issue を作成してもらってください。*
