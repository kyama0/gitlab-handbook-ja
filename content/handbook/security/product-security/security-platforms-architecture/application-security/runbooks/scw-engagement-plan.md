...
- 月次の Slack 告知で、最近のセキュリティリリースで見られたトップ 3 の脆弱性を取り上げ、リリースの AppSec プライマリ（[リリースマネージャー](/handbook/engineering/releases/release-managers/)を参照）が告知を行い、開発者がそれらを特定して修正する方法を学べるようにする
