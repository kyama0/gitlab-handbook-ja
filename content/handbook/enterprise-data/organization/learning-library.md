...
## GitLab チームメンバーによるコンテンツ

- [How Data Teams Do More With Less By Adopting Software Engineering Best Practices - Thomas の 2018 年 DataEngConf NYC での講演](https://www.youtube.com/watch?v=eu623QBwakc)
- [Taylor による 2019 年 Music City Tech Conference（ナッシュビル）での同様の講演のスライド](https://docs.google.com/presentation/d/1oSdej0y7o5d4DKlyykmTEMbokr7sRIxMkFmw6Z8a270/edit?usp=sharing)
...
- [Data Science is different now](https://vickiboykis.com/2019/02/13/data-science-is-different-now/) (注: これが GitLab にまだデータサイエンティストがいない理由です。)
...
- [Building a Mature Analytics Workflow](https://www.getdbt.com/blog/building-a-mature-analytics-workflow) (注: これは「アナリティクスはソフトウェアエンジニアリングのサブフィールドである」という前提を説明しています。)
