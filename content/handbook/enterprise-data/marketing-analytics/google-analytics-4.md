...
translator: codex
stale: false
lastmod: "2026-07-15T11:46:59-07:00"
---
...
* about.gitlab.com: メインのマーケティングウェブサイト
* docs.gitlab.com: 技術的な GitLab ドキュメント
* page.gitlab.com: リード獲得キャンペーン向けのマーケティングウェブサイト
* learn.gitlab.com: ABM のゲート付きアセット向けのマーケティングウェブサイト
* webcasts.gitlab.com: ウェブキャストの登録と視聴向けのマーケティングウェブサイト
* events.gitlab.com: イベント登録向けのマーケティングウェブサイト
* explore.gitlab.com: ABM 向けにパーソナライズされたマーケティングウェブページ
* university.gitlab.com: GitLab のコースと認定資格
* forum.gitlab.com: GitLab のフォーラムとディスカッション
* handbook.gitlab.com: GitLab の従業員向け（公開）
* internal.gitlab.com: GitLab の従業員向け（アクセス制限）
* developer.gitlab.com
* customers.gitlab.com（チェックアウトページのみ）: eコマース購入フロー
* gitlab.com（登録ページのみ）: ユーザーが GitLab に登録できるゲート付きの「プロダクト」ページ
  * /sign_up/
  * /users/sign_in
  * /users/almost_there
...
| navigation_menu_click           | navigation_menu_level1<br>navigation_menu_level2                                                      | ナビゲーションからのリンクのクリック。レベル1はタブ名です。タブにホバーするとレベル2リンクのサブメニューが展開される場合があり、別のページへのリンクとなる場合もあります。                                                                                      |
...
| saas_trial_duopro               |                                                                                                        | gitlab.com/-/trials/duo_pro/new でのDuo Proトライアル登録                                                                 |
...
さらに、使用できるクリーンデータモデルは以下のとおりです：

* `PROD.WORKSPACE_MARKETING.GOOGLE_ANALYTICS_EVENTS`: イベントスコープ
* `PROD.WORKSPACE_MARKETING.GOOGLE_ANALYTICS_SESSIONS`: セッションスコープ
