...
translator: claude
stale: false
lastmod: "2026-08-27T08:41:45+02:00"
---
...
#### T シャツサイジングアプローチ {#t-shirt-sizing-approach}
...
データチームはイテレーションと呼ばれる 2 週間の間隔で作業します。イテレーションは水曜日に始まり、火曜日に終わります。これにより、チームはイテレーションの冒頭にイテレーション計画ミーティングを行えます。
...
| 10 - 第 2 金曜日 | **MR をレビューのために提出する最終日** <br><br>MR はマージ準備ができているためにドキュメントとテストを含む必要があります。 | **イテレーションはおおむね確定** <br><br>イテレーションプランナーが次のイテレーションの Issue の優先度とチームキャパシティを確認します |
