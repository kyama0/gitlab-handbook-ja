...
### ステップ 1: OpenCode をインストールする {#step-1-install-opencode}

```bash
curl -fsSL https://opencode.ai/install | bash
```

### ステップ 2: インストールを確認する {#step-2-verify-the-installation}
...
### ステップ 3: analytics リポジトリから OpenCode を起動する {#step-3-start-opencode-from-the-analytics-repo}
...
### ステップ 4: GitLab Duo を AI プロバイダーとして設定する {#step-4-configure-gitlab-duo-as-your-ai-provider}
...
### ステップ 4.5: 接続をテストする {#step-45-test-the-connection}

接続できたら、`hi` と入力して OpenCode が応答することを確認します。

### ステップ 5: Golden Config を適用する {#step-5-apply-the-golden-config}
...
### ステップ 6: `plan` をデフォルトエージェントに設定する {#step-6-set-plan-as-your-default-agent}
...
### ステップ 7: エージェント利用ガイドを確認する {#step-7-review-the-agent-usage-guide}

OpenCode を使い始める前に、[エージェント利用ガイド](agent-usage-guide.md) を確認し、次の点を理解してください。
...
## 音声プロンプト用の MacWhisper（任意） {#macwhisper-for-voice-prompting-optional}
