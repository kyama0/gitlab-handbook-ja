---
title: "コンテンツライブラリ - GitLab での生活"
description: このコンテンツライブラリは、GitLab での生活のストーリーを伝えるのに役立つブログ投稿、記事、ビデオ、アワード、簡単な事実のキュレーションされたリストです。
upstream_path: /handbook/people-group/employment-branding/content-library/
upstream_sha: 1e195b58b9f249ff10bd0e705106c320fee86141
translated_at: "2026-05-14T00:00:00Z"
translator: claude
stale: false
lastmod: "2026-05-05T13:43:57-05:00"
---

## コンテンツライブラリの使い方

Talent Acquisition チームに所属していても、GitLab の別のチームに所属していても、すべてのチームメンバーが GitLab とここで働くことがどのようなものかを広めるのに必要な情報を持ってほしいと考えています。

このコンテンツライブラリは、GitLab のタレントアンバサダーとして行動する際にリソースとして使用してください：ソーシャルメディアで共有するとき、ネットワーク内の人々と会話するとき、イベントで話すときなど。
...
ソース: [GitLab チームページ](/handbook/company/team/)

現在のヘッドカウント数は、現在のチームメンバーのソースとして GitLab チームページを使用し、その数を最も近い 100 まで切り下げて、四半期ごとの収益発表後に更新されます。この数は、特定のチームメンバー数を参照するすべてのキャリアサイトで使用されます。

## GitLab での生活に関する主要メッセージ

- 私たちは世界最大のオールリモート企業の 1 つで、創業年からこの文化を意図的に構築してきました。
- 私たちのミッションは、誰もが貢献できる世界を信じていることを明確にしています。私たちはこれを、製品上で運営を行い、すべてにおいて価値観と一致し続けることによって GitLab で可能にしています。
- [GitLab での生活と私たちの文化](/handbook/company/culture/) について詳しく。

## GitLab における Diversity, Inclusion, and Belonging (DIB) に関する主要メッセージ

- Diversity, inclusion, and belonging (DIB) は GitLab の成功にとって基本的です。私たちは行うすべてのことに DIB をあらゆる方法で注入しています。
- GitLab では、誰もが声を持ち、貢献する力を与えられています。これは、より多様で包括的な文化を作るために、チームメンバーが自分の経験について率直に話し、リーダーシップに提案を提供する機会を持つことを意味します。
- Team Member Resource Group、イベントスポンサーシップ、メンターシップ機会、HBCU との提携を通じて、人々が毎日、フルセルフとして現れることができ、快適に感じる透明な環境を作ることに努めています。
- [GitLab における DIB](/handbook/company/culture/inclusion/) について詳しく。

## GitLab を働く素晴らしい場所として認識するアワードとリスト

これらのアワードとリストは、GitLab のユニークな文化を認識し、ここがそんなに働く素晴らしい場所である理由を広めるのに役立ちます。最新のものは次のとおりです：
...
<details><summary>記事/ブログ/特集</summary>
...
<details><summary>ポッドキャスト</summary>
...
ここで働くことに関する [企業 YouTube チャンネル](https://www.youtube.com/gitlab) や GitLab Unfiltered YouTube チャンネルには、さらに多くのビデオがあります。

| プラットフォーム | 説明 |
| ------ | ------ |
| [GitLab Careers](https://about.gitlab.com/jobs/) | GitLab キャリアページ |
| [Life at GitLab](https://www.linkedin.com/company/gitlab-com/life/general/?viewAsMember=true) | LinkedIn ライフページ |
| [Product at GitLab](https://www.linkedin.com/company/gitlab-com/life/4763492d-8a7e-49de-8b66-30ad33df805e/?viewAsMember=true) | LinkedIn ライフページ |
| [Engineering at GitLab](https://www.linkedin.com/company/gitlab-com/life/d7a581f5-5dd7-499f-a5e9-79bbcda7f29a/?viewAsMember=true) | LinkedIn ライフページ |
| [UX at GitLab](https://www.linkedin.com/company/gitlab-com/life/2401df61-b442-4630-a061-c586f6d788ba/?viewAsMember=true) | LinkedIn ライフページ |
| [Builtin](https://builtin.com/company/gitlab) | カルチャーページと求人ボード |
| [Women in Sales Everywhere](https://www.womeninsaleseverywhere.com/companies/gitlab) | 会社ページとコミュニティメンバーベネフィット |
| [Glassdoor](https://bit.ly/3BT89On) | 会社評価、レビュー、求人ボード |
| [Comparably](https://www.comparably.com/companies/gitlab) | カルチャーページと求人ボード |

## ロゴ、会社説明、チーム写真

公式 GitLab ロゴ、会社説明、グリーンスクリーン、その他のプレス関連アセットが必要な場合は、GitLab Web サイトの [プレスキット](https://about.gitlab.com/press/press-kit/) を参照してください。

外部共有が承認されたチームおよびカルチャー写真は、[この Google フォルダ](https://drive.google.com/drive/folders/18SG20yehfmHP3krNuU03LZliuN_JWtmA) で見つけることができます。
