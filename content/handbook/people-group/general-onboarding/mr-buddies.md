...
1. オプションで、マージリクエストバディとしてチームメンバーのマージリクエストをマージできるよう、<https://gitlab.com/gitlab-com/www-gitlab-com> へのメンテナーアクセスを [リクエスト](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new) する
