...
upstream_path: /handbook/upstream-studios/experience-research/facilitating-user-interviews/
...
## インタビューのヒント {#tips-for-interviewing}
...
## インタビュートレーニング {#interview-training}

インタビュースキルの向上に興味があれば、UXリサーチチームが運営する軽量なインタビュートレーニングプログラムである [Interview Carousel](/handbook/upstream-studios/experience-research/interview-carousel/) への登録を検討してください。
