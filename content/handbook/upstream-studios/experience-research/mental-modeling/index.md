...
### メンタルモデリング調査を行うタイミング {#when-to-do-a-mental-modeling-study}
...
## メンタルモデリング活動の種類 {#types-of-mental-modeling-activities}
...
### コンセプトマッピング分析 {#concept-mapping-analysis}
