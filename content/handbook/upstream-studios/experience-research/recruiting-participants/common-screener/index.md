...
### Common Screener を使用する利点は何ですか？ {#what-are-the-benefits-of-using-a-common-screener}
...
### Common Screener の使用例はありますか？ {#is-there-an-example-of-how-a-common-screener-has-been-used}
...
### Common Screener で使用される質問の例は何ですか？ {#whats-an-example-of-a-question-used-in-a-common-screener}
...
### チームが Common Screener の使用から利益を得られると考える場合、どの手順を取りますか？ {#what-steps-do-you-take-if-you-think-your-teams-could-benefit-from-using-a-common-screener}
...
### 既存の Common Screener を使用したい場合、どの手順を取りますか？ {#what-steps-do-you-take-if-youd-like-to-use-an-existing-common-screener}
