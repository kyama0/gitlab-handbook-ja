...
## アンケートのサンプルサイズを決定する際に考慮すべき要素 {#factors-to-consider-when-determing-your-survey-sample-size}
...
## アンケートのサンプルサイズに関するガイドライン {#guidelines-for-survey-sample-size}
...
## アンケートのサンプルサイズを報告する {#reporting-your-survey-sample-size}
