...
upstream_path: /handbook/upstream-studios/experience-research/diary-studies/
...
## ダイアリースタディを行う目的 {#the-purpose-of-doing-diary-studies}
...
## ダイアリースタディを実施するタイミング {#when-to-conduct-diary-studies}
...
## ダイアリースタディが他のリサーチタイプと異なる点 {#how-diary-studies-are-different-from-other-types-of-research}

ダイアリースタディは、同じ参加者グループから複数回データを収集するという点で、アンケート、インタビュー、フォーカスグループとは異なるユニークな手法です。この手法は、時間の異なる時点で 1 つ以上の定量的指標（たとえば、自信や有効性の評価）を収集する状況において [縦断的スタディ](/handbook/upstream-studios/experience-research/longitudinal-studies/) と重なる部分があります。両者の主な違いは、ダイアリースタディは定量的な指標を使うことを **必須としない** ことです。多くのダイアリースタディは、定性データ（自由形式のフィードバックや自己報告の観察）のみを収集することに関わる場合があります。

### ダイアリースタディと縦断的スタディの違い {#how-diary-studies-differ-from-longitudinal-studies}

ダイアリースタディには、[縦断的スタディ](/handbook/upstream-studios/experience-research/longitudinal-studies/) で説明されているのと同じステップが多数必要です。1 つ追加で必要なステップは、参加者がいつエントリーを記録するかを決めることです:
...
ダイアリースタディのリサーチ計画に影響を与える他の要因には、[リクルートする参加者の種類](/handbook/upstream-studios/experience-research/recruiting-participants/)、リサーチの期限、リサーチ質問の数などがあります。

## ダイアリースタディの設定方法 {#how-to-set-up-a-diary-study}
...
### ダイアリースタディの実施のヒント {#tips-for-conducting-diary-studies}
...
## ダイアリースタディの例 {#examples-of-diary-studies}
...
## ダイアリースタディに関する追加リソース {#additional-resources-on-diary-studies}
