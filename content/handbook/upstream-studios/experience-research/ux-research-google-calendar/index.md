---
title: "UX Research Google Calendar の使用"
description: "他の人がリサーチセッションに参加できるようにする UX Research Google Calendar の使い方です。"
upstream_path: /handbook/upstream-studios/experience-research/ux-research-google-calendar/
...
1. Location フィールドに Zoom 会議 URL を含めます。
1. イベントの本文に、次を含めます。
    - リサーチの全体的な目標（これはディスカッションガイドから取得します）
    - リサーチの実施者
