...
## プロダクト分析の全体像を理解する {#understanding-the-product-analytics-landscape}
...
### 連携するチーム {#teams-to-collaborate-with}
...
## 利用可能な情報の状況 {#the-state-of-available-information}
...
### GitLab が追跡する一般的なメトリクスとセグメント {#common-metrics-and-segments-that-gitlab-tracks}
...
## Product Data Insights チームとの連携 {#working-with-product-data-insights-team}
...
### どのように支援を受けられますか？ {#how-can-i-get-help}
...
## UXR-PDI ユースケースの例 {#example-uxr-pdi-use-case}
...
## 簡易メトリクス用語集 {#simplified-metrics-glossary}
...
## 便利な Tableau ワークブック {#useful-tableau-workbooks}
