...
ときには、デザイナー、PM、Technical Writer が、追加の[プロダクト内参照情報](https://design.gitlab.com/usability/contextual-help/)を[ドロワーコンポーネント](https://design.gitlab.com/components/drawer/)に表示することに合意します。参照情報は、その機能の既存ドキュメントと整合する必要があります。
