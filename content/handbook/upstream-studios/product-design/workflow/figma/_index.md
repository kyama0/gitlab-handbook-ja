...
FigJam ボードの情報を安全に保つことに懸念がある場合は、[パスワード保護](https://help.figma.com/hc/en-us/articles/5726720100247-Add-password-protection-to-files)を追加できます。これにより、オープンセッションが有効なときにボードを編集できるのは、パスワードを持つ人だけになります。
