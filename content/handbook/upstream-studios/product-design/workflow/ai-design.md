...
デザインフェーズに移る前に、デザイナーが AI エンゲージメントガイドラインを作成することをお勧めします。これは Google の [People + AI Research](https://pair.withgoogle.com/) が提案したフレームワークで、ここでも使用することを提案します。このフレームワークは AI 関連のデザインおよび技術要件に関する整合性を確立する基盤を提供します。私たちはこのフレームワークを独自の Figjam テンプレート {tbd link} に適応させました。
