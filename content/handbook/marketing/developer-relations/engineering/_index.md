...
|  | |
|-----|-----|
| **ワークフロー** | [デベロッパーリレーションズエンジニアリングのコントリビューターワークフロー](/handbook/marketing/developer-relations/engineering/community-contributors-workflows) |
...
このチームの目標は、コントリビュータープログラムをリードし、私たちと一緒に GitLab を共創するお客様を支援・惹きつけ、技術面・プロセス面の改善を通じてコントリビューションプロセスの効率を高め、GitLab にマージされた MR を月に 170 件以上提出するコントリビューターを目指すという私たちの野心を持続させることです。これは、[**誰もが世界を動かすソフトウェアにコントリビュートし、共創できるようにする**](/handbook/company/mission/#mission )という GitLab のミッションと、[3 年間の社内会社戦略](https://internal.gitlab.com/handbook/company/three-year-strategy/)に沿っています。
...
- [デベロッパーリレーションズチーム](/handbook/marketing/developer-relations/)と協力して、コミュニティの表彰システム、アワード、エンジニアリング支援を改善する。
...
このチームは[デベロッパーリレーションズエンジニアリングのかんばんボード](https://gitlab.com/groups/gitlab-org/-/boards/7745119?label_name[]=Contributor%20Success)を使用します。Issue は次を満たす必要があります。
...
- `workflow::complete`: 実装後に解決された Issue。これらは、クローズする前にチームおよびデベロッパーリレーションズ部門へのレポートで強調すべきです。
...
デベロッパーリレーションズエンジニアリングの DRI は、将来簡単に取り出せるよう、チームトラッカー [`gitlab-org/developer-relations/contributor-success/team-task`](https://gitlab.com/gitlab-org/developer-relations/contributor-success/team-task/-/issues) に Issue を作成する責任を負います。

デベロッパーリレーションズエンジニアリングの DRI は、フィードバックを咀嚼し、投票の後に新しい四半期に持ち込む 1 つの Issue を選ぶ責任を負います。

## デベロッパーリレーションズエンジニアリングのスタンドアップ

このスタンドアップの目的は、デベロッパーリレーションズエンジニアリングのチームメンバー間で協力することです。これは、ブロッカーや進捗を確認し、異なる視点で考え、私たちの目標に向けてイテレーションするための、チーム固有のミーティングです。

- アジェンダ: <https://docs.google.com/document/d/1chIzCdg1CNRrRRuYR7c7OW_BF1mBxKFTJoXyP2HLt4E/edit#heading=h.o6qzal1u0b7i>

## デベロッパーリレーションズエンジニアリングのリーディングリスト
...
NOTE: Zoom リンクにパスワードが埋め込まれていることを確認してください。
