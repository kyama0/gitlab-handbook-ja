...
### IDE での AI と GitLab Duo {#ai-and-gitlab-duo-in-ides}
...
#### 推奨設定と拡張機能 {#recommended-settings-and-extensions}
...
##### Chat を右パネルに移動 {#move-chat-to-the-right-panel}
...
#### デモ設定: JetBrains IDE での外観 {#demo-settings-appearance-in-jetbrains-ides}
...
> 注意: Windows と Visual Studio ライセンスへのアクセスが必要で、追加のセキュリティレビューも必要です。
>
> ステータス: 調査中。ToDo は [この社内 issue](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/712) で追跡しています。
...
> ステータス: 非アクティブ。現在、インフラストラクチャのメンテナーはいません。以下のドキュメントは、将来の歴史的な参照のために残されています。
...
### Dev Environments を強調する講演とデモ {#talks-and-demos-highlighting-dev-environments}
