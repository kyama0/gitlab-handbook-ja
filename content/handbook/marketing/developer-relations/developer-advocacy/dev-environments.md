...
![JetBrains IntelliJ IDEA に Duo Agentic Chat を表示し、Java 8 を 21 にモダナイズ中。エディタはエージェント編集による差分ビューを表示。](/images/handbook/marketing/developer-relations/developer-advocacy/dev-environments/jetbrains_intellij_idea_light_theme_dap_java_modernize_agentic_edits.png)
