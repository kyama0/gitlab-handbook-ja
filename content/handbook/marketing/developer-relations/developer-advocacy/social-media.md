...
- [OpenGraph validator](https://www.opengraph.xyz/) でタグ（ソーシャルプレビューを含む）をデバッグします。
...
メリット: コンテンツ共有（例: [GitLab ブログ](https://about.gitlab.com/blog/)/）のリーチを増やし、[creator mode プロフィール](/handbook/marketing/developer-relations/developer-advocacy/social-media/#linkedin-use-creator-mode-profile)を使って新しいフォロワーを引きつけます。
...
#### LinkedIn: Creator Mode プロフィールを使う {#linkedin-use-creator-mode-profile}
...
LinkedIn は、複数のメリットをもたらすプロフィール向けの [Creator Mode](https://www.linkedin.com/help/linkedin/answer/a522537/creator-mode) を提供しています:
...
Creator Mode を有効にした [Michael Friedrich](https://www.linkedin.com/in/dnsmichi/) のプロフィール例:

![Creator Mode を有効にした LinkedIn プロフィール: Michael Friedrich](/images/handbook/marketing/developer-relations/developer-advocacy/social-media/linkedin_creator_mode_profile_michael_friedrich.png)
...
1. チームメンバーや友人に、[Starter Packs](/handbook/marketing/developer-relations/developer-advocacy/social-media/#bluesky-starter-packs) への追加を依頼します。
...
[GitLab のリリース](https://about.gitlab.com/releases/)は、毎月多くの価値を追加します。開発者として、あなたはそれらが具体的に解決するユースケースやワークフローの強化を知っています。この知識を使って、なぜこの新機能があなたを助けるのか **why** を説明してください。
...
最初のパイロット実験は、[2021 年 8 月の GitLab 14.2](https://gitlab.com/gitlab-org/verify-stage/-/issues/97#note_664350725) のために、私たちの [Verify product group](/handbook/product/categories/#verify-stage) で確立されました。DRI は @jreporter（Group Manager, Product）と @dnsmichi（DE stable counterpart）でした。
