---
title: "テクニカルマーケティングのデモ動画の作成と公開"
upstream_path: /handbook/marketing/developer-relations/technical-marketing/howto/create-and-publish-demos/
...
これはデモ動画の作成と公開の手順に関する SSoT です。これらは Issue テンプレートに表示されるように設計されています。デモの Issue テンプレートにはいくつかの種類がありますが、これは共通する内容です（一部の特定の公開先の詳細は Issue テンプレートごとに調整する必要があります）。
