---
title: "テクニカルマーケティング コンテンツライブラリ"
description: "GitLab のテクニカルマーケティングチームが作成した技術コンテンツのライブラリ。"
upstream_path: /handbook/marketing/developer-relations/technical-marketing/content-library/
...
著者: [Itzik Gan-Baruch](https://gitlab.com/itzikgb)
...
著者: [Cesar Saavedra](https://gitlab.com/csaavedra1)
...
How to use Quarkus with GL - (Q2 予定)

What's GitOps and why go that route rather than K8s? - (Q2 予定)

In praise of developer experimentation - (Q2 予定)
...
著者: [William Arias](https://gitlab.com/warias)
...
著者: [Fernando Diaz](https://gitlab.com/fjdiaz)

Ensuring Continuous Software Compliance with GitLab - (Q1 予定)

Integrating Jaeger Distributed Tracing with GitLab - (Q2 予定)

Configuring Audit Event Streaming - (Q2 予定)

Setting up Connection to Hashicorp Vault with OIDC - (Q2 予定)

GitOps using Terraform with Integrated Security Scanning - (Q2 予定)

GitLab Technical Marketing Demo Resources - (Q2 予定)
...
著者: [Tye Davis](https://gitlab.com/tyed19)
...
GitLab Premium capabilities tech video playlist - 作成予定

GitLab Ultimate capabilities tech videos playlist - 作成予定
...
GitLab の [YouTube チャンネル](https://www.youtube.com/c/gitlab/playlists) を検索することで参照できます
...
[こちら](https://drive.google.com/drive/folders/1Qm8Y3oVLRa0nS1BARA631Ex6SKVzYp3C?usp=sharing) を参照してください
