...
1. Google Cloud / AWS では、[商標化されていないドメインを登録](https://internal.gitlab.com/handbook/security/product_security/infrastructure_security/guides/domains-dns/#non-trademark-domain-names)（社内）してデモ用途で利用することもできます。
