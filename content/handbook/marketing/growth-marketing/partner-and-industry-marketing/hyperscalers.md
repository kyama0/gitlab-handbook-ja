...
upstream_path: "/handbook/marketing/growth-marketing/partner-and-industry-marketing/hyperscalers/"
...
2. Fund Requester: 資金リクエストを開始する人
   ...
   1. キャンペーン詳細を [該当するスプレッドシート](/handbook/marketing/growth-marketing/partner-and-industry-marketing/hyperscalers/#application-process) に入力
...
3. Campaign Owner／Operations（Fund Requester は Campaign Owner も兼ねることが可能）
   ...
   3. Hyperscaler Funds Issue リンクを [該当するスプレッドシート](/handbook/marketing/growth-marketing/partner-and-industry-marketing/hyperscalers/#application-process) に追加
...
3. Operations Checklist が完了したら、Campaign Owner は Issue を [Plan から WIP](/handbook/marketing/growth-marketing/regional-marketing/#process-for-moving-events-from-plan-to-wip) に移動できます。
...
2. イベント終了から 2 週間後に、該当する [ハイパースケーラースプレッドシート](/handbook/marketing/growth-marketing/partner-and-industry-marketing/hyperscalers/#application-process) を Actual MQL と Pipeline で更新します。
...
1. Regional Marketing がマーケティング活動を管理する場合、[Plan to WIP プロセス](/handbook/marketing/growth-marketing/regional-marketing/#process-for-moving-events-from-plan-to-wip) に従います。
2. Partner Marketing がマーケティング活動を管理する場合、Partner Marketing MDF GitLab Issue を使用します:

    1. 追加の Allocadia アクティビティを作成:

       1. Partner Marketing MDF サブカテゴリーと 0 ドル値のライン項目を作成（既存の Hyperscaler セットアップに加えて）
       2. これにより、ハイパースケーラー監査証跡を維持しつつ、パートナーマーケティング側面の別個のセットアップが可能になります

    2. Issue とプロジェクトのセットアップ:

       1. Partner Marketing GitLab Issue を作成
