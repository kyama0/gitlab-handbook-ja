...
upstream_path: /handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/enterprise-it-roles/
...
- [複雑さがデジタルトランスフォーメーション成功の障害となる](https://www.cio.com/article/228830/complexity-a-killer-when-it-comes-to-digital-transformation-success.html) - [CIO が直面する 5 つの大きな課題](https://www.mrc-productivity.com/blog/2019/11/7-challenges-facing-cios-and-it-leaders-in-2020/)
...
1. **VP レベル**
   ...
   **VP Apps／Development／Engineering** - イノベーション、アップデート、機能に対するビジネスの要求を満たす支援を行う。このロールは通常、速度、市場投入時間、ビジネスとの整合性に基づいて報酬／インセンティブが支払われます。
   ...
   1. アプリケーション開発リーダーが直面する重要な課題はいくつかあります。
      - [サイクルタイム - 速度を改善する方法](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/it-groups/build/cycle-time/)
      - [安全なアプリケーションを提供する方法](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/it-groups/build/secure-applications/)
      - [ハイブリッドクラウドを乗りこなし、ロックインされない方法](/handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/it-groups/build/modernize/)
   1. リソース:
