...
## Marketo Tech Stack ガイド {#marketo-tech-stack-guide}

プロビジョニング、インテグレーション、システム図に関する詳細については、[Marketo Tech Stack ガイド](/handbook/marketing/marketing-operations/marketo/tech-stack-guide-marketo/#integrations)をご覧ください。

### Marketo Salesforce.com 接続 {#marketo-salesforcecom-connection}
...
### Salesforce のカスタム同期ルール {#custom-sync-rules-with-salesforce}
...
#### サンドボックスを SFDC ステージングに再接続する {#reconnecting-sandbox-to-sfdc-staging}
...
### ウェブサイトフォーム管理 {#website-form-management}
...
### Marketo の製品データ {#product-data-in-marketo}
...
## MQL とリードスコアリング {#mql-and-lead-scoring}
...
#### なぜスコアリングモデルを使用するのか？ {#why-do-we-use-a-scoring-model}
...
### リードスコア分類 {#lead-score-classification}
...
#### Lead Classification Matrix の使用方法と Lead Classification の読み方 {#how-to-use-the-lead-classification-matrix-and-read-the-lead-classification}
...
## リストとセグメンテーション {#lists-and-segmentation}
...
### その他のフィールドドキュメントと定義 {#other-field-documentation-and-definitions}
...
### クイックアクションとウォッチリスト {#quick-actions-and-watch-list}
