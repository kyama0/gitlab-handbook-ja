...
ZoomInfo には Okta 経由でアクセスします。チームメンバーは [Lumos](https://app.lumosidentity.com/app_store) から ZoomInfo へのアクセスをリクエストできます。

Zoominfo プラットフォームへのアクセスを受け取ったら、[Zoominfo ReachOut Chrome 拡張機能](https://chrome.google.com/webstore/detail/zoominfo-reachout/fofjcndophjadilglgimelemjkjblgpf)をダウンロードする必要があります。リンクは、ホームページの右下にスクロールしても見つけられます。
