...
translated_at: "2026-05-01T01:25:00Z"
translator: claude
stale: false
lastmod: "2026-04-20T10:10:25-07:00"
---
...
ログイン情報を受け取り、Zoominfo プラットフォームに入ったら、[Zoominfo ReachOut Chrome 拡張機能](https://chrome.google.com/webstore/detail/zoominfo-reachout/fofjcndophjadilglgimelemjkjblgpf)をダウンロードする必要があります。リンクは、ホームページの右下にスクロールしても見つけられます。
...
| [Save and Subscribe Function Explained](www.help.zoominfo.com/lightning/articles/help/Save-and-Subscribe-Function-Explained) | ZoomInfo Sales の Save and Subscribe 機能は、プラットフォームに戻ったときにユーザーがリストを再構築する必要がないように保護します。|
...
ZoomInfo の admin 管理は、Field Sales ロール (AE/SAE/ASM/ISR) のライセンスを管理、プロビジョニング、デプロビジョニングする Sales Operations チームと、Sales Development 組織 (BDA/SDR/BDR) のライセンスを管理、プロビジョニング、デプロビジョニングする Marketing Operations チームの間で共有されています。
