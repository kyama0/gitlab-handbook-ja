...
JiffleNow は、イベントやキャンペーンにおいて対面およびバーチャルの B2B ミーティングのアポイントメントスケジューリングを自動化するサービスです。
...
- リクエスト: [このフォームのコピーを作成](https://docs.google.com/document/d/1HmKshkrpeEi0Y0KqrLlZy1EPfVSJbbWMEpGzzt2OXHI/edit?tab=t.0)し、Jifflenow インスタンスをリクエストするために必要な詳細をすべて記入してください。
  - フォームの記入が完了したら、`Jifflenow Request: [Month, Year] - [name of event]` というタイトルで一般的な [Marketing Ops Issue](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/new) を作成し、Issue に `Jifflenow` ラベルを追加してください。
