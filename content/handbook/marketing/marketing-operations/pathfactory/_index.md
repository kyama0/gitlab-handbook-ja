...
**注意:**  PathFactory アクティビティは [MQL スコアリングモデル](/handbook/marketing/marketing-operations/marketo/#scoring-models) に結びついています。これは、エントリポイントがランディングページからの場合、コンテンツトラックにフォーム戦略を追加する必要がないことを意味します。
