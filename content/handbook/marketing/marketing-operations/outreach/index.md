...
| CC: Answered: Asked for Call Back | 悪いタイミングで捕まえてしまい、コールバックを依頼された、またはまだツールを評価中で数週間後にコールバック。 | 中立シグナル | シーケンス継続 | Accepted |
| CC: Answered: Create follow up task | コールに応答があり、担当者がリードを今後どう扱うかを手動で判断する必要がある。 | ポジティブシグナル | シーケンス終了 | Qualifying |
