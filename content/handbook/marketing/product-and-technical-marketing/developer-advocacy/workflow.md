---
description: "Developer Advocacy の業務を計画し、追跡するための Issue テンプレート、ボード、ラベル、自動化。"
linkTitle: "Team workflow"
title: "Developer Advocate チームのワークフロー"
upstream_path: "/handbook/marketing/product-and-technical-marketing/developer-advocacy/workflow/"
upstream_sha: "fa96dbec1adcd6457e8819e6bd3d28fddfdddf4f"
lastmod: "2026-09-18T21:20:33+02:00"
translated_at: "2026-09-20T01:55:39+00:00"
translator: codex
stale: false
---


## チームのワークフロー {#team-workflow}

Developer Advocate チームのワークフローページへようこそ。チームがどのように機能し、チームと協力する方法を学びましょう。私たちは主に [Developer Advocate Meta の Issue トラッカー](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues)を使用しています。チームラベル `developer-advocacy` と[その他のラベル](https://gitlab.com/groups/gitlab-com/-/labels?subscribed=&sort=relevance&search=developer+advocacy)を所有しており、これらは [gitlab-com](https://gitlab.com/gitlab-com)グループレベルにあります。私たちのチームが追跡するために、必要に応じてこのグループ配下の任意の Issue にラベルを追加できます。

### 概要ビデオ {#overview-video}
...
### Developer Advocacy チームの働き方 {#how-the-developer-advocacy-team--work}

チームのすべてのアクティビティは、[Developer Advocacy Meta プロジェクト](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues)、または協力する他のチームの Issue トラッカーで Issue として追跡します。アクティビティは、コンテンツ、イベント、その他のアクティビティの 3 つのカテゴリに分類されます。Issue の作成を簡単にするため、チームは関連するプレースホルダーとラベルが事前入力された Issue テンプレートを使用しています。以下に Issue テンプレートへの直接リンクを示します。

- コンテンツ：[Issue テンプレート](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?issuable_template=content)
- 競合調査：[Issue テンプレート](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/work_items/new?description_template=competitive-research)
- イベント：[Issue テンプレート](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?issuable_template=events)
- リリースエバンジェリズム：[Issue テンプレート](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?issuable_template=release-evangelism)
- その他：[Issue テンプレート](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?issuable_template=other-activities)

### Issue ボード {#issue-boards}

Issue ボードは Developer Advocacy チームのアクティビティに関する単一の信頼できる情報源です。Developer Advocate には、Issue ボードの列を期日順に並べておくことが求められます。これは、Developer Advocacy チームの作業を追跡するためにボードを使用するステークホルダーに役立ちます。

- [担当者別の Issue](https://gitlab.com/groups/gitlab-com/-/boards/7577841?label_name[]=developer-advocacy)
- [四半期別のコンテンツ](https://gitlab.com/groups/gitlab-com/-/boards/7577857?label_name[]=DA-Type%3A%3AContent&label_name[]=developer-advocacy)
- [種類別のコンテンツ](https://gitlab.com/groups/gitlab-com/-/boards/7577822?label_name[]=DA-Type%3A%3AContent&label_name[]=developer-advocacy)
- [イベント](https://gitlab.com/groups/gitlab-com/-/boards/7577874?label_name[]=developer-advocacy&label_name[]=DA-Type%3A%3AEvents)
- [Issue トリアージボード](https://gitlab.com/groups/gitlab-com/-/boards/7669248?label_name[]=DA-Bot%3A%3ATriage)

### Developer Advocate チームとの協力方法 {#how-to-work-with-the-developer-advocate-team}
...
[Developer Advocate リクエスト Issue テンプレート](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/new?issuable_template=developer-advocate-request)を使ってリクエストを送信できます。リクエストをトリアージするために必要な情報を収集するためのガイドが提供されています。

### CFP {#cfps}

講演募集（CFP） のワークフローは、[CFP ハンドブック](/handbook/marketing/product-and-technical-marketing/developer-advocacy/cfps/)で整理されています。

## ラベル {#labels}

Developer Advocate チームのワークフローはラベルでサポートされており、Issue のタイプ、ステータス、その他の関連情報を判断するのに役立ちます。チームの主要なラベルは `developer-advocacy` です。チームが所有する、参加する、または認識する必要があるすべての Issue は、`developer-advocacy` でタグ付けする必要があります。その他のラベルは以下のとおりです:

### 一般ラベル {#general-labels}

| **CFP ラベル** | **説明** |
| ---------- | ----------- |
| `developer-advocacy` | Developer Advocacy チームに関連する Issue にラベル付けするために使用 |
| `DevRel-Influenced` | DevRel、特に Developer Advocacy の影響を受けた Issue にラベル付けするために使用 |
| `DA-Ops` | Developer Advocacy の `Ops in DevOps` テーマに関連する Issue にラベル付け |
| `DA-Dev` | Developer Advocacy の `Dev in DevOps` テーマに関連する Issue にラベル付け |
| `DA-k8s` | Developer Advocacy の `Kubernetes` テーマに関連する Issue にラベル付け |

### Issue 管理 {#issue-management}

#### 一般ワークフローラベル {#general-workflow-labels}
...
|`DA-Status::OnHold` | 何らかの理由で保留中の Issue |
...
#### コンテンツワークフローラベル {#content-workflow-labels}
...
#### コンサルティングラベル {#consulting-labels}

他のチームから Developer Advocate に対する、所有、参加、またはアクティビティに協力するというリクエストはコンサルティングとして分類され、これらのリクエストは通常、依頼するチームに基づいてラベル付けされます。これらは、Developer Advocate チームが頻繁に協力する社内のチームです。それらのチームのラベルは次のとおりです:
...
コンサルティング用に作成された Issue は、チームの四半期予算に対してカウントされます。詳細は[リクエスト予算セクション](/handbook/marketing/product-and-technical-marketing/developer-advocacy/workflow/#request-budgets)で学べます。

#### リージョンベースラベル {#region-based-labels}
...
これらのラベルは、トリアージ目的で [DA-Bot](/handbook/marketing/product-and-technical-marketing/developer-advocacy/projects/#developer-relations-bot)によって自動的に割り当てられます。
...
これらのラベルは、[CFP 提出](/handbook/marketing/product-and-technical-marketing/developer-advocacy/cfps/)のワークフローを追跡するために使用されます。
...
| `CFP-OSS` | Open Source チームに関連する CFP を識別 |
...
5. イベントが終わったら、フィードバックと結果で Issue を更新します。
    1. 既存のものがあれば、トークのビデオを [YouTube プレイリスト](/handbook/marketing/product-and-technical-marketing/developer-advocacy/content/#gitlab-youtube-channel)に追加します。
...
#### イベントリクエスト {#event-requests}

イベントリクエストには、イベント参加（例：顧客ミーティングへの参加、イベントのスタッフ業務、ディナーやソーシャルイベントへの参加、ニュース収集のためのイベントのモニタリング） と、デモやプレゼンテーションなどのイベントでの登壇機会の両方が含まれます。

#### CFP（講演提案募集）リクエスト {#cfp-call-for-proposals-requests}

CFP リクエストには、Developer Advocate にイベントやメディアの機会の提案を提出するよう依頼することや、オープン CFP に提出するチームメンバーをサポートすることが含まれます。

企業、フィールド、またはパートナーイベントの CFP に Developer Advocate を提出依頼するには、[Developer Advocate に CFP の提出を依頼する](/handbook/marketing/product-and-technical-marketing/developer-advocacy/cfps/)を参照してください。

#### コンテンツリクエスト {#content-requests}

コンテンツリクエストには、ブログ記事、ポッドキャスト、メディアインタビュー、または Developer Advocate をメディアの機会に参加させるリクエストが含まれます。

#### リクエストのスコアリング {#scoring-requests}
...
- Developer Advocate チームのメンバーが Issue をトリアージし、必要なすべての詳細と指示を提供します。
