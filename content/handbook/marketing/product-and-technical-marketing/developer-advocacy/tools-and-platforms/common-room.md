---
linkTitle: "Common Room"
description: "Common Room でコミュニティの動向を把握するためのアクセス、ユースケース、レポート作成のワークフロー。"
title: "Common Room のワークフロー"
upstream_path: "/handbook/marketing/product-and-technical-marketing/developer-advocacy/tools-and-platforms/common-room/"
...
Developer Advocacy チームは、コミュニティプラットフォーム全体からのインサイトを集約、レビューし、アクションを取るために Common Room を使用します。トレンドとコミュニティの感情を追跡するためにも使用します。

## Common Room へのアクセス {#accessing-common-room}
...
3. ステップ 2 の _このアクセスの理由_ で、Common Room を使用するビジネスケースを説明し、リンクしてください。
...
## GitLab データ {#gitlab-data}

Common Room は GitLab とネイティブには統合されていません。
私たちには[カスタム Ruby スクリプト](https://gitlab.com/gitlab-org/developer-relations/gitlab-common-room-api-source)があり、
スケジュールされたパイプラインで実行してデータを取り込みます。
...
## Developer Relations のビジネスケース {#business-cases-for-developer-relations}

### GitLab コントリビューターとスーパーユーザーの支援 {#supporting-gitlab-contributors-and-super-users}

**DRI**: [Co-Create & Community Engineering チーム](/handbook/marketing/developer-relations/engineering/)
...
### コミュニティエンゲージメントの追跡 {#community-engagement-tracking}
...
### ソートリーダーシップのためのキーワードトレンドの特定と監視 {#identifying-and-monitoring-keyword-trends-for-thought-leadership}

**DRI**: [Developer Advocacy](/handbook/marketing/product-and-technical-marketing/developer-advocacy/)
**説明**:
...
### Open Source プログラムの機会の特定 {#identifying-opportunities-for-open-source-program}

**DRI**: [Growth Programs](/handbook/marketing/developer-relations/programs/)
...
### 新規メンバーのオンボーディング（Discord） {#new-member-onboarding-discord}
...
## Common Room から情報をリクエストする {#requesting-information-from-common-room}
...
### 特定の顧客エンゲージメントの追跡 {#tracking-specific-customer-engagement}
