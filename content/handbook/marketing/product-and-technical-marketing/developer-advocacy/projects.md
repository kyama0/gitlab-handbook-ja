---
description: "Developer Advocacy がデモ環境、チュートリアル、研究、自動化プロジェクトを整理し、維持する方法。"
title: "プロジェクト"
upstream_path: "/handbook/marketing/product-and-technical-marketing/developer-advocacy/projects/"
...
## 組織構成 {#organisation-structure}

すべてのプロジェクトは、トップレベルのサブグループに整理されています。トップレベルの名前空間 `gitlab.com/gitlab-da` にはプロジェクトを置くことはできません。

| グループ        | DRI | 説明  |
|--------------|-----|--------------|
| [demo-environments](https://gitlab.com/gitlab-da) | 全員 | チームが維持する長期のデモ環境 |
| [conferences](https://gitlab.com/gitlab-da/conferences) | 全員 / @fjdiaz | [カンファレンス、イベント、ミートアップなど](/handbook/marketing/product-and-technical-marketing/developer-advocacy/events/#event-booth-training)でのチームメンバー向けの公開デモのグループ  |
| [playground](https://gitlab.com/gitlab-da/playground) | 全員 | サポートなしのテストプロジェクト、シンプルなデモケース、コードスニペットなど。ブログ記事からリンクする際は、対応する use-cases または demo-environment グループに移動してください。 |
| [use-cases](https://gitlab.com/gitlab-da/use-cases) | 全員 | 製品デモ、講演、ソートリーダーシップ、研究のための特定トピックのユースケース |
| [projects](https://gitlab.com/gitlab-da/projects) | 全員 | チームが維持する本番プロジェクト。ブログプロジェクトやデモには、専用の `use-cases` グループを使用してください。 |
| [tutorials](https://gitlab.com/gitlab-da/tutorials) | 全員 | チュートリアルとワークショップ。 |
...
一部のプロジェクトは、Kubernetes クラスター、自己管理型 CI/CD Runner、クラウド VM、ドメインなどへのアクセスを必要とします。チームは、GitLab.com SaaS のデモに必要なこれらの外部インフラ依存関係をホストできる Google Cloud または AWS のクラウドリソースにアクセスできます。詳しくは[クラウドリソースのハンドブック](/handbook/marketing/product-and-technical-marketing/developer-advocacy/tools-and-platforms/cloud-resources)を参照してください。
...
[Developer Advocate の開発環境](/handbook/marketing/product-and-technical-marketing/developer-advocacy/dev-environments/)を参照してください。

## 製品導入のイニシアチブ {#product-adoption-initiatives}

### Social チームと連携した LinkedIn Live {#linkedin-lives-in-collaboration-with-the-social-team}

GitLab は、月次リリースを紹介し、製品アップデートやソートリーダーシップを共有するために、通常は毎月第 4 木曜日に月次の LinkedIn Live 配信を開催しています。各配信には、GitLab のチームメンバーとスペシャルゲストが登場し、AI を活用したソフトウェア開発の最新事情について議論します。これは [Developer Advocacy](/handbook/marketing/product-and-technical-marketing/developer-advocacy/)と [Social Media](/handbook/marketing/corporate-communications/social-marketing/)の両チームによる共同プロジェクトです。
...
| [GitLab 17 リリースイベントの振り返り](https://www.linkedin.com/video/live/urn:li:ugcPost:7212131667262492673/) | 7.3K    | 2024/06 |
| [AI の活用：GitLab の知見とイノベーション](https://www.linkedin.com/events/7219699059933020163) | 6.3K    | 2024/07 |
...
## アーカイブ済みのプロジェクト {#archived-projects}
...
- メンテナー: @sugaroverflow
- アーカイブ:
  - [FY23 ニュースレターのエピック](https://gitlab.com/groups/gitlab-com/-/epics/1915)
  ...
  - [ニュースレター各号の PDF（内部）](https://drive.google.com/drive/folders/1w086j7mTDRCUEtINm2AVivkxfctMQT2J)
...
- [YouTube プレイリスト](https://www.youtube.com/playlist?list=PL05JrBw4t0Kp5uj_JgQiSvHw1jQu0mSVZ)
- [プロジェクトを含む GitLab グループ](https://gitlab.com/gitlab-da/use-cases/ai/gitlab-duo-coffee-chat)
- [GitLab Duo](https://about.gitlab.com/gitlab-duo-agent-platform/)
- [講演：AI の力を借りた効率的な DevSecOps ワークフロー](https://docs.google.com/presentation/d/e/2PACX-1vQAS87EMBRc4FPtBs_pVMSYs-Pna6ZxV7KF9-z6iGzhNrtr8XD2cnm5nN4jT75U52sbtvfSo23nnkTI/pub?start=false&loop=false&delayms=3000&slide=id.g28d14e7db45_0_3) - [コンテンツエピック](https://gitlab.com/groups/gitlab-com/marketing/developer-relations/-/epics/402)
- [組織 Issue](https://gitlab.com/gitlab-com/marketing/developer-relations/developer-advocacy/developer-advocacy-meta/-/issues/375)
...
### CI/CD コンポーネントカタログ {#cicd-components-catalog}

[GitLab がメンテナンスするコンポーネント](https://gitlab.com/components)の CI/CD テンプレートの移行を通じて、CI/CD コンポーネントカタログのシードを支援するために、製品およびエンジニアリングと協力します。コミュニティのコンペティションやハッカソンからのコントリビューションの保守とレビューを支援します。学んだことをコンテンツやストーリーテリングに再利用します（[コンテンツエピック](https://gitlab.com/groups/gitlab-com/marketing/developer-relations/-/epics/399)）。詳しくは [FY25 Developer Relations エピック](https://gitlab.com/groups/gitlab-com/marketing/developer-relations/-/epics/466)（内部）をご覧ください。
...
- チームメンバー向けに [リリースエバンジェリズム](/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/#release-evangelism)の Issue を作成する。
- [Developer Advocacy ワークフロー](/handbook/marketing/product-and-technical-marketing/developer-advocacy/workflow/)に従って Issue をトリアージする。
