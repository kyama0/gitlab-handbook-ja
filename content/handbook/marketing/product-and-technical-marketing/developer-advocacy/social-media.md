---
description: "ソーシャルメディアで技術コンテンツを共有し、開発者コミュニティと交流するための実践的なガイダンス。"
linkTitle: "Social media"
title: "ソーシャルメディアにおける Developer Advocacy"
upstream_path: "/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/"
upstream_sha: "fa96dbec1adcd6457e8819e6bd3d28fddfdddf4f"
lastmod: "2026-09-18T21:20:33+02:00"
translated_at: "2026-09-20T01:54:53+00:00"
translator: codex
stale: false
---
...
Developer Advocacy は、ソーシャルメディアとコミュニティエンゲージメントを通じてソートリーダーシップを構築します。ここで共有するヒントと戦略は、チームメンバーやより広いコミュニティが、GitLab のエバンジェリスト・アドボケイトとして自分自身のプロフィールを構築するために使用できます。
...
GitLab の Developer Advocate には、共有したコンテンツの成果に関する分析と知見を得るため、[URL のタグ付けと追跡用の UTM](/handbook/marketing/product-and-technical-marketing/developer-advocacy/content/#utms-for-url-tagging-and-tracking)を追加することが推奨されます。

## ターゲットプラットフォーム {#target-platforms}

LinkedIn は、コンテンツ配信、リリースエバンジェリズム、顧客エンゲージメントの主要なターゲットプラットフォームです。

> 注: 2024 年の Twitter/X のプラットフォーム変更と、それに伴うコンテンツエンゲージメントの欠如により、私たちは FY25Q4 で Developer Advocate 向けのプラットフォームとしての Twitter/X を非優先化しました。
...
![Raycast 拡張機能: 絵文字のキーボードショートカット](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/raycast_extensions_settings_emojis_keyboard_shortcut.png)
...
1. オプション: 投稿の末尾を「URL はコメントにあります。」で締めます。
...
メリット: コンテンツ共有（例: [GitLab ブログ](https://about.gitlab.com/blog/)/）のリーチを増やし、[クリエイターモードのプロフィール](/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/#linkedin-use-creator-mode-profile)を使って新しいフォロワーを引きつけます。

一部のグループでは、投稿の承認にモデレーターが必要です。以下のガイドラインに従ってください:

- 投稿が役立つものであり、リンクされた記事の短い要約を提供していることを確認します
- [ソーシャルカードプレビュー](/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/#social-card-validators)を確認し、人々のスクロールを止めさせるスクリーンショットや [GIF](/handbook/product/product-processes/making-gifs/)に置き換えます。
...
LinkedIn はデフォルトでユーザー間のつながりを基本としており、誰もがつながりを管理するために異なる戦略を使っています（例: 直接会った人のみなど）。ユーザーが、直接の LinkedIn のつながりを必要とせずに、あなたのコンテンツをフォローして関わりたい場合があります。これは、Twitter と同じように [自動スケジュール](/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/#sharing-content)で LinkedIn でもソートリーダーシップコンテンツを共有するのに最適な戦略です。
...
- [クリエイター分析](https://www.linkedin.com/help/linkedin/answer/a701208)
  ...
  - Developer Advocacy のソートリーダーシップ戦略メトリクスに必要です。

クリエイターモードを有効にした [Michael Friedrich](https://www.linkedin.com/in/dnsmichi/)のプロフィール例:

![クリエイターモードを有効にした LinkedIn プロフィール: Michael Friedrich](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/linkedin_creator_mode_profile_michael_friedrich.png)
...
2. 検索バーをタップします。
   ...
   ![LinkedIn iOS アプリ: 検索バー](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/linkedin_mobile_app_qr_code_connect_01_search_bar.png)

3. このアクションにより、検索バーの右側に QR コードアイコンが表示されます。

   ![LinkedIn iOS アプリ: 検索バー、QR アイコン](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/linkedin_mobile_app_qr_code_connect_02_search_bar_qr_icon.png)

4. QR コードアイコンをタップして、共有用の QR コードを表示します。

   ![LinkedIn iOS アプリ: QR コードビュー](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/linkedin_mobile_app_qr_code_connect_03_qr_code_view.png)
...
1. オプション: アプリをダウンロードします
    ...
    - アプリストアから [Android](https://play.google.com/store/apps/details?id=xyz.blueskyweb.app&hl=en&pli=1)。
1. Bluesky にログインします。
1. アカウントをセットアップします。
   ...
   ![@dnsmichi の Bluesky プロフィール、@gitlab.com ブランドハンドル付き](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/bluesky_profile_bio_gitlab.png)
...
1. 投稿を保存するブックマークアクション（[Issue](https://github.com/bluesky-social/social-app/issues/1091)）。
   ...
   ![Bluesky のフィード、ピン付き](/images/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/bluesky_bookmarks_workaround_pins_feed.png)
...
| GitLab ブランドのソーシャルアカウント | [@gitlab.com](https://bsky.app/profile/gitlab.com) |
...
- Steven Borrelli による [Bluesky の技術系スターターパック一覧](https://github.com/stevendborrelli/bluesky-tech-starter-packs)
- Dana Woodman による [Bluesky のスターターパックスレッド - 開発、クラウドネイティブ、運用、セキュリティ](https://bsky.app/profile/danawoodman.com/post/3l7yeqhnopp2s)
- Mubashar Iqbal による [Bluesky Directory - 検索機能付きの厳選コレクション](https://blueskydirectory.com/)

#### Bluesky のフォロワーとエンゲージメント {#followers-and-engagements-on-bluesky}

1. チームメンバーや友人に、[スターターパック](/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/#bluesky-starter-packs)への追加を依頼します。
...
1. Mastodon は投稿のインプレッションを追跡しません。GitLab 所有のコンテンツには **常に** [短縮 URL による UTM トラッキング](/handbook/marketing/product-and-technical-marketing/developer-advocacy/social-media/#utm-tracking)を使用してください。
...
- [GitLab Forum](https://forum.gitlab.com/) - [ハンドブック](/handbook/marketing/product-and-technical-marketing/developer-advocacy/tools-and-platforms/forum/)
...
- ブログ＆ニュース
  ...
  - [GitLab ブログ](https://about.gitlab.com/blog/)
...
- 興味深いストーリーを共有するユーザーをフォローします
  - そのユーザーがフォローバックする可能性があり、フォロワー数が増えます。
...
- GitLab の競合他社を批判しないでください。
  - 代わりに、競合他社のコミュニティに関わり、改善方法を学びます。
- フィードバックを製品・エンジニアリングチームに還元します。
- ライブストリーミングやコミュニティコーヒーチャットで新しいアイデアを採用します。
  - コミュニティメンバーをディスカッションに巻き込みます。

例: Chromium のビルド時間に関するディスカッションが、月曜日に [自動スケーリングする Runner を備えた GitLab Self-Managed](https://twitter.com/dnsmichi/status/1351241954349223944)へとつながりました。水曜日には、[YouTube のライブ配信](https://twitter.com/dnsmichi/status/1351944765697363974)で、[#everyonecancontribute cafe](https://www.youtube.com/watch?v=isKaBJ4VT24)の中で試すことにしました。その後、Max が [ブログ記事](https://web.archive.org/web/20240211154203/https://fotoallerlei.com/blog/2020/autoscaling-gitlab-runners-on-hetzner-cloud/)を書きました。
...
[GitLab のリリース](https://about.gitlab.com/releases/)は、毎月多くの価値を追加します。開発者として、あなたはそれらが具体的に解決するユースケースやワークフローの強化を知っています。この知識を使って、この新機能があなたに役立つ **理由** を説明してください。
...
- 14.9: Notable Contributor の紹介：[LinkedIn](https://www.linkedin.com/posts/dnsmichi_terraform-everyonecancontribute-activity-6912476005810999296-ig8Q)（3,000+ ビュー、60+ リアクション）
- 14.8: Notable Contributor の紹介：[Twitter](https://twitter.com/dnsmichi/status/1496140144067465227)（8,000 インプレッション、150 エンゲージメント）[LinkedIn](https://www.linkedin.com/posts/dnsmichi_everyonecancontribute-devops-activity-6901905241671835648-X4Vk)（2,500 ビュー、32 リアクション）
- 14.7: Notable Contributor の紹介：[Twitter](https://twitter.com/dnsmichi/status/1484898545849315333)（18,000 インプレッション、600 エンゲージメント）[LinkedIn](https://www.linkedin.com/posts/dnsmichi_everyonecancontribute-community-devops-activity-6890664006277754880-OCJ5)（7,500 ビュー、150 リアクション）
- 14.6: Issue のタイトルでの Markdown のレンダリング：[LinkedIn](https://www.linkedin.com/posts/dnsmichi_yesssss-gitlab-146-allows-to-render-markdown-activity-6879493371191156736-RHCu)（3,000 ビュー、62 リアクション）
- 14.6: Notable Contributor の紹介：[LinkedIn](https://www.linkedin.com/posts/dnsmichi_everyonecancontribute-activity-6879464875018465280-skt5)（1,500 ビュー、30 リアクション）
- 14.5: IaC のセキュリティスキャン：[LinkedIn](https://www.linkedin.com/posts/dnsmichi_security-infrastructureascode-kics-activity-6870082879037173761-kyaQ)（2,300 ビュー、28 リアクション）
- 14.5: CI/CD における exists を使った条件付きインクルード：[Twitter](https://twitter.com/dnsmichi/status/1464279272214958095)（12,000 インプレッション、600 エンゲージメント）
- 14.3: CI/CD における条件付きインクルード：[Twitter](https://twitter.com/dnsmichi/status/1440690461673340933)（21,000 インプレッション、1,800 エンゲージメント）
- 14.2: ステージのない CI/CD パイプライン：[Twitter](https://twitter.com/dnsmichi/status/1429475480030351364)（55,000 インプレッション、1,900 エンゲージメント）と [LinkedIn](https://www.linkedin.com/posts/dnsmichi_async-cicd-pipelines-with-needs-as-job-activity-6835241415748939776-I6kI)（9,000 ビュー、127 リアクション）
- 14.2: Gitpod で MR を開く機能の Notable Contributor の紹介：[Twitter](https://twitter.com/dnsmichi/status/1429469773058936841)（43,000 インプレッション、300 エンゲージメント）[RT-引用ツイート](https://twitter.com/ludmann/status/1429735681513951235)
- 14.2: Markdown のライブプレビュー：[Twitter](https://twitter.com/dnsmichi/status/1429463680182276100)（7,000 インプレッション、300 エンゲージメント）[LinkedIn](https://www.linkedin.com/posts/dnsmichi_wohooooooo-live-markdown-preview-while-typing-activity-6835229767072014336-sDCg)（5,000 ビュー、62 リアクション）
- 14.2: CI/CD の include 文のパラメーター化：[Twitter](https://twitter.com/dnsmichi/status/1429473222098100233)（8,000 インプレッション、400 エンゲージメント）[LinkedIn](https://www.linkedin.com/posts/dnsmichi_you-can-parametrize-cicd-include-statements-activity-6835239058843688960-Xc6v)（800 ビュー、13 リアクション）
- 14.2 @Jira の Issue から @gitlab で直接ブランチを作成？！ぜひ使いたい機能です：[Twitter](https://twitter.com/olearycrew/status/1429899257700618249)（15,000 インプレッション、900 エンゲージメント）
- 14.2 ご覧ください。GitLab プロフィールに代名詞と名前の発音の両方が追加されました：[Twitter](https://twitter.com/olearycrew/status/1429459101294157829)（5,000 インプレッション、150 エンゲージメント）
- 14.1: MR のステータスチェック用の外部 API：[Twitter](https://twitter.com/dnsmichi/status/1418271636722274307)（8,000 インプレッション、500 エンゲージメント）
...
- 14.1: Kubernetes クラスターのイメージスキャン：[LinkedIn](https://www.linkedin.com/posts/dnsmichi_kubernetes-activity-6823916460750974976-FJEc)（2,500 ビュー、27 リアクション）
- 14.0: パイプラインエディター：[Twitter](https://twitter.com/dnsmichi/status/1407359717282828298)（38,000 インプレッション、1,400 エンゲージメント）
- 14.0: GitLab のコンテナスキャンで @AquaSecTeam の Trivy を使用：[Twitter](https://twitter.com/olearycrew/status/1407358974601707520)（7,000 インプレッション、100 エンゲージメント）
- 14.0: Terraform モジュールレジストリの導入：[Twitter](https://twitter.com/sarki247/status/1407995667121901568)（4,200 インプレッション、55 エンゲージメント）
- 14.0: Helm 3 を使うクラスター管理プロジェクトテンプレート：[Twitter](https://twitter.com/sarki247/status/1408056830551601159)（2,000 インプレッション、64 エンゲージメント）

過去の例:

- [13.12: 条件に基づく動的な CI/CD 変数（Twitter）](https://twitter.com/dnsmichi/status/1396129739622998022)（23,000 インプレッション、2,300 エンゲージメント）
- [13.11: 13.11 を紹介し、13.12 を予告する連続ツイート](https://twitter.com/dnsmichi/status/1395686623132758017)（32,000 インプレッション）
- [13.10: CI/CD 変数のネスト（Twitter）](https://twitter.com/dnsmichi/status/1383014333500813322)（18,000 インプレッション、1,100 エンゲージメント）[LinkedIn](https://www.linkedin.com/posts/dnsmichi_gitlab-1310-allows-to-nest-cicd-variables-activity-6787693633425424384-WelD)（2,300 ビュー、35 リアクション）
- [13.10: 子パイプラインのトリガーでの CI/CD ジョブの並列実行（Twitter）](https://twitter.com/dnsmichi/status/1382351735960797184)（13,000 インプレッション、700 エンゲージメント）[LinkedIn](https://www.linkedin.com/posts/dnsmichi_parallel-cicd-job-execution-in-gitlab-improves-activity-6788117887266652160-hNIV)（1,100 ビュー、25 リアクション）
- [13.9: 展開された CI/CD 設定（Twitter）](https://twitter.com/dnsmichi/status/1363879804785803268)（5,000 インプレッション、400 エンゲージメント）
...
- [13.8: CI パイプラインエディター（LinkedIn）](https://www.linkedin.com/posts/dnsmichi_best-release-ever-gitlab-inc138-is-here-activity-6758427487870451712-TttR)（5,000 ビュー、10 コメント、316 リアクション、15 再共有）
...
- [13.7: マージリクエストのレビュアー（LinkedIn）](https://www.linkedin.com/posts/dnsmichi_gitlab-devops-productivity-activity-6756907989321433088-TRW9)（500 ビュー、16 リアクション）
- [13.7: CI/CD ジョブログ内でレンダリングされる URL（LinkedIn）](https://www.linkedin.com/posts/dnsmichi_everyonecancontribute-activity-6723982784492273664-cwg0)（4,800 ビュー、350 リアクション、12 コメント）
- [13.6: VS Code の GitLab ワークフロー（Twitter）](https://twitter.com/dnsmichi/status/1336362663107063808)（16,000 インプレッション、700 エンゲージメント）
- [13.5: グループ Wiki（Twitter）](https://twitter.com/dnsmichi/status/1319656105249820672)（18,000 インプレッション、600 エンゲージメント）
- [13.4: パイプライン効率化のドキュメント（LinkedIn）](https://www.linkedin.com/posts/dnsmichi_on-a-personal-note-my-first-larger-contribution-activity-6714235003447853056-Kkv4)（2,100 ビュー、49 リアクション）
- [13.3: KubeCon の Kubernetes 関連の予告](https://twitter.com/dnsmichi/status/1296051268448915456)（18,000 インプレッション、500 エンゲージメント）
- [13.3: CI/CD ジョブの並列実行によるマトリックスビルド（LinkedIn）](https://www.linkedin.com/posts/dnsmichi_gitlab-development-cicd-activity-6702933595721351168-c-nV)（2,400 ビュー、49 リアクション）
...
Developer Advocate は、毎月 18 日前後のリリース前に、エンドユーザーの視点に立ってリリースブログ記事の項目をレビューする手助けをします。レビューには以下が含まれます:

- 機能の説明と、解決される問題/ユースケースの明確化。
- 機能を主要機能として取り上げることを提案。
- 大きな影響を与える、または欠けている追加項目を Changelog から追加。

最初のパイロット実験は、私たちの [Verify 製品グループ](/handbook/product/categories/#verify-stage)とともに、[2021 年 8 月の GitLab 14.2](https://gitlab.com/gitlab-org/verify-stage/-/issues/97#note_664350725)に向けて開始しました。DRI は @jreporter（Group Manager, Product）と @dnsmichi（DE stable counterpart）でした。
...
質問が来た場合や、より多くの専門家を巻き込む場合、Developer Advocate は Slack の [#developer-advocacy](https://gitlab.slack.com/archives/CMELFQS4B)で手助けできます。
...
- ユーザーが自分のユースケースを解決するよう促す、かっこいいタイトルを選びます: `Unstable npm mirrors no more: @gitlab got you covered - the NPM registry will be open sourced.`
- デモ環境に移動し、ガイドステップを含む 1〜4 枚のスクリーンショットを作成します（ミニチュートリアルにします）
- リリースブログ記事への URL を含めるべきです
- ユーザー名の前に @ を付けて @gitlab をメンションします
