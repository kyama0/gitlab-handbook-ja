...
### 顧客の採用と価値 {#customer-adoption-and-value}
...
- [Weaveworks Flux CD](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/gitops/#weaveworks---using-flux-oss-operator) - 主なソリューションは GitOps オペレーターのみで、エンドツーエンドの GitOps フローを実現するには複数の統合が必要
...
- 継続的インテグレーション（[営業リソースページ](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/ci/)、[お客様向けソリューションページ](https://about.gitlab.com/solutions/continuous-integration/)）
- 継続的デリバリー（[営業リソースページ](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/cd/)、[お客様向けソリューションページ](https://about.gitlab.com/stages-devops-lifecycle/continuous-delivery/)）
- ソースコード管理（[営業リソースページ](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/version-control-collaboration/)、[お客様向けソリューションページ](https://about.gitlab.com/solutions/source-code-management/)）
- GitOps（[営業リソースページ](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/gitops/)、[お客様向けソリューションページ](https://about.gitlab.com/solutions/gitops/)）
...
- [ソースコード管理](https://docs.google.com/presentation/d/1mVi6-dsMsaA-KPVd2fn1StXuJQ62-kJDm-4J0rc_B1U/edit?usp=sharing)
- [継続的インテグレーション](https://docs.google.com/presentation/d/1O6iwRt1DO9m-3vp3RAsUDLp6PGTOoA16UUrsBmx_MJo/edit#slide=id.p)
- [継続的デリバリー](https://docs.google.com/presentation/d/1bGdjQNfHxmYKYz_ZsrtyhEyXLGlv8UoTavi_aGl3UNc/edit#slide=id.p)
...
- [GitOps とは？](https://about.gitlab.com/topics/gitops/)
- [GitLab と Ansible を使用した Infrastructure as Code](https://about.gitlab.com/blog/2019/07/01/using-ansible-and-gitlab-as-infrastructure-for-code/)
- [3 部構成の第 1 部: GitOps にコラボレーション技術が不可欠な理由](https://about.gitlab.com/topics/gitops/gitops-gitlab-collaboration/)
- [3 部構成の第 2 部: インフラストラクチャチームが GitLab と Terraform を GitOps に使用する方法](https://about.gitlab.com/topics/gitops/gitlab-enables-infrastructure-as-code/)
- [3 部構成の第 3 部: GitLab を使用して任意のクラウドへデプロイする方法](https://about.gitlab.com/topics/gitops/gitops-multicloud-deployments-gitlab/)
- [GitLab による GitOps: CI/CD トンネル](https://about.gitlab.com/blog/2022/01/07/gitops-with-gitlab-using-ci-cd/)
- [Auto DevOps 101: CI/CD をより簡単にする方法](https://about.gitlab.com/blog/2019/10/07/auto-devops-explained/)
- [プログレッシブデリバリー](https://about.gitlab.com/blog/2019/04/19/progressive-delivery-using-review-apps/)
- [継続的デリバリーパイプラインへ 3 か月で移行した方法](https://faun.pub/how-we-switch-to-a-continuous-delivery-pipeline-in-3-months-9667b9f65f7a)

### 動画

- SCM: [ソースコードのウォークスルー（2020 年 1 月）](https://www.youtube.com/watch?v=wTQ3aXJswtM) James Ramsey（Group Product Manager for the Create Stage）
- SCM: [GitLab Flow パターン](https://youtu.be/InKNIvky2KE?list=WL)
- SCM: [Design Management のウォークスルー（2020 年 1 月）](https://youtu.be/LzFRBMGl2SA) Christen Dybenko（PM Knowledge Group）
- SCM: [Web IDE のウォークスルー（2020 年 1 月）](https://www.youtube.com/watch?v=oDZu71nWctc&list=PL05JrBw4t0Kp0LPy37-rcLf9KYppouxPR&index=11&t=2s) Kai Armstrong（PM Editor Group）
- SCM: [ソフトウェア開発ライフサイクルの一部としての Merge Request とソース管理](https://youtu.be/UuX-GnYWNwo?t=274) William Chia（sPMM CI/CD）
- SCM: [GitLab の名前空間: ユーザー、グループ、サブグループ](https://www.youtube.com/watch?v=r0sJgjR2f5A) Brendan O'Leary（Tech Evangelist）
- SCM: [信頼できるワークフローを構築するための充実した変更管理](https://youtu.be/uW95PV8d-w8?t=186) Darwin Sanoy（Solutions Architect）
- CI/CD: [GitLab による CI/CD](https://youtu.be/1iXFbchozdY)
- CI/CD: [複雑な CI/CD のための GitLab: 堅牢で可視性の高いパイプライン](https://youtu.be/qy8A7Vp_7_8)
- CI/CD: [Runner はどのように動作するか？](https://youtu.be/IsthhMm64u8)
- CI/CD: [CI/CD を習得する](https://about.gitlab.com/webcast/mastering-ci-cd/)
- CI/CD: [Auto DevOps とは？](https://www.youtube.com/watch?v=pPRF1HEtQ3s&feature=youtu.be)
- GitOps: [GitOps とは？なぜ重要なのか？どう始めるか？](https://www.youtube.com/watch?v=JtZfnrwOOAw)
- GitOps: [Infrastructure as Code とは](https://www.youtube.com/watch?v=zWw2wuiKd5o)
- GitOps: [GitLab と Ansible を使用した Infrastructure as Code](https://youtu.be/M-SgRTKSeOg)
- GitOps: [3 部構成の第 1 部: GitLab が GitOps を支援する方法 ― プロセス](https://www.youtube.com/watch?v=wk7YAXijIZI)
- GitOps: [3 部構成の第 2 部: GitLab が GitOps を支援する方法 ― インフラストラクチャ](https://www.youtube.com/watch?v=5rqoLj8N5PA)
- GitOps: [3 部構成の第 3 部: GitLab が GitOps を支援する方法 ― アプリケーション](https://www.youtube.com/watch?v=heQ1WY_08Tc)
- GitOps: [GitLab と Terraform による GitOps](https://www.youtube.com/watch?v=G7JOjI6V3AY)
- GitOps: [GitOps に GitLab を使用してサイロを解消し、コラボレーションを促進する](https://www.youtube.com/watch?v=5ykRuaZvY-E)
- GitOps: [GitOps クリックスルーデモ](https://drive.google.com/open?id=1UT32lLvXtwAslkK7o8asbko3a231WKrjmlcM0z9coPw)
...
- [CS Skills Exchange: CI の詳細解説](https://www.youtube.com/watch?v=ZVUbmVac-m8&list=PL05JrBw4t0KorkxIFgZGnzzxjZRCGROt_&index=3&t=0s)
- [CS Skills Exchange: Runner 概要](https://www.youtube.com/watch?v=JFMXe1nMopo&list=PL05JrBw4t0KorkxIFgZGnzzxjZRCGROt_&index=11&t=0s)
- [CS Skills Exchange: Runner 概要](https://www.youtube.com/watch?v=JFMXe1nMopo&list=PL05JrBw4t0KorkxIFgZGnzzxjZRCGROt_&index=11&t=0s)
- [Microsoft Azure DevOps と技術面で競合する](https://drive.google.com/open?id=18jwSeeUylGXv8LoEedCMRfBZt9t7QLOYKCHJp-SvdqA) *(GitLab 内部限定)*
- [Jenkins と競合する](https://drive.google.com/open?id=1IvftLfaQyKn5-n1GLgCZokOoLU-FFzQ8LfJ9cf0FVeg) *(GitLab 内部限定)*
- [CI/CD で仕事を楽にするプレゼンテーション](https://docs.google.com/presentation/d/1scYkmV4Xdfj-8iwwpEiLCe0vBfpAdrL5pyA2w1Fgnf0/edit#slide=id.g7193b194b5_0_96)

#### デモ動画とクリックスルーデモ

- [マーケティングの全クリックスルーデモ](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/#click-throughs)
- [マーケティングの全ライブデモ](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/#live-instructions)
...
- [Jenkins から GitLab への移行](https://youtu.be/RlEVGOpYF5Y)
- [GitHub リポジトリで GitLab CI/CD パイプラインを使用する](https://youtu.be/qgl3F2j-1cI)
- [ライブデモ: GitLab CI/CD ディープダイブ](https://youtu.be/pBe4t1CD8Fc)
