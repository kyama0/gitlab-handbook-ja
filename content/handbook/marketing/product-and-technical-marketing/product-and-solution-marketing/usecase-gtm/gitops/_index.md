...
GitOps の[市場要件](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/#market-requirements) は以下のとおりです
...
| ------ | ------ | ------ | ------ | ----
| コラボレーションの促進 | ディスカッション、ユーザータグ付け、一般コメント、インラインコメント、インライン提案、未解決スレッド追跡、コメントからの Issue 作成、提案管理、CODEOWNERS、承認 |  [Discussions](https://docs.gitlab.com/ee/user/discussions/)、[CODEOWNERS](https://docs.gitlab.com/ee/user/project/codeowners/)、[MR approvals](https://docs.gitlab.com/ee/user/project/merge_requests/approvals/) | [![GitOps でコラボレーションを促進](/images/marketing/product-and-technical-marketing/product-and-solution-marketing/usecase-gtm/gitops/youtube_social_icon_red-32x23.png) GitOps でコラボレーションを促進](https://youtu.be/onFpj_wvbLM) |
...
| テスト自動化 | パイプラインの一部としてユーザビリティ、パフォーマンステストを含み、問題があった場合は成功したデプロイにロールバック |   [リリースバージョニング](https://docs.gitlab.com/ee/user/project/releases/)、[高度なデプロイ戦略](https://about.gitlab.com/blog/2020/11/23/cd-unified-monitor-deploy/)（Canary、インクリメンタルロールアウト、Blue/Green デプロイなど）のサポート、フィーチャーフラグ、Review App、[パフォーマンステストと検証](https://about.gitlab.com/blog/2020/02/18/how-were-building-up-performance-testing-of-gitlab/) | |
...
## トップ 3 差別化要因 {#top-3-differentiators}
...
| - | ---------------------- | ------------------------- |
| GitOps を実現するための複数製品 | ArgoCD はデプロイメント部分のみに注力。フィーチャーフラグと高度なデプロイ戦略サポート用の他の Argo プロジェクトがあります。 | GitLab は単一プラットフォームに統合された必要なツール一式を提供 |
...
### Weaveworks - Flux OSS オペレーター使用 {#weaveworks---using-flux-oss-operator}
...
- IAR ハンドブックページは、[アナリストとの会話にユースケースを取り入れる](/handbook/marketing/corporate-communications/analyst-relations/#how-we-incorporate-use-cases-into-our-industry-analyst-interactions) 計画を反映するよう更新されています。
...
- [GitOps とは何か？](https://about.gitlab.com/topics/gitops/)
...
- [3 部構成の第 3 部: GitLab を GitOps に使用して任意のクラウドへデプロイする方法](https://about.gitlab.com/topics/gitops/gitops-multicloud-deployments-gitlab/)

### 動画（基本的なデモ動画を含む）

- [GitOps とは？なぜ重要なのか？どう始めるか？](https://www.youtube.com/watch?v=JtZfnrwOOAw)
- [Infrastructure as Code とは](https://www.youtube.com/watch?v=zWw2wuiKd5o)
- [GitLab と Ansible を使用した Infrastructure as Code](https://youtu.be/M-SgRTKSeOg)
- [3 部構成の第 1 部: GitLab が GitOps を支援する方法 ― プロセス](https://www.youtube.com/watch?v=wk7YAXijIZI)
- [3 部構成の第 2 部: GitLab が GitOps を支援する方法 ― インフラストラクチャ](https://www.youtube.com/watch?v=5rqoLj8N5PA)
- [3 部構成の第 3 部: GitLab が GitOps を支援する方法 ― アプリケーション](https://www.youtube.com/watch?v=heQ1WY_08Tc)
- [GitLab と Terraform による GitOps](https://www.youtube.com/watch?v=G7JOjI6V3AY)
- [GitLab を GitOps に活用してサイロを解消し、コラボレーションを促進](https://www.youtube.com/watch?v=5ykRuaZvY-E)

### クリックスルー & ライブデモ

- [GitOps クリックスルーデモ](https://drive.google.com/open?id=1UT32lLvXtwAslkK7o8asbko3a231WKrjmlcM0z9coPw)
