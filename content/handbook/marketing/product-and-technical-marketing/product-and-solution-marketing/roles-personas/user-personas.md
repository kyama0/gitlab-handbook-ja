...
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/
...
<p id="buyer-personas">バイヤーペルソナについては、<a href="/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/buyer-persona/">バイヤーペルソナページ</a>を参照してください。</p>
...
ある組織アーキタイプのペルソナが、別の組織アーキタイプの 1 つまたは複数のペルソナと類似した達成すべきこと（Jobs to be done）やその他の特性を持つことが起こり得ます。これらすべてを記述することで、見過ごされる可能性のある違いを理解し、製品開発の過程でより焦点化された決定を行うのに役立ちます。GitLab が対応する組織アーキタイプについて [詳しくはこちら](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/organization-archetype/) をご覧ください。
...
私たちは以下のペルソナを、彼らが行う仕事、モチベーション、フラストレーションの観点から記述します。このレンズを通じてユーザーを理解することは、彼らのワークフローをサポートする製品に貢献するのに役立ちます。
  ...
  1. [Parker, Product Manager](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#parker-product-manager)
  ...
  1. [Presley, Product Designer](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#presley-product-designer)
  ...
  1. [Janell, Enablement Advocate](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#janell-enablement-advocate)
  1. [Sidney, Systems Administrator](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#sidney-systems-administrator)
  ...
  1. [Ingrid, Infrastructure Operator](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#ingrid-infrastructure-operator)
  1. [Dakota, Application Development Director](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#dakota-application-development-director)
  1. [Amy, Application Security Engineer](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#amy-application-security-engineer)
  1. [Isaac, Infrastructure Security Engineer](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#isaac-infrastructure-security-engineer)
  1. [Alex, Security Operations Engineer](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#alex-security-operations-engineer)
  1. [Cameron, Compliance Manager](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#cameron-compliance-manager)
  1. [Daphne, Data Scientist](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#daphne-data-scientist)
  1. [Mia, ML Engineer](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#mia-ml-engineer)
...
- 「プロダクト」ではなく「プロジェクト」管理の役割に陥ること: プロダクトマネージャーとしての動的で戦略的な責任ではなく、主にプロジェクトマネージャーとしてタスクとタイムラインの追跡に焦点を当てていることに気づくと、モチベーションが下がります。これは、私の仕事の満足度を高める要因である、顧客ニーズへの対処、効果的な市場戦略の立案、明確なプロダクトビジョンの維持を妨げます。
...
私は時間の大部分を計画された開発タスクの完了に費やしており、約 30 〜 40% の時間がミーティング、次のスプリントの計画、バグやカスタマーリクエストの発生に応じた修正に費やされます。私は Issue ベースで作業し、チームと定期的なスタンドアップを行っています。
...
私は品質への強い関心と、それを推進するために必要なスキルを持つ組織のソフトウェアエンジニアです。私の目的は、**開発プロセスに品質を組み込むこと**と、**すべてのチームで品質のオーナーシップを推進すること**です。これを達成するため、テストプロセスと品質レポートを支援するツールを開発します。また、[テストピラミッド](https://docs.gitlab.com/development/testing_guide/testing_levels/)のあらゆるレベルでテストを書きます。組織のテストを整えて効率的かつ効果的にし、部門全体で品質に対する意識を育てる支援もします。

##### 達成すべきこと（Jobs to be done）

- **テストフレームワークの開発と保守:** 適切なレベルでテストを書きやすくする、よく保守された 1 つ以上のテストフレームワークを組織のエンジニアに提供する必要があります。
- **品質を促進するツールとレポートの提供:** 開発者が品質に関するタスクをより容易に達成し、エンジニアリングとマネジメントにフィードバックを提供できるようにするツールとレポートを作成・保守する必要があります。
- **対応する担当者との品質計画の実施:** エンジニアリングの担当者と定期的にやり取りし、今後開発されるもの、現在進行中のもの、提供されるものを追跡したいと考えています。その情報をもとに、最もリスクが高く重要な作業を特定し、コードレビューと機能の設計・実装に関する議論を通じて、適切なタイミングで品質フィードバックを提供できる必要があります。
- **テスト環境の管理** 本番で使われるソフトウェアを代表するテスト環境もプロビジョニング・保守します。これらの環境を通じて、可能な限り現実に即したテストを行い、問題をより早く検出できます。

##### スキル & 個人特性

- 集中力: エンジニアリングロールにおける品質とその意味に強く集中している
- 適応力: 開発者とアーキテクトの両方のように考えられる
- 好奇心旺盛: 物事の仕組みを学んだり、分解したりすることを楽しむ
- 技術的: ツール構築を楽しむ（コーディングスキルを持つ）
- 情熱的: ツールとプロセスの改善、品質の提唱を好む
- 効果的なコミュニケーター: 口頭でも文書でも明確に表現できる

##### フラストレーション

- 不安定なテスト
- 実行時間の長いテストスイート
- 代表的なテストデータがないため、Issue を再現できないこと
- 不安定なインフラストラクチャ
- 開発作業についてより早くフィードバックできないこと
...
- **ターミナル、コーディング環境**： Ruby、JavaScript、Terraform、その他のサポート言語を使用する VIM、VS Code、または RubyMine
- **テスト自動化フレームワーク**： プロダクトに適したテストツールの実装
- **クラウド管理コンソール**： インフラストラクチャにアクセスするため（Google Cloud Platform、Amazon Web Services、Azure）
- **環境プロビジョニング**： Terraform と Ansible
- **トリアージと緩和**：
  - Docker - Issue を再現し、環境をエミュレートするため
  - 異なる環境用のアカウント - テストとインフラストラクチャのため
  - データリポジトリとジェネレーター
  - ロギングツール
...
- 脆弱性ダッシュボードを監視するとき、仕事をより簡単かつ効率的にできるよう、監視しているすべてを 1 つのツールで見たい。
...
- ダッシュボードを監視するとき、仕事をより簡単かつ効率的にできるよう、監視しているすべてを 1 つのツールで見たい。
...
- 即座に機転を利かせ、ストレスの多い状況でも冷静さを保つことが得意
...
- セキュリティアラートやインシデントのダッシュボードを監視するとき、仕事をより簡単かつ効率的にできるよう、監視しているすべてを 1 つのツールで見たい。
...
- **PagerDuty**: インシデント対応の起点で、そこからオンコール通知が送信される
...
#### 内部ペルソナのリスト
  ...
  1. [Eddie, Content Editor (Internal persona)](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#eddie-content-editor)
  1. [Dana, Data Analyst (Internal persona)](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/user-personas/#dana-data-analyst)
...
- コンテンツを検索・置換できるツールがないと、ページの一括更新を行うのは難しいです。
