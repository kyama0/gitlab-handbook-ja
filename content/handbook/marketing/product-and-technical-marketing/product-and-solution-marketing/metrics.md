...
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/metrics/
...
| チーム | 主要メトリクス | 副次メトリクス | 最終的なメトリクス目標 |
| ---- | -------------- | ---------------- | -------------------- |
| PMM | 閲覧数 | 作成コンテンツ（ページ、ドキュメント、講演、ブログなど） | IACV アトリビューション |
| TMM | 閲覧数 | 作成コンテンツ（デモ、動画など） | IACV アトリビューション |
| AR | 閲覧数 | アナリストカバレッジ（レポート、言及、MQ、Wave など） | IACV アトリビューション |
| Cust Ref | 閲覧数 | 作成コンテンツ（ケーススタディ、引用、リファレンスなど） | IACV アトリビューション |
| Comp Intel | 閲覧数 | 作成コンテンツ（比較ページなど） | IACV アトリビューション |
...
- [Product and Solution Marketing コンテンツインベントリ Issue](https://gitlab.com/gitlab-com/marketing/strategic-marketing/product-marketing/-/issues/3353)
- [Google スプレッドシート上の MVC1](https://docs.google.com/spreadsheets/d/1W5oAlbPV610-ylM7LWv_zc6bEqQK9dI0H9Hrn2f6Jwc/edit#gid=0)
- [Google DataStudio ダッシュボード](https://datastudio.google.com/u/0/reporting/bb7a37e5-d63e-421a-9b3b-8d1ec80f72dd/page/OjYYB?s=jsv8OeXU4KI)
- YAML ベースのインベントリモデル（MVC） - 追加／変更を行う詳細は [asset_inventory ページ](./asset_inventory/) で説明されています。 ご自身のチームインベントリファイルを追加する場合は、そのページの情報に従ってください。

## Web トラフィック分析

- [Web サイトとハンドブックページ](https://datastudio.google.com/u/0/reporting/1jhpxOcfWp9B44smdc6Uv-tGMNyWoludX/page/JKsTB)
- [YouTube メトリクス](https://studio.youtube.com/channel/UCMtZ0sc1HHNtGGWZFDRTh5AC)
- 学習リンク:
  - [Shane Rice - このようなダッシュボードを構築する方法を説明する YouTube 動画](https://youtu.be/tNOD5qrH6Ao)
  - [初心者向け Google Analytics](https://analytics.google.com/analytics/academy/course/6)

## マーケティングアトリビューションモデル

- [マーケティングアトリビューション](https://10az.online.tableau.com/#/site/gitlab/views/DraftTDCampaigns-L2RInteractions/CampaignDrillDown?:iid=1)
- 学習: [マーケティングアトリビューション - クイック概要](https://experienceleague.adobe.com/en/docs/marketo-measure/using/introduction-to-marketo-measure/overview-resources/marketo-measure-attribution-models)
...
- [月次マーケティング主要メトリクスのスライド](https://docs.google.com/presentation/d/1BGcMMqNfayuGsJVjqFCOXPrt5VK8S-KwHQiGr3d5KII/edit)
- [ケーススタディ追跡ボード](https://gitlab.com/gitlab-com/marketing/strategic-marketing/customer-reference-content/case-study-content/-/boards/1804878?scope=all&utf8=%E2%9C%93&state=opened)
...
- [FY2021 SKO でのアナリストアセットのセールス利用に関するベースラインサーベイデータ](https://docs.google.com/forms/d/10A8ConBSuaxj7D-91jV0PNFMKIIWzu3eq9w1TtFY9co/edit#responses)
- Gartner 再版の[情報](https://drive.google.com/file/d/1LVaBSFwOwHZ9KJ05TyzB3NHG_Ct0Q68x/view?usp=sharing)スライド、[履歴](https://drive.google.com/file/d/14DkA5Ab8E6ZpGgeK6YeMU2FVAzMiljc6/view?usp=sharing)（閲覧数など）
Forrester 再版情報（閲覧数、ダウンロード数、滞在時間）
- [顧客リファレンスメトリクス](https://docs.google.com/presentation/d/1ajOzG91G3hxlqWo8uOuVUR8wrslTRVA8-0lFzjYXhZ0/edit?usp=sharing) - スライド 2 は現在のメトリクスの例です（プールと属性、リクエストと属性、いくらかの収益アトリビューション／インパクトの測定開始など）
- 検討すべきアイデア:
  - アナリストニュースレターメトリクス
...
- [マーケティング KPI](/handbook/company/kpis/#marketing-kpis)
