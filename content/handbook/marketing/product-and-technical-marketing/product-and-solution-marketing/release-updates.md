---
title: "プロダクトリリースアップデート"
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/release-updates/
...
GitLab チームメンバー限定で、プロダクトリーダーシップが [2021-11-16 の Contribute 2021 で Product Keynote を発表しました。動画の録画は EdCast で視聴できます](https://gitlab.edcast.com/insights/prepared)。
...
参考: Sales Enablement ハンドブックの[今後のセッション](/handbook/sales/training/sales-enablement-sessions/#upcoming-training)。Q3 FY22 のプロダクトアップデートは 2021-11-04 に行われ、以下に[動画](https://www.youtube.com/watch?v=z6hFnUtm2Gk)と[発表されたデッキ](https://docs.google.com/presentation/d/1WECT2c2d7FmfjR0woYhU-PY0FjFl8a54Y_DbQE3yinA/edit?usp=sharing)の内部版を埋め込んでいます。*外部版へのリンクは以下: [動画録画](https://www.youtube.com/watch?v=BSxhSrzhJeQ) と [発表されたデッキ](https://docs.google.com/presentation/d/1IfsxSGsZqx0tyNAW4L5noMAtMLx1LBR26xrvSN3X5jk/edit?usp=sharing)。*
...
Product Keynote: [Innovating Together on the Next Generation of DevOps](https://www.youtube.com/watch?v=jNE-lvpDeoc&list=PLFGfElNsQthYrsUB5l2O6tuNk2cc-1wdO)、[(deck, GitLab 内部限定)](https://docs.google.com/presentation/d/1NmiMn0dogvaidA8Ol5LTG-ixHWB9htZtq6dIHe5u0Pw/edit?usp=sharing)、2021-08-04
...
[The Next Iteration of DevOps, GitLab CEO Keynote](https://www.youtube.com/watch?v=Wx8tDVSeidk&list=PLFGfElNsQthbEvHYa2pCK36kmKKuJercw)（Sid Sijbrandij 出演）、2021-08-03
...
パッチリリースを含むすべてのリリース投稿の一覧は、[このブログカテゴリ「releases」](https://about.gitlab.com/releases/categories/releases/)を参照してください。

将来のリリース（重要な機能にフラグが立てられたもの）は、[Product の今後のリリースページ](https://about.gitlab.com/releases/)に掲載されています。[有料プロダクトティアの今後の機能（ティア別リスト）](https://about.gitlab.com/direction/paid_tiers/)もご覧いただけます。

GitLab SaaS で現在実行されているリリース情報は [GitLab SaaS リリースページ](https://about.gitlab.com/releases/gitlab-com/)にあります。
...
GitLab 14 にフォーカスしつつ、SKO 以降のすべてのバージョンを [このプレゼンテーション](https://docs.google.com/presentation/d/1CqCVool3S6rrnSOoQ6c0YL2vXxfnBAdMsAx7OatXLb4/edit?usp=sharing)でカバーしました:
...
[SKO Product Keynote の動画](https://gitlab.edcast.com/insights/keynote-product) と 2021-02 に発表された[デッキ](https://docs.google.com/presentation/d/1NunKRuZBnDcZi0k_N5-NQBvdy5X5ZaV4a1Qf7w126qs/edit?usp=sharing)は GitLab 内部限定です。
...
コンテンツは GitLab Value Framework の活用に関する詳細情報で更新され、[このプレゼンテーション](https://docs.google.com/presentation/d/1GHePaoupd-4CMbwY2qyySba908ukTUHLgGyyV9lDZyY/edit?usp=sharing)に含まれています:
...
GitLab 13.0 は 2020-05-22 に [このリリースブログ投稿](https://about.gitlab.com/releases/2020/05/22/gitlab-13-0-released/)とともにローンチされました。メジャーリリースのローンチでは、当時 CPO であった Scott Williamson による 13.0 のハイライトと、私たちのプロダクト戦略の主要ドライバーへの洞察を共有する以下の動画が取り上げられました:
...
GitLab 13.0 ローンチに先立ち、[このブログ投稿（動画とスライドデッキを含む）](https://about.gitlab.com/blog/2020/05/21/version-12-year-in-review/)では、バージョン 12.0 から 12.10 までを振り返りました。
...
### 12.3–12.8 セールスイネーブルメント {#123128-sales-enablement}
...
[これらのミーティングノート](https://docs.google.com/document/d/1q35EN6PkbhM7uoHGDHdmWK7RyhLa3JPlPDvJdmaaxlw/edit?usp=sharing)では、以下の 6 つのリリースをカバーしています:
...
私たちの初の四半期セールスフォーカス型プロダクトリリースアップデートは、FY20 Q3 の 12.0–12.2 を対象に、2019-08 に行われました。[GitLab Unfiltered のこの録画](https://www.youtube.com/watch?v=y2KrovJD76Q)では、[共有ノートドキュメント](https://docs.google.com/document/d/1T3Zsj90TkLD0wXXjsWQ6EhuEhtyzjXKd1EOhbxZGI3g/)からのハイライトと分析を共有しています。
...
GitLab 12.0 のローンチには、ライブストリーミングプログラム [11.0 to 12.0: How we got to DevSecOps in a single application](https://www.youtube.com/watch?v=ZopqBQQOK20) と、その中での GitLab CEO Sid Sijbrandij による Ask Me Anything が含まれていました。
...
詳細は 12.0 リリースブログ投稿: [GitLab 12.0 released with Visual Reviews and Dependency List](https://about.gitlab.com/releases/2019/06/22/gitlab-12-0-released/) をご覧ください。
...
11.0 ローンチのテーマは [Auto DevOps](https://docs.gitlab.com/ee/topics/autodevops/) でした（10.0 と同様）:
...
詳細は 11.0 リリースブログ投稿: [GitLab 11.0 released with Auto DevOps and License Management](https://about.gitlab.com/releases/2018/06/22/gitlab-11-0-released/) をご覧ください。

### 10.0 ローンチ

10.0 ローンチのテーマは [Auto DevOps](https://docs.gitlab.com/ee/topics/autodevops/) でした:
...
詳細は 10.0 リリースブログ投稿: [GitLab 10.0 released with Auto DevOps and Group Issue Boards](https://about.gitlab.com/releases/2017/09/22/gitlab-10-0-released/) をご覧ください。
...
このページは、Product と Marketing からのリリースリソースを、関連する Sales Enablement のページ、動画、プレゼンテーションと統合しています。「[ハンドブックファースト](/handbook/about/handbook-usage/#why-handbook-first)」アプローチにより、リソースが Sales や関心を持つあらゆる人にとってより見つけやすく利用しやすくなり、学習のためのより強固な基盤を提供します。
