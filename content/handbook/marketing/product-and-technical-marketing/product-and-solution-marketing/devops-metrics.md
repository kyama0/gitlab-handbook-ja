...
リードタイムは素晴らしいメトリクスです。これは開発速度を直感的に示す優れた指標だからです。何らかの形で DevOps プロセスを管理している場合、これを全体的なヘルスチェックとして見ることができます。リードタイムが数ヶ月の場合、システムやプロセスを合理化・自動化する機会の領域がおそらくいくつかあります。
