...
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/i2p/
...
> - `Commit to <your branch name> branch` が選択されていることを確認（例: Commit to 1-make-homepage-prettier branch）
> - `Commit` ボタンをクリック
...
> - Pods をクリック
> - Namespace ドロップダウンを `minimal-ruby-app-<number>` に変更
> - Pods をクリック
