...
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/cicd-deep/
...
まず、セルフサービス: 新しいハードウェアの依頼を提出し、応答を待ち、変更とコストを正当化し、場合によっては PO を提出する必要はありません。開発チームは古いマシンを倉庫から取り出し、2 分で作業を開始できます。開発チームは満足して生産性が向上し、インフラストラクチャチームもデータセンターで iOS チーム用の Mac Mini 群を管理する必要がなくなるため満足します。
