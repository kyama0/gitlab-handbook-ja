---
title: "クリックスルーをオフラインで実行する"
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/off-line-click-throughs/
...
## クリックスルーデモをオフラインで実行する

### Google スライドをオフラインで実行できるようにラップトップをセットアップする

これは [https://business.tutsplus.com/tutorials/google-slides-offline--cms-29532](https://business.tutsplus.com/tutorials/google-slides-offline--cms-29532) の手順に従って行うのが最善です

オフラインで実行する際にラップトップで使用するのと**同じ** Google ログインで上記の手順を実行することを必ず確認してください！
...
オフラインになったら、これらのプレゼンテーションを実行するには:

1. Chrome ブラウザを開き、前のセットアップで使用したのと同じユーザーでログインしていることを確認します
1. [https://docs.google.com/presentation](https://docs.google.com/presentation) にアクセスします
1. 表示したいファイルを見つけます（前に閲覧したのと同じフォルダー構造内にあるはずです）
1. 表示したいプレゼンテーションを開けば、そのまま動作するはずです。

### その他

古いバージョンをお探しですか? G-drive の [「Archive」フォルダー](https://drive.google.com/open?id=1XnEZpqqMY-gSzBXgbe-h4039zqIIPCDF)にあります。
