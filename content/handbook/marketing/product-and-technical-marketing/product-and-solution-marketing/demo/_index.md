...
- ビジョン - 私たちが向かっている方向を示すために設計（まだ開発されていない将来的なアイデアが含まれる場合がある）
- ユースケースベース - GitLab が特定のユースケースをどのように解決するかを示すために設計（私たちが販売すべき方法）
- 機能 - プロダクト機能の詳細をより深く掘り下げるために設計（見込み客のリクエストに応じて）

これらのデモにはさまざまなフォーマットがあります:

- 動画 - 受動的に視聴することで誰でもセルフデモするのに適している
- ライブ（デモのセットアップと実行方法の手順） - すべての人（特に GitLab 営業）が自身のシステムリソースでデモをセットアップしてライブで実行できるようにする。即興の深掘りが可能になる - 必ずしも良いことではない。

## 動画

## GitOps でコラボレーションを促進 (GitLab 13.2) (2020 年 7 月)
...
## バージョン管理とコラボレーション - プロダクト開発アセットへの変更を制御 (2020 年 4 月)
...
## バージョン管理とコラボレーション - アクセスを管理、追跡、維持 (2020 年 4 月)
...
## バージョン管理とコラボレーション - コラボレーションを促進 (2020 年 4 月)
...
## GitLab CI - 可視性とコラボレーション (2020 年 4 月)
...
## DevSecOps - セキュリティダッシュボードでセキュリティ脆弱性を管理 (2020 年 4 月)
...
## DevSecOps - CI/CD パイプラインにセキュリティを追加 (2020 年 4 月)
...
## DevSecOps - ライセンスコンプライアンス (2020 年 4 月)
...
## DevSecOps ユースケース概要 (12.7) (2020 年 2 月)
...
## 単一アプリケーションのメリット (12.1) (2019 年 8 月)
...
## 3 分で分かる GitLab (12.1) (2019 年 8 月)
...
## GitLab 概要 - 計画からモニタリングまで (11.3) (2018 年 10 月) (18 分)
...
## マイクロサービスで複数のアジャイルチームを運営するための Group と Project のセットアップ (11.7) (2019 年 1 月)
...
## GitLab による SAFe とアジャイル計画 (11.7) (2019 年 1 月)
...
## GitLab 11.0 の Auto DevOps (2018 年 6 月)
...
## GitLab VSM - マッピング用 Issue ボード (2018 年 6 月)
...
## GitLab VSM - ビジネス価値モニタリング (2018 年 6 月)
...
## クリックスルー {#click-throughs}

クリックスルーデモは複数の方法で実行できます:

- [オフラインで実行する](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/off-line-click-throughs/)（カンファレンス、機内での練習など）
- オンラインで [ファイルから](https://drive.google.com/drive/folders/1Qm8Y3oVLRa0nS1BARA631Ex6SKVzYp3C?usp=sharing) 実行する。プレゼンテーションを実行するのと同じ
- もしくは以下のリンクを使ってウェブからオンラインで実行する:

## GitLab の計画からモニタリングまで (2019 年 8 月 - 12.0)

 [<img src="/images/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/ptm.png" alt="">](https://tech-marketing.gitlab.io/static-demos/ptm-v14.html)
...
## Kubernetes クラスターを作成 (2019 年 8 月 - 12.0)

[<img src="/images/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/gke_setup.png" alt="">](https://tech-marketing.gitlab.io/static-demos/gke_k8s.html)
...
## マージリクエスト承認 API (2019 年 7 月 - 12.0)

 [<img src="/images/marketing/product-and-technical-marketing/product-and-solution-marketing/demo/mr_approval.png" alt="">](https://tech-marketing.gitlab.io/static-demos/mr_approval.html)
...
## アジャイルプロジェクトマネジメント (2019 年 6 月 - 12.0)
...
[G-slides ファイル](https://docs.google.com/presentation/d/13Zj83pjpwyq3s4T2fPSTuKO8NwqdCdn827GB7S-3hW8/edit?usp=sharing)

## クロスプロジェクトパイプラインのトリガーと可視化 (2019 年 5 月 - 11.10)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1AVYo0HqTrwG59G2a55YzQhbXX2EKIsxQ-9P7-g_2bQc/edit?usp=sharing)

## セキュア機能 (2019 年 3 月 - 11.8)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1fdTmdepdaq03OSfcA3pYduDxDnQEyvY4ARPqXEX8KrY/edit#slide=id.g2823c3f9ca_0_9)
[セールスイネーブルメント録画（短縮版）](https://youtu.be/hwJTiXt5T3w)

## セキュア機能（短縮版、ガイド付き） (2019 年 3 月 - 11.8)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1cfzdLFWk3hYLw_aocgunVmJCD-TSiOgypr66A_nR8VQ/edit?usp=sharing)
[ブースデモ自動再生リンク](https://docs.google.com/presentation/d/e/2PACX-1vQF2Neh1h0vFwMapLvhppr_bZZVaxbtnVvTP69xd6YNGreW5dZ43w4w5qQTmYNewmI-3pViilsvbIcX/pub?start=true&loop=true&delayms=3000)
[セールスイネーブルメント録画](https://youtu.be/hwJTiXt5T3w)

## Auto DevOps (2018 年 10 月 - 11.3)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1oKHU3MsbJmxVQyO-7c6JLMoCOS80uS-0NlcI-mRxAAY/edit?usp=sharing)
[セールスイネーブルメント録画（短縮版）](https://youtu.be/V_6bR0Kjju8)

## Auto DevOps (短縮版、ガイド付き) (2018 年 7 月 - 11.0)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1UkQI_9V-CJZcbZJBDTB7tyOg14XHCKIwNoUHW1K6tC8/edit?usp=sharing)
[ブースデモ自動再生リンク](https://docs.google.com/presentation/d/e/2PACX-1vRQ4xltHhYRO_zgbo7exF6BwR09jvPmyFzR4XvjdlpYMRqT4dctx61XCkLjfR-8sq6QyOsoEFBBJjJh/pub?start=true&loop=true&delayms=3000)
[セールスイネーブルメント録画](https://youtu.be/V_6bR0Kjju8)

## Auto DevOps - セットアップ (GKE) (2018 年 10 月 - 11.3)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1AGABPlNzMm5-rrYfwGIzueXIbPleVkGpnc2Qk6JtnWk/edit?usp=sharing)

## Auto DevOps - セットアップ (EKS) (2018 年 10 月 - 11.3)
...
[G-slides ファイル](https://docs.google.com/presentation/d/1Ejnho9pqXPj-OHNU2q51cC0xCG5c8pVLmvg-maIA7BQ/edit?usp=sharing)

## ライブ（手順） {#live-instructions}

## 計画からモニタリングまで（旧称 i2p）

[計画からモニタリングまで（旧称 i2p）](i2p/)

GitLab の単一プラットフォームによる完全な DevOps ライフサイクルを、Issue、計画、マージリクエスト、CI/CD、モニタリングを通じて、アイデアから本番環境まで紹介します。

## CI/CD ディープダイブ

[CI/CD ディープダイブ](cicd-deep/)

GitLab CI/CD パイプラインのより詳細な内容を提供します。

## 統合デモ

[統合デモ](integrations/)

Jira Issue や Jenkins パイプラインなどの一般的なツールと GitLab との統合をハイライトするデモンストレーション。

## カンファレンスブースのセットアップ

カンファレンスでクリックスルーデモを実行するために iPad の使用を始めました。また、主要なスライドとプロダクトクリップを表示するメイン画面の動画もループ再生するようになりました。これらの詳細については [カンファレンスブースのセットアップページ](conference-booth-setup/) で確認できます。
