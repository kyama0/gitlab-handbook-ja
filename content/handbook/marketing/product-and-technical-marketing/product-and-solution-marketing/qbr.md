---
title: "QBR サポート"
upstream_path: /handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/qbr/
...
GitLab では、四半期ごとのビジネスレビュー（QBR）を実施し、お客様とのやり取りから理解を深め、学びを得ています。Product and Solution Marketing では、QBR プロセスをサポートし、主要な学びを捉えると同時に、メッセージング、ポジショニング、コラテラルを改善するために将来取るべきアクションを特定するために、能動的にリスニングを行っています。これにより、営業チームがお客様を支援できるよう私たちが手助けします。

### 概要

1. 各 QBR に出席・参加します。
2. QBR では、アクションアイテムを記録します。
   - まず単一の SM Action Item Google Doc に記録し、
   - 次に SM Request Process を使用してアクションアイテムを追跡する Issue を作成します <link>

### 詳細 ― QBR 出席者として

1. QBR アクション追跡ドキュメントを開きます
...
**各 QBR ミーティングについて**:
       1. 各 QBR ミーティングごとにページ 2（各 QBR アクションアイテム用のセクション）のコピーを作成します。
       1. ヘッダー「Date-Region」を具体的な日付と地域に更新します。
       1. QBR ノートドキュメントへのリンクを追加します（既に存在する場合）
       1. この特定の QBR の QBR スライドフォルダへのリンクを追加します。
