---
title: "ブログスタイルガイド"
description: "このハンドブックページでは、GitLab ブログへの投稿に関するスタイル、句読点、スペル、文法のガイドラインについて説明します。"
upstream_path: /handbook/marketing/product-and-technical-marketing/content/editorial-team/
...
- [ブログハンドブック](/handbook/marketing/blog/)
- [ブランドガイドライン](https://design.gitlab.com/brand-overview/resources/)
...
- ブログ編集者があなたの文を 1 回以上読まなければならない場合、彼らはあなたが何を言おうとしているかについて質問するか、説明を求めるかもしれません。編集プロセスは会話であり、[協調的](/handbook/values/#collaboration)であり、共通の理解に到達するためにいくつかの非同期のやり取りが必要になることがあります。目標は常にブログ投稿のアイデアと言語の明確さを向上させることであり、これは私たちが[結果を出す](/handbook/values/#results) のに役立ちます！
...
[ローコード／ノーコードツールに関するこの投稿](https://about.gitlab.com/blog/2020/03/26/low-code-no-code/) の冒頭で、GitLab 固有のストーリーに入る前にトピックの歴史とコンテキストを示す「スイープ」パラグラフの例を見ることができます。

**2. 投稿全体をアップレベルする**

例: 「[テクニカルインタビューの問題？ あなたが面接を受けている仕事のようではない](https://about.gitlab.com/blog/2020/03/19/the-trouble-with-technical-interviews/)」は、当初は GitLab の Frontend グループがテクニカルインタビューを再設計した方法についてだけのものでした。話し合いの後、ここで語るべきより広いストーリーがあると決定されました。なぜなら GitLab のストーリー（フロントエンドテクニカルインタビューの再設計）は実際には、テクニカルインタビューが効果的でなく、常に包括的ではないという、より大きく業界全体の問題に対処していたからです。
...
[頭字語または頭文字略語](https://www.dailywritingtips.com/acronym-vs-initialism/) を使用する場合、
最初の言及で完全な用語を使用し、直後に短縮版を括弧内に含めることを確実にしてください。それ以降は
略語または頭文字略語を代わりに使用できます。

> 例: A Contributor License Agreement (CLA) は、他のプロジェクトへの
> オープンソース貢献の業界標準です。

以下は、最初に定義する必要のないよく使われる略語と頭文字略語です（ただし控えめに使用してください。[トーン・オブ・ボイス](https://design.gitlab.com/brand/overview/#tone-of-voice) を参照）:
...
## アメリカ英語 vs. イギリス英語 {#american-english-vs-british-english}

私たちはデフォルトでアメリカ英語を使用します。[このリスト](https://www.dictionary.com/e/british-english-vs-american-english/) のスペルの違いを参照してください。
...
特定の単語のスタイリングについては、[以下](#word-list) を参照してください。

### 大文字小文字 {#case}

すべてのタイトルと見出しには [センテンスケース](https://www.thoughtco.com/sentence-case-titles-1691944) を使用してください。
...
これらは GitLab という会社の[組織構造](/handbook/company/structure/#organizational-chart) を構成する要素です。要素の名前は大文字にしますが、その後の単語は大文字にしません:
...
ブログハンドブックの[ブログタイトルのガイダンス](/handbook/marketing/blog/#guide-to-the-frontmatter-in-the-mr) を参照してください。
...
特定の単語にハイフンを入れる場合については[以下](#word-list) を参照してください。
...
ブログ投稿では、よりフォーマルでなく、私たちの[トーン・オブ・ボイス](https://design.gitlab.com/brand/overview/#tone-of-voice) に沿うため、インタビュー対象者をファーストネームで参照することを好みます。

## ボイス

私たちは、ライターがブログ投稿で受動態ではなく能動態を使用することを好みます。*ボイス* は、文の主語が動詞のアクションを受けるか実行するかを記述します。トーン・オブ・ボイスについて、この [Grammarly のブログ投稿](https://www.grammarly.com/blog/sentences/active-vs-passive-voice/) で詳しく学んでください。
...
- Agile
  - [Agile methodology](https://en.wikipedia.org/wiki/Agile_software_development) を指す場合、A を大文字にする
...
私たちにはより包括的な執筆プロセスをガイドするために[ブログハンドブックのライター向けチェックリスト](/handbook/marketing/blog/#diversity-inclusion-and-belonging-dib-checklist-for-blog-writers) があります。以下のチェックリストは、公開されたコンテンツが Diversity、Inclusion、Belonging (DIB) という私たちのバリューを反映するよう、編集者向けに用意されています。

#### 画像は包括的ですか？ {#are-the-images-inclusive}

- 画像（カバー画像とスクリーンショット）は [包括的](/handbook/marketing/product-and-technical-marketing/content/editorial-team/#are-the-images-inclusive) ですか？
- 代替テキストは説明的ですか（SEO とアクセシビリティのため）？ そうでない場合は、著者をタグ付けするか、自分で変更してください。[説明的な代替テキストを書くためのヒント](https://moz.com/learn/seo/alt-text) を参照してください。

#### ライティングは包括的ですか？

- 投稿は[包括的な言葉](/handbook/company/culture/inclusion/#inclusive-language) を使用していますか？
- 投稿で取り上げられている人物が、[正しい代名詞](/handbook/people-group/orientation-identity/#how-do-i-know-which-pronouns-to-use) を使用して参照されていることを確認しましたか？ 個人の[チームページプロフィール](https://gitlab.com/close-modal) と Slack プロフィールで簡単に確認できます。
...
- ブログ投稿について DIB の質問がある場合は、推測しないでください。DIB チームに連絡するか、ブログ Issue またはマージリクエストで適切な[チームメンバーリソースグループ (TMRG)](/handbook/company/culture/inclusion/tmrg-tmag/) のリードをタグ付けしてください。

### スタイルと言語

- 投稿は私たちのスタイルガイドに準拠していますか？
- [アメリカ英語](#american-english-vs-british-english) で書かれていますか？
- すべてのタイトルと見出しは[センテンスケース](#case) になっていますか？
