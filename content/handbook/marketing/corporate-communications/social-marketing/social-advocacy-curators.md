...
upstream_path: /handbook/marketing/corporate-communications/social-marketing/social-advocacy-curators/
...
[ソーシャルメディアアドボカシープログラム](/handbook/marketing/corporate-communications/social-marketing/team-member-social-advocacy/) を通じて、GitLab チームメンバーに当社や業界全体に関する最新ニュースとアップデートを提供できます。キュレーションされたコンテンツを提供するツールを整備することで、自分自身のパーソナルブランドを構築し、各テーマのエキスパートになり、GitLab の成長に貢献できます。
...
### キュレーターの現行リスト {#current-list-of-curators}

| 名前 | トピック |
| ------ | ------ |
| TBD | アワードと寄稿記事 |
| Jessica Reeder | オールリモート |
| TBD | オープンソース |
...
- 新しい Bambu ストーリーを、共有してほしいチームと一緒に Slack で共有する。PubSec は PubSec チャンネルで、オールリモートはリモートトピックや whats-happening チャンネルで共有しましょう。ストーリーは共有されるためには露出が必要ですが、Slack で依頼を大量に流しすぎないよう注意してください。
