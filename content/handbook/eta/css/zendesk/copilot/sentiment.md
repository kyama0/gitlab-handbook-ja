...
> Intelligent triage は、AI を使用して、新規のカスタマーサポートチケットをトピック、感情、言語、および製品名などのエンティティに基づき自動的に分類します。これらの AI 分類をワークフローに組み込むことで、繰り返し発生するリクエストを自動化し、手動トリアージをなくし、エージェントをリアルタイムで支援し、リスクの高いチケットに迅速に対応できます。
