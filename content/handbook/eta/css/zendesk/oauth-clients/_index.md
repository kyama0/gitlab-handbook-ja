...
upstream_path: /handbook/eta/css/zendesk/oauth-clients/
...
## Zendesk の OAuth クライアントを理解する {#understanding-zendesk-oauth-clients}
...
## OAuth クライアントを使う {#using-oauth-clients}
...
### ベアラートークンを生成する {#generating-a-bearer-token}
...
### ベアラートークンを失効させる {#revoking-a-bearer-token}
...
### OAuth クライアントを作成する {#creating-an-oauth-client}
...
### OAuth クライアントを編集する {#editing-an-oauth-client}
...
### OAuth クライアントを削除する {#deleting-an-oauth-client}
