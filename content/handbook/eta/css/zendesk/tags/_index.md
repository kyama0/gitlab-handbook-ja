...
手動で作成したタグを Google シートに追加するようリクエストするには、[機能リクエスト Issue](https://gitlab.com/gitlab-com/eta/css/issue-tracker/-/issues/new?description_template=Feature) を作成してください (Customer Support Systems チームによる手動対応が必要です)。
