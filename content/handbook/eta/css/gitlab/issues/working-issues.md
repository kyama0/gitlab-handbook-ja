...
また、次の[グループコメントテンプレート](https://gitlab.com/groups/gitlab-com/eta/css/-/comment_templates/)を使用して、作業を支援する quickactions コメントを生成できます。
...
これを支援するため、該当する状況に適した[グループコメントテンプレート](https://gitlab.com/groups/gitlab-com/eta/css/-/comment_templates/)を使用します。
...
また、次の[グループコメントテンプレート](https://gitlab.com/groups/gitlab-com/eta/css/-/comment_templates/)を使用して、新しいステージへの移動を支援する quickactions コメントを生成できます。
...
`Request validation` [グループコメントテンプレート](https://gitlab.com/groups/gitlab-com/eta/css/-/comment_templates/)を使用して、これを支援する quickactions コメントを生成できます。
