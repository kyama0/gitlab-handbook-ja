...
### ステージ 1 - 重大度を判定する {#stage-1---determine-severity}
...
### ステージ 3 - incident.io でインシデントを作成する {#stage-3---create-an-incident-in-incidentio}
...
### ステージ 4 - インシデントをトラブルシューティングする {#stage-4---troubleshoot-the-incident}
...
### ステージ 5 - インシデントをエスカレーションする {#stage-5---escalate-the-incident}
...
### ステージ 6 - incident.io でインシデントを解決する {#stage-6---resolve-the-incident-in-incidentio}
...
### ステージ 7 - Issue を解決する {#stage-7---resolve-the-issue}
...
### ステージ 8 - インシデント後レビュー {#stage-8---after-incident-review}
