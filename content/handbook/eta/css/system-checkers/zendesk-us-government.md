...
description: 'Zendesk US Government システムチェッカーのドキュメント'
upstream_path: "/handbook/eta/css/system-checkers/zendesk-us-government/"
...
<sup>[gitlab-com/support/support-ops/support-ops-project#1890](https://gitlab.com/gitlab-com/support/support-ops/support-ops-project/-/issues/1890)で導入</sup>
...
## Zendesk US Government システムチェッカーを理解する

### Zendesk US Government システムチェッカーとは

Zendesk US Government システムチェッカーは、Zendesk US Government の状態を確認するためにスケジュールされたパイプラインを使用する仕組みです。[#feed_status-zendesk-usgov Slack チャンネル](https://gitlab.enterprise.slack.com/archives/C08PBULKRUH)に投稿します。
...
- 新規または更新済みの項目の詳細を [#feed_status-zendesk-usgov Slack チャンネル](https://gitlab.enterprise.slack.com/archives/C08PBULKRUH)に投稿する

## Zendesk US Government システムチェッカーの変更
...
Zendesk US Government システムチェッカーを変更するには、プロジェクトリポジトリで MR を作成する必要があります。正確にどの変更を行うかは、リクエスト自体によって決まります。
