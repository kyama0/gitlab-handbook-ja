...
## 私たちがこのやり方で働く理由 {#why-we-work-this-way}
...
## モデルを 1 段落で {#the-model-in-one-paragraph}
...
## モデルを 1 枚の図で {#the-model-in-one-picture}
...
### Enterprise AI（プラットフォーム Hub） {#enterprise-ai-the-platform-hub}
...
### ATO、AI Transformation Owner（スポーク） {#ato-ai-transformation-owner-the-spoke}
...
### Champion（機能内 Hub） {#champions-the-in-function-hub}
...
## 意思決定権の一覧 {#decision-rights-at-a-glance}
