...
**セキュリティのベストプラクティス:** 公共スペース（例: 空港、飛行機、電車など）で旅行する場合、使用する必要があるまでラップトップの Wi-Fi を無効にすることがセキュリティのベストプラクティスです。ワイヤレスネットワークに接続していない場合でも、ワイヤレスチップは「オンザワイヤー」のネットワークをスキャンしており、馴染みのある、または既知のネットワークへの接続を試みる場合があります。
