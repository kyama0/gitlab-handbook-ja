...
緊急または至急のリクエストの場合は、Slack の Compass アプリ（上部の検索バーに "Compass" と入力して見つけます）または it-help@gitlab.com から IT に連絡してください。

**お願い:** チームメンバーにはオンコールシフトが予定されているため、チャンネルで問い合わせ、**特定の個人に Slack のダイレクトメッセージを送らないでください（機密事項の場合を除く）**。Slack アプリでグループや個人をタグ付けする必要はありません。リクエストには**最初に対応可能になった担当者が回答します**。Slack の Compass アプリ（上部の検索バーに "Compass" と入力して見つけます）または it-help@gitlab.com から IT に連絡してください。
