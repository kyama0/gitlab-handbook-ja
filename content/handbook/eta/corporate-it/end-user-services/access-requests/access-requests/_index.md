...
build:
    ...
    render: never
aliases:
  - /handbook/security/corporate/end-user-services/access-requests/access-requests/
...
チームメンバーが現在プロビジョニング済みのシステムへのアクセスを必要としなくなった場合、または同じアクセスレベルを必要としなくなった場合（管理者からユーザーへのアクセスのダウングレードなど）、アクセス変更リクエストが記録されます。
