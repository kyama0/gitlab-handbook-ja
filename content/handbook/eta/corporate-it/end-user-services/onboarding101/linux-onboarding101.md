...
ラップトップのセットアップにさらに支援が必要な場合は、毎週火曜日に予定されているオンボーディングコール（Calendar を確認してください！）に参加するか、Slack の Compass アプリ（上部の検索バーに "Compass" と入力して見つけます）または it-help@gitlab.com へメールで IT に連絡してください。
