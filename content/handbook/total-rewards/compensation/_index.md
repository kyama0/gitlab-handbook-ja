...
## Total Rewards への問い合わせ {#contact-total-rewards}
...
#### Director 以上のボーナス {#directorbonuses}
...
#### チームメンバーがエクイティの対象になるとき {#when-team-members-are-eligible-for-equity}
...
## 報酬が決定されるとき {#when-compensation-is-determined}
...
### 年次報酬レビュー (ACR) {#annual-compensation-review-acr}
...
### ジョブプロファイルとビジネスタイトル {#job-profile-vs-business-title}
...
### 市場に整合した報酬レンジ {#market-aligned-compensation-ranges}
...
#### GitLab がロールをベンチマークする方法 {#how-gitlab-benchmarks-roles}
...
#### 市場データのセグメンテーション {#market-data-segmentation}
...
#### 報酬レンジを理解する {#understanding-compensation-ranges}
...
#### コンパレシオとは何か {#what-is-compa-ratio}
...
### 報酬レンジを確認する {#viewing-compensation-ranges}
