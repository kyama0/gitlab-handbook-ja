...
description: "スムーズで平穏な（boring な）メジャーリリースを実現するためのワーキンググループ。"
status: active
...
translator: "claude"
stale: false
lastmod: "2024-12-09T13:36:32+00:00"
---
...
メジャーリリース ワーキンググループは、廃止予定ポリシーに従ってメジャーリリースで廃止されるすべての機能が発表された時点から、メジャーリリースの少なくとも 1 マイルストーン後まで、メジャーアップグレードに伴う顧客の問題を把握し対応計画を策定するまでの期間を対象に活動します。この大まかなスケジュールは上記の属性テーブルに概説されています。
