...
| ワーキンググループの役割              | 担当者                | 役職                                                        |
|---------------------------------|-----------------------|--------------------------------------------------------------|
| ファシリテーター                     | Sharif Bennett         |  Mid Market Account Executive |
| エンジニアリングリード | Darva Satcher           | Create Engineering Manager, Editor & Knowledge                           |
| デジタルプロダクションリード | Aricka Flowers           | Manager, Digital Production                           |
| エグゼクティブステークホルダー           | Christopher Lefelhocz        | VP of Development         |
| エグゼクティブステークホルダー           | Ryan O'Nell          | VP of Commercial Sales     |

## 終了基準 {#exit-criteria}

Minorities in Tech メンタリングプログラム ワーキンググループは以下を提供します:

- [x] MIT メンタリングプログラムのフレームワーク策定
- [x] 参加者の特定
- [x] 参加者へのトレーニングの提供
- [x] 最初の MIT メンタリングプログラムの実施
- [x] 最初のメンター/メンティーペアクラスの修了
