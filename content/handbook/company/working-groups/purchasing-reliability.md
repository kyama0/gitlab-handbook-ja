...
- [gitlab-com/business-technology/enterprise-apps&293](https://gitlab.com/groups/gitlab-com/business-technology/enterprise-apps/-/epics/293): ディストリビューター e マーケットプレイス
...
1. クロスチーム調整のためにコミット済みロードマップアイテムを約 2 四半期先まで見通した、FY23 の各チームの組織体制とスタッフィング計画の定義
