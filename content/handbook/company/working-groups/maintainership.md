---
title: "メンテナーシップ"
description: "開発部門のメンテナーシップを今後 5 年間持続可能なものにするための改善"
...
前四半期においてメンテナーシップの成果にばらつきが見られました。例として、一部のメンテナーにレビューの負荷が集中しており、これが重大な職務満足度の問題やバーンアウトにつながる可能性があります。私たちは（人員数とコミュニティコントリビューション両面で）成長しているにもかかわらず、メンテナーの数は横ばいになっています。メンテナーサポートが必要なリポジトリ数は増加している一方で、カバレッジは低下しています。メンテナーであるシニアエンジニアが、ここに挙げた複数の領域でポジティブな影響を与えており、メンテナーではないエンジニアよりもキャリアの機会が多いという透明性を確保したいと考えています。

私たちの目標は、会社とオープンコアプロジェクト両方の需要を満たしながら、今後 5 年間メンテナーシップを持続できる組織を実現するためのプロセスと文化を変えることです。これには以下が含まれますが、これらに限定されません:

- 現在のメンテナー数を増やし、将来的にも増加すると予測できるフォーキャスティングを実施します。
- メンテナーがコードレビューの需要に対応できることを示す可用性の測定指標を確立します。
- MR レビューをメンテナー間で均等に分散するためのロードバランシング指標を設けます。
- メンテナーをサポートし、レビューに必要な作業を削減するためのコードレビュー機能と CI/ツールの改善を行います。
- コードベースの特定部分が適切にサポートされているか、支援が必要かを把握するためのカバレッジ・監視指標を設けます。
- 新たな規模でのメンテナーオンボーディングを改善します。
- 楽しみます。
...
このワーキンググループの終了基準は達成されましたが、2023 年 2 月 2 日まで月次フォローアップミーティングは継続されます。

## メンテナーシッププロセス

メンテナーシッププロセスについては[このページ](/handbook/engineering/workflow/code-review/#maintainer)に記載されています。

### 終了基準（100%完了）

| #  | 開始日 | 目標完了日 | 完了日 | DRI        | 基準 |
| -- | ------     | ------ | ------         | ------     | ------   |
| 1  |  2022-06-01       | 2022-07-22 | 2022-10-28            | @nhxnguyen | [メンテナーシップカバレッジのギャップを解消するための実施計画の作成](https://gitlab.com/groups/gitlab-com/-/epics/1817)|
| 2  |  2022-04-26       | 2022-07-22 | 2022-07-18      | @mwoolf | [メンテナーシッププログラムの健全性をより透明化するための指標の開発](https://gitlab.com/groups/gitlab-com/-/epics/1816) |
| 3  |  2022-05-04       | 2022-08-05 | 2022-10-04            | @robotmay_gitlab | [エンジニアとメンテナーに期待される行動と責任の更新](https://gitlab.com/groups/gitlab-com/-/epics/1815) |
| 4  |  2022-05-18       | 2022-08-05 | 2022-10-04            | @oregand | [トレーニーメンテナープロセスの効率化改善](https://gitlab.com/groups/gitlab-com/-/epics/1814) |
| 5  |  2022-06-01       | 2022-08-05 | 2022-11-16            | @sabrams | [メンテナーシップ変更に関するコミュニケーション計画の策定と実施](https://gitlab.com/groups/gitlab-com/-/epics/1813) |

### データとダッシュボード

- [レビュアー/メンテナーの可用性とキャパシティ](/handbook/engineering/workflow/code-review/#maintainerreviewer-availability) - メンテナー/レビュアーの可用率の推移と受信済み/予測レビューリクエストを表示します。
- [メンテナーとトレーニー](/handbook/engineering/development/performance-indicators/#maintainers-and-trainees)
- [メンテナーシップ需要](/handbook/engineering/workflow/code-review/#maintainer-demand)
...
| ファンクショナルリード（メンテナー - フロントエンド）         | Natalia Tepluhina | Staff Frontend Engineer |
| ファンクショナルリード（非メンテナー - バックエンド）      | Manoj M J | Senior Backend Engineer |
| ファンクショナルリード（トレーニー - Registry DB）          | Steve Abrams | Intermediate Backend Engineer |
| ファンクショナルリード（メンテナー - Workhorse, Shell） | Robert May | Senior Backend Engineer |
| ファンクショナルリード（メンテナー - フロントエンド）         | Ezekiel Kigbo | Senior Frontend Engineer |
| ファンクショナルリード（メンテナー - Omnibus）          | Balasankar C       | Senior Backend Engineer |
| ファンクショナルリード（メンテナー - CNG, Operator）    | Mitchell Nielsen | Senior Backend Engineer |
...
コミュニケーションを促進するために 2 種類のラベルセットを用意しています:
...
更新に適用できるアナウンスには一般に 3 種類あります:

1. **アラート** - 特定の個人が*知っておくべきかもしれない*こと。

  例: トレーニーとメンテナーに、プログラムが 1 年間持続することを意図しており、その時点で評価されるべきであることを知らせる。

  アラートは最も優先度の低いアナウンスのタイプです。一部の人が見逃したとしても問題ありません。アラートは通常 1 回のアナウンスで済みます。

1. **変更** - 特定の個人が*知っておく必要がある*こと。

  例: メンテナーになるために必要な承認数を変更する。
...
- [ ] 結果を軸分析するために、サブグループ（フロントエンド/バックエンド、レビュアー/トレーニー/メンテナー）を区別するための質問を追加する。
...
| 終了基準 | 関連チャンネル |
| ----------- | ----------------- |
| [メンテナーシップカバレッジのギャップを解消するための実施計画の作成](https://gitlab.com/groups/gitlab-com/-/epics/1817) | 変更によって直接影響を受けるプロジェクトのチャンネル。 |
| [メンテナーシッププログラムの健全性をより透明化するための指標の開発](https://gitlab.com/groups/gitlab-com/-/epics/1816) | `#eng_managers`<br />エンジニアリングスタッフミーティング |
| [エンジニアとメンテナーに期待される行動と責任の更新](https://gitlab.com/groups/gitlab-com/-/epics/1815) | `#trainee_maintainers`<br />`#backend_maintainers`<br />`#frontend_maintainers`<br />`#database_maintainers`<br />`#eng_managers`<br />エンジニアリングスタッフミーティング |
| [トレーニーメンテナープロセスの効率化改善](https://gitlab.com/groups/gitlab-com/-/epics/1814) | `#trainee_maintainers`<br />`#backend_maintainers`<br />`#frontend_maintainers`<br />`#database_maintainers`<br />`#eng_managers`<br />エンジニアリングスタッフミーティング |
...
[プロダクトカテゴリページ](/handbook/product/categories/)と[プロジェクトページ](/handbook/engineering/projects)は、特定のプロジェクトを所有するグループとステージを特定するのに役立ちます。明確でない場合は、プロジェクトのメンバーを直接メンバーシップでフィルタリングし、所有者やメンテナーに直接誰がプロジェクトを所有しているかを尋ねる方法もあります。
