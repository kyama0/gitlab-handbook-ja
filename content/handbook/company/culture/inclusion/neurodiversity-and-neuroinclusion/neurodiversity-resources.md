...
description: "GitLabにおいて、神経多様性に対応した仕事のためのサポートにアクセスし、合理的配慮を申請し、リソースを見つける方法。"
page_type: handbook
...
D-->|いいえ| G[あなたのマネージャーが、開示した場合に合理的配慮の理由をサポートしてくれると思いますか？また、それはGitLabのバリューに反映されていますか？]
F--> H[はい]
H-->
G--> |はい| J[必要なサポートを得るために、快適であれば開示を検討すべきです]
G--> |いいえ| K[合理的配慮とマネージャーへのアプローチの最善の方法について、People Business PartnerまたはDIBチームへの相談を検討できます]
```
