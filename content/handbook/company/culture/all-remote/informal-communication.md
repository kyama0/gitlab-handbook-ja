...
1. 子どもの頃、夢の仕事は何でしたか？ その一部はまだ真実ですか？
...
私たちはオールリモート環境で働くため、子どもや家族が予告なしにコールに登場することがよくあり、これはリモートワークの一部です。しかし、ジュースボックスチャットでは、意図的にこの方法で会い、社交する機会があります。オールリモート企業での「子どもを職場に連れて行く日」のようなものだと思ってください。
