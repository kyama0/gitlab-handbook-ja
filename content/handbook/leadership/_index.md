...
1. 同期的なブレインストーミングのコールへの参加を求められたとき、チームメンバーは代わりに Issue を開き、チームのアイデアを[非同期で](/handbook/communication/#asynchronous-communication)求める。
...
## あなた個人の README {#your-individual-readme}
...
## マトリックス組織なし {#no-matrix-organization}
