---
title: "透明性レポート"
description: "このページには GitLab の透明性レポートに関する情報とリンクが含まれています"
...
translator: claude
stale: false
lastmod: "2026-09-10T09:17:57Z"
---

{{% details summary="法執行機関リクエスト - これは GitLab が受領した政府リクエストの詳細を示す最新の法執行機関レポートです" %}}
## 2025 年 法執行機関透明性レポート

このレポートは 2025 年 1 月から 2025 年 12 月までの期間に GitLab が受領した法的リクエストをカバーし、受領したリクエストの種類、その処理状況、GitLab のユーザープライバシーと透明性へのコミットメントについてのインサイトを提供します。GitLab は公開された[法執行機関リクエストのガイドライン](/handbook/legal/privacy/law-enforcement-guidelines.md)に従ってリクエストを審査・対応します。
...
{{% details summary="2024 年 法執行機関透明性レポート（アーカイブ）" %}}

### 2024 年 法執行機関透明性レポート

このレポートは 2024 年 1 月から 2024 年 12 月までの期間に GitLab が受領した法的リクエストをカバーし、受領したリクエストの種類、その処理状況、GitLab のユーザープライバシーと透明性へのコミットメントについてのインサイトを提供します。GitLab は公開された[法執行機関リクエストのガイドライン](/handbook/legal/privacy/law-enforcement-guidelines.md)に従ってリクエストを審査・対応します。
...
{{% details summary="EU デジタルサービス法の透明性レポート - EU デジタルサービス法第 15 条および第 24 条に基づく、GitLab.com に関する GitLab の年次コンテンツモデレーションレポート" %}}

## EU デジタルサービス法の透明性レポート {#eu-digital-services-act-transparency-reports}
...
これらの年次レポートとは別に、GitLab は第 24 条(2) に基づき、欧州連合における GitLab.com の平均月間アクティブ受信者数を 6 か月ごとに公開します。現在の数値は、[DMCA とデジタルサービス法のページ](/handbook/legal/dmca/#monthly-active-recipients-in-the-european-union---digital-services-act-article-242-disclosure)にあります。

### 公開済みレポート {#published-reports}

1. **2025 年 1 月 1 日から 2025 年 12 月 31 日**: [公式レポート（XLSX）](/files/legal/gitlab-dsa-transparency-report-2025.xlsx)
2. **2024 年 2 月 17 日から 2024 年 12 月 31 日**: 以下に全文を掲載

{{% details summary="EU デジタルサービス法の透明性レポート、2024 年 2 月 17 日から 2024 年 12 月 31 日（アーカイブ）" %}}

### EU デジタルサービス法の透明性レポート 2024 {#eu-digital-services-act-transparency-report-2024}
...
##### 2024 年の GitLab について {#about-gitlab-in-2024}
...
##### 2024 年の GitLab の Trust & Safety チーム {#gitlabs-trust--safety-team-in-2024}
...
##### 2024 年の報告の提出 {#submitting-a-report-in-2024}
...
- **メール経由**: 誰でも [abuse@gitlab.com](mailto:abuse@gitlab.com)に直接連絡できます。著作権侵害の通知は [dmca@gitlab.com](mailto:dmca@gitlab.com)に提出してください。
- **EU 違法コンテンツ**: EU 内の誰でも[違法コンテンツレポートフォーム](/handbook/legal/dsa/)を通じてレポートを提出できます。

#### 2. 月間アクティブ受信者情報（第 24 条(2)）

GitLab は EU におけるサービスの平均月間アクティブ受信者に関する情報を 6 ヶ月ごとに公開しています。GitLab の EU における平均月間アクティブ受信者についての最新情報は、[公開ハンドブックページ](/handbook/legal/dmca/#monthly-active-recipients-in-the-european-union---digital-services-act-article-242-disclosure)で確認できます。

#### 3. EU コンテンツモデレーション（第 15 条(1)(c)）

##### 2024 年のモデレーションアプローチ {#moderation-approach-in-2024}
...
##### 2024 年の EU コンテンツモデレーションカテゴリの概要 {#eu-content-moderation-category-overview-for-2024}

| DSA カテゴリ | サブカテゴリ | 自動アカウントモデレーションアクション | 手動アカウントモデレーションアクション | 総モデレーションアクション |
|---|---|:---:|:---:|:---:|
| 知的財産侵害 | DMCA | 0 | 75 | 75 |
...
GitLab は違法コンテンツ専用の報告の仕組みを実装しており、[違法コンテンツ報告フォーム](/handbook/legal/dsa/)から利用できます。この仕組みは、EU または加盟国の法律に照らして違法だと考えるコンテンツを報告したい欧州連合内のユーザーが利用できます。
...
##### 2024 年の申し立てプロセス {#appeal-process-in-2024}

通知後、影響を受けるユーザーと報告者は GitLab のサポートチームに連絡するか、[abuse@gitlab.com](mailto:abuse@gitlab.com)にメールしてモデレーションアクションに対して異議を申し立てることができます。各リクエストは GitLab の Trust and Safety チームによって確立された基準に従ってレビューされます。
...
##### 2024 年の応答時間 {#response-times-in-2024}
