...
- ロゴの場合は、[illustrations/third-party-logos](https://gitlab.com/gitlab-org/gitlab-svgs/-/tree/main/illustrations/third-party-logos) ディレクトリ（[gitlab-svgs](https://gitlab.com/gitlab-org/gitlab-svgs) プロジェクト内）に画像ファイルを保存すること。
