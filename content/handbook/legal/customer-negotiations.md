...
2. パートナーによって DocuSign プロセスが開始され、Ecosystem Operations がリクエストしているパートナーが有効で認可されたパートナーであることを確認すると、LOA は法務チームにルーティングされて法務スタンプが追加され、その後 GitLab 認可署名者に実行のため。完了すると、完全に実行された LOA は DocuSign を介して GitLab Legal とパートナーに配布されます。
...
### GitLab Issues でのクロスファンクショナルなコラボレーション
