...
GitLab の有給 Parental Leave は、出産または養子縁組により親になる（性別を問わない）チームメンバーを対象とします。Parental Leave ポリシーと適格要件の詳細については、ハンドブックの [Parental Leave](/handbook/people-group/time-off-and-absence/leave-types/#gitlab-parental-leave) セクションを参照してください。

### 軍務休暇

GitLab は、軍務休暇のため仕事を欠勤するチームメンバーの権利を保護することにコミットしています。このポリシーの詳細については、ハンドブックの [Miliary Leave](/handbook/people-group/time-off-and-absence/leave-types/#military-leave) セクションを参照してください。
