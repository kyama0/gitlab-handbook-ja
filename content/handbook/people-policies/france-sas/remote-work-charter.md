...
description: GitLab France S.A.S. リモートワーク憲章 - フランス語と英語のバージョン。
...
記載された[Roles & Responsibilities](/handbook/people-policies/france-sas/right-to-disconnect-charter/#roles-and-responsibilities)のとおり、このページへの変更は code owner による承認またはマージが必要です。すべての貢献を歓迎し、奨励します。
{{% /panel %}}
...
## 日本語: GITLAB FRANCE S.A.S. リモートワーク憲章

### 前文

GitLab は、世界 65 カ国以上に 1,700 人を超えるチームメンバーを擁する、世界最大級のオールリモート企業の 1 つです。

GitLab のオールリモートアプローチは、世界中からの採用と勤務、および柔軟な労働時間を促進し、同じ場所にいるか複数のタイムゾーンに分散しているかに関わらず、チームメンバーがより良く協働できるようにします。

その結果、GitLab France S.A.S.（以下「会社」）に雇用されるすべてのチームメンバーは、100% のベースでリモートワークを行っています。

本憲章（以下「憲章」）は、適用される法的枠組みに従って会社内のリモートワークを実施・監督するために作成されました。

#### 1. 定義と適用範囲

リモートワークとは、会社の敷地内で実施できた可能性のある業務が、情報通信技術を使用してチームメンバーによって会社の敷地外で行われる、あらゆる形態の業務組織です。

完全なリモートワークは、会社の採用条件の 1 つです。

これは、会社が会社の敷地を有しておらず、すべてのチームメンバーが会社のために職務を遂行するために会社の敷地／会社の作業スペースへのアクセスを有していないことを意味します。

したがって、採用時から、会社のすべてのチームメンバーは、労働時間の 100% をリモートで遂行しています。

このリモートワーク組織が雇用契約の本質的な部分であることを考慮すると、それは雇用契約の両当事者の承認によってのみ変更または終了できます。

#### 2. リモートワークの場所

リモートワークは、チームメンバーの住居、または会社と関係するチームメンバーとの相互の合意により定義される第三の場所のいずれかで行われるものとします。

住居とは、チームメンバーの通常の居住地、つまり給与明細に住所が記載されている場所を意味します。

すべてのリモートワークの場所は、フランス領土に位置している必要があります。

#### 3. 作業場所の適応とコンプライアンス

3.1 *リモートワーク場所の適合性*

住居ベースのリモートワークの場合、チームメンバーは、健康、安全、および労働条件に関するルールに準拠した作業スペースを提供し、会社の代表者が宿舎のコンプライアンスをチェックすることを受け入れる必要があります。
適用される要件の概要が憲章に添付されています。
チームメンバーは、検査の日時について少なくとも 5 営業日前に通知されます。

さらに、リモートワーク場所は、電気設備の適合性に関する要件に準拠する必要があります。この文脈において、開始日に先立って、チームメンバーは最近の電気診断、またはそれがない場合はリモートワーク場所の電気設備の適合性に関する宣誓書を提供する必要があります。

チームメンバー自身が診断を実施することもできます（発生した費用は、それぞれの証明書の提示により会社が支払います）。

転居の場合、チームメンバーは会社に通知し、新しい住所を伝えることを約束します。新しい住居もコンプライアンスチェックの対象となる場合があります。さらに、上記のとおり電気設備の適合性を実証する必要があります。

第三の場所でのリモートワークの場合、チームメンバーは、このリモートワーク場所の電気設備の適合性、健康、安全、および労働条件に関するルールの遵守（特に人間工学、照明などの観点で）、および憲章の第 7 条による保険でこの場所がカバーされていることに関する宣誓書を提供することを約束します。この宣誓書は、この場所でリモートワークを開始する前に提供する必要があります。

リモートワーク場所の適合性に関するすべての指示は、職場での自分自身の安全を守るためにチームメンバーに義務を課す健康と安全の指示であることが想起されます。これらの指示の遵守不履行は、重大な不正行為による解雇を含む懲戒処分につながる可能性があります。

3.2 *障害のあるリモートワーカー*

リモートワークは、以下の方法で障害のある労働者に開かれています:

- 家具の適応
- 特殊なソフトウェアのインストール
- 作業環境の適応

会社のハンドブックの[reasonable accommodation](/handbook/people-policies/inc-usa/#reasonable-accommodation) セクションは、補足情報を提供します。

#### 4. 労働時間の編成

リモートワークの期間中、チームメンバーは以下を遵守することを条件として、自由に労働時間を編成できます:

- 会社で適用される通常の労働時間帯、つまり午前 9 時から午後 8 時の間の、合意された実効的な日次労働時間の制限を尊重すること。
- チームメンバーのマネージャーと合意された利用可能性期間中は、会社内で使用される典型的な遠隔通信手段（特にメール、Slack、Zoom など）で連絡を取ることが可能であること。
- 最低休息期間（2 営業日の間の連続 11 時間、週ごとの連続 35 時間）に関する施行中の法律によって課される制限。

#### 5. 労働時間と業務量

5.1 *労働時間の管理*

各リモートワーク日について、チームメンバーは適用される基準労働時間を働くものとします。該当する場合、リモートワークは、経営陣の明示的な要求がある場合を除き、いかなる時間外労働も生成しません。

リモートワーク日については、労働時間は自己申告システムに従ってカウントされ、月次バランスは各月末に要求なしでマネージャーに提出する必要があります。Payroll ハンドブックページは、これに関する詳細情報を [Global Upside - France](/handbook/finance/payroll/#global-upside---france) セクションで提供しています。

5.2 *業務量規制のモダリティ*

リモートワークは、チームメンバーの通常の業務量を増やしたり、業務の適切な遂行を危うくしたりしてはなりません。

チームメンバーは、業務の進捗についてマネージャーと定期的に、少なくとも週次のベースでコミュニケーションをとるものとします。この機会に、必要に応じてチームメンバーの業務量が再調整される場合があります。さらに、チームメンバーは、できるだけ早く解決策を見つけるために、委ねられた業務の遂行に困難がある場合にはただちにマネージャーに連絡するものとします。

年中のあらゆる再調整に関わらず、チームメンバーの業務量の進化は、憲章の第 10 条に規定されている年次インタビューで議論されます。

#### 6. 作業機材

会社は、チームメンバーの活動に必要な機材を提供および／または払い戻します。

提供される機材は以下の品目で構成されます:

- ラップトップコンピューター
- 契約上の義務の遂行に必要なソフトウェア
- 必要な場合は画面
- 必要な場合はキーボード／マウス
- 必要な場合はデスク／人間工学に基づいた椅子
- 必要な場合はプリンター

チームメンバーは以下を約束します:

- 委ねられた機材を大切に扱うこと
- 作業機材の故障または不具合が発生した場合、ただちに会社に通知すること

機材に対する技術的専門家による介入の必要性が生じた場合、チームメンバーは #it_help Slack チャンネル経由、または Team Member Enablement Issue Tracker で issue を開くことにより、IT チームに連絡します。

チームメンバーは、提供された機材の使用説明書を確認し、解雇を含むことのある処罰を伴って、これを厳密に遵守することを約束します。

必要な場合および会社の要求があった場合、チームメンバーは、この機材のインストール、使用、保守に関する必要なトレーニング、およびリモートワーク期間中にその適応に関連するトレーニングを受けることを約束します。

最後に、チームメンバーは、解雇を含むことのある処罰を伴って、[acceptable use policy](/handbook/people-group/acceptable-use-policy/) に従って会社が提供する機材を使用することを約束します。

会社は、機材の保守、修理、および必要に応じて交換の費用を負担することを約束します。
会社が提供するすべての機材はその所有物のままであり、そうしたものとして差し押さえから免除されます。

チームメンバーは、雇用契約の終了時に、会社が提供した機材を遅滞なく返却することを約束します。

#### 7. 保険

チームメンバーが住居をリモートワークに使用する場合、会社に属する機材で住居で作業しているという事実を保険会社に通知し、住居をカバーする「マルチリスク」住宅保険証明書を会社に提供することを約束します。
会社は、結果として生じる追加の保険費用（あれば）を、憲章の第 9 条で示された条件のもとで負担するものとします。

#### 8. データ保護

チームメンバーは、データ保護および機密性を確保するために会社が策定した内部ポリシーとルールを遵守することを約束します。

特に、チームメンバーは、サードパーティに情報が渡されないこと、および本人だけがワークステーションを使用することを確保するためにコンピューター機材へのアクセスがロックされることを保証します。

#### 9. リモートワーク費用と業務費用

リモートワーク目的のチームメンバーの住居の使用によって発生する費用（wifi、暖房、電気など）は、費用発生時に適用される現地の規則に従って会社がカバーします。

これは、月額最低 €57.20 を受け取ることを意味し、当社の[expenses policy](/handbook/finance/expenses/)に設定された制限まで、また実際に月額のリモートワーク費用が少なくともこの金額に達することを条件とします。

現在、これは当社の費用評価ツール (Navan) を介した費用と払い戻しを管理する一般的なアプローチに組み込まれています。

リモートワーク費用は、追跡可能性の目的で、適切な領収書と正当化により裏付ける必要があります。

リモートワークに関連する費用とは別に、チームメンバーが業務目的のために負担した費用は、適用される法的ルールと内部ポリシーに従って会社が支払います。

リモートワークに関連する費用に加えて、チームメンバーは、業務目的のために私邸の一部を使用する制約に対応する月額 €50 グロスの職業手当 (indemnité de sujétion) を受け取ります。この手当は、雇用契約で合意された固定報酬の不可欠な部分です。

#### 10. 年次インタビュー

チームメンバーは年次インタビューを受けるものとし、その際にリモートワークに関連する労働条件と業務量について議論されます。

#### 11. プライバシーの保護

監視手段が設置された場合（技術的管理、サイバー犯罪と戦うシステムなど）、チームメンバーには通知される必要があります。このシステムは、業務目的で利用可能になっているツールの使用にのみ関連する必要があります。

#### 12. トレーニング

提供される技術機材の使用に関連する特定のトレーニングとは別に、チームメンバーは、専門的な発展を確保するために、トレーニング、サポート、コーチングへのアクセスを有します。

#### 13. 健康と安全

リモートワーク日の病気または事故の場合、チームメンバーは 24 時間以内に Team Member Relations (teammemberrelations@gitlab.com) に通知することを約束します。

#### 14. 翻訳

憲章のフランス語版と英語版の間で矛盾がある場合、フランス語のテキストがすべての状況において優先するものとします。
...
憲章の現行バージョンの PDF は[こちら](https://drive.google.com/file/d/1wWR8BnRFwmZURjYLHFE5_zzHh_UJB28u/view?usp=drive_link)からアクセスできます。憲章が更新された場合、透明性のために以前のバージョンの PDF がここで利用可能になります。

- [2021 バージョンはこちらから利用可能](https://drive.google.com/file/d/1rIpcgcXNVDiAyhTPnBIDohItxUwzFb3D/view?usp=drive_link)。
