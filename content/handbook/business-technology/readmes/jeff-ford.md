...
2021 年に GitLab の IT チームへ契約社員として参加し、10 ヶ月後に晴れて正社員として転換されました！

毎日、組織全体のメンバーが業務を進められるよう支援し、障壁を取り除くことにやりがいを感じています。問題解決と笑顔のサービスが大好きです！

アリゾナ州の荒々しくも美しいソノラ砂漠地帯に在住しています 🌵

（少し助けを借りながら 🤖）bash ワンライナーやブックマークレットを作ることも楽しんでいます

---

### 連絡先（個人）

- Issue で `@jeffford-gl` をタグ付けしてください
- メール `jford@gitlab.com`
- Slack `Jeff Ford`
