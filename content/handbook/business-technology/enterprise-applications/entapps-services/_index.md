---
title: IT エンタープライズアプリケーションサービス
upstream_path: /handbook/business-technology/enterprise-applications/entapps-services/
...
- [メジャーインシデント管理](https://docs.google.com/presentation/d/14F8-odTSEWQ0OS53oMJ-o6hDflplKkYsO4o9tww2uVw/edit#slide=id.p1)
- 変更管理（準備中）
- リリース管理（準備中）
- 新規アプリケーション SOX コンプライアンスレビュー（準備中）
