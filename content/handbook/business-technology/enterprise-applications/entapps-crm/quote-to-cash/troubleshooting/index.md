...
トゥルーアップとは、前年度にライセンス数を超過した顧客に対する事後支払い（バックペイメント）のことです。
...
利用状況 Ping を通じたデータが利用できない場合は、インスタンスで利用状況 Ping が無効になっていると考えられ、手動でこの情報を取得する必要があります。
...
### セルフマネージドでのライセンス超過ユーザーに必要なスクリーンショットを顧客に依頼する方法 {#how-to-ask-the-customer-for-a-screenshot-needed-for-users-over-license-with-self-managed}
