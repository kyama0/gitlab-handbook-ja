...
GitLab のプロダクトマネジメントの学習と能力開発へようこそ!

Product L & D Hub のリソースは、プロダクトマネージャーが自分のペースで探索、学習、成長することを支援することを目的としています。私たちはさまざまなスキルレベルやさまざまな深さ / コミットメントレベルにまたがるコンテンツを集めることを目指しています。プロダクトマネージャーは、ここにあるリソースに取り組んで、GitLab および全体的な製品キャリアで成功した旅を歩むことを推奨します。

ここにあるリソースのほとんどは無料ですが、支払いが必要なコンテンツは [GitLab の払い戻しポリシーに従って払い戻し可能](/handbook/people-group/learning-and-development/growth-and-development/) です。

時間の経過とともに、GitLab のプロダクトマネジメントの [コンピテンシー](/handbook/product/product-management/product-cdf-competencies/)、[CDF](/handbook/product/product-management/product-cdf-competencies/)、[product development flow](/handbook/product-development/how-we-work/product-development-flow/) を直接サポートするコンテンツを追加していきます。進化するプロダクトマネジメントの領域には継続的な学習が必要であり、GitLab は深く学習するために必要な時間も勤務時間の一部として提供することにコミットしています。マネージャーに学習と開発の時間を確保してもらうように依頼することを推奨します。

## すべての GitLab プロダクトマネージャーへの推奨書籍とトーク

これらの書籍は、GitLab のすべてのプロダクトマネージャーが読むことを強く推奨します。
...
最適な結果を達成するために効率をどのように活用するかを論じる。 <br>
...
## GitLab 固有のプロダクトマネージャーのコンピテンシーをサポートする資料

[プロダクトマネージャーコンピテンシー](/handbook/product/product-management/product-cdf-competencies/)

### Opportunity Canvas

GitLab の Chief Product Officer が、10 分間のビデオで opportunity canvas を成功させる要因について洞察を共有しています。
...
- [Opportunity Canvas 概要](/handbook/product/product-processes/#opportunity-canvas)
- [アラートを実行可能なインシデントに翻訳することは難しい](https://docs.google.com/document/d/1-sJoVFr3ND_-N3EtXUNYF6oVROfhE4rcjVqpnQd5N6U/edit#heading=h.bjrjegyjyv9f)
- [リモートおよび仮想パッケージリポジトリ](https://docs.google.com/document/d/1HxStNvY5i4Qn6c_AvhsKNV2WOEqbAivEjZqFPwhKej8/edit#heading=h.4mt5fmtn0ax4)
...
- [Opportunity Canvas "Lite" の使用タイミングと方法](/handbook/product/product-processes/#opportunity-canvas-lite)
- [例: Opportunity Canvas Lite: Parent-child パイプラインのデフォルト動作変更](https://gitlab.com/gitlab-com/Product/-/issues/2030)

#### Canvas レビューの例ビデオ

- [Opportunity Canvas Unfiltered プレイリスト](https://www.youtube.com/playlist?list=PL05JrBw4t0KqR2kan56Ae7Di70WF3tpZJ)

### GitLab での優先順位付け

<br/>
Nicole は、Mike および Olivier との議論で、エンジニアリングのカウンターパートとの技術的負債の優先順位付けへの彼女のアプローチを共有しています。
<br/><br/>
...
James はエンジニアリングのカウンターパート Scott と、エラーバジェット、技術的負債、その他の優先順位のバランスをどのように取るかについて議論しています。
<br/><br/>
...
Fabian と Nick は Geo チームでの PM/EM 連携と PM と EM の間の共感構築の重要性について議論しています。
<br/><br/>
...
- [GitLab の優先順位付けガイドラインテーブル](/handbook/product/product-processes/#prioritization)

## プロダクトマネジメントのピアメンターシッププログラム

### 概要

私たちには、Principal PM へ、もしくは People Management へのいずれであっても、リーダーシップスキルを向上させることに興味を持っている非常に才能のあるプロダクトマネージャーのチームがあります。どちらのトラックでも重要なスキルは、他者をコーチしメンタリングする能力です。
現在、チームの圧倒的多数は Senior レベルです。従来のメンタープログラムでは、人々にメンターとメンティーの役割が割り当てられます。ほとんどの人が他者をメンタリングしたいと考えているため、メンターが多すぎてメンティーが足りない状態になっています。

リーダーシップ / メンタリングスキルを成長させることに加え、PM には以下のようなコーチングが必要な分野もあります。

- 顧客発見
- ビルドトラックでのイテレーションと効率
- パフォーマンスインジケーターの設定と進化
- Sisense スキル
- 適切な優先順位付けを伴うビジョンとロードマップの伝達

### 提案

PM がそれぞれの強みと成長が必要な分野に基づいてペアになるピアメンターシッププログラムを確立します。PM はそれぞれが強いスキルについてお互いをコーチすることができます。

これには PM が参加者としてボランティアで参加する必要があります。マネジメントは参加者の強みと弱みを匿名で収集し、協力してペアを作る必要があります。

### パイロット

ボランティアの PM 間でペアを設定し、PM が毎週会う 8 週間のパイロットを実施します。GMP はパイロットの過程でスキル開発を評価し、成功の潜在的な指標とすることができます。

パイロットは FY22Q3 中に実行されます。これにより、ボランティアの収集、スキルの評価、パイロットのペア設定、コーチングとメンタリングのクラッシュコースの実行など、2 ヶ月の準備期間があります。パイロットは Q3 の最初の 2 ヶ月間実行され、最終月にはプログラム調整と継続のために振り返りを行います。

パイロットのレトロの後、今後ローテーションで継続するかを決定できます。

私たちはこの [epic](https://gitlab.com/groups/gitlab-com/-/epics/1546) でパイロットプログラムを計画します。

### ピアメンターシップ中のキャリア開発フレームワークの利用

プロダクトマネージャーはすべて [CDF](/handbook/product/product-management/product-cdf-competencies/) を使用して評価されており、CDF の文脈で各人がどのようにパフォーマンスを発揮しているかを議論する方法として、CDF を活用するのは素晴らしい方法となります。CDF の特定の領域で改善したい場合は、ピアメンターシップスペースがメンターシップを求めるのに最適な場所となります。CDF はチームメンバーと管理ラインの間で保持される機密文書ですが、メンターシップの目的では、チームメンバーは関連する部分を共有することを選択できます。CDF に関するフィードバックがあれば、マネージャーと話し合うか、[CDF ハンドブックページ](/handbook/product/product-management/product-cdf-competencies/) への MR を開き、`gl-product-leadership` にレビューをタグ付けしてください。

## 成長と能力開発のプロセス

一般的な [成長と能力開発の福利厚生](/handbook/people-group/learning-and-development/growth-and-development/) は Total Rewards チームによって維持されています。以下はプロダクトマネージャー向けに具体化したものです。

Product チームには、以下に概説するトレーニング用の特定のプロセスがあります。新しいトレーニングへのサポートを得るには、Growth and Development の一般的なガイドラインに従ってください。

### Product Talk の Continuous Interviewing コース

Continuous Interviewing コースは、プロダクトマネジメントのオンボーディングの一部です。

### Reforge メンバーシップ

GitLab は、GitLab のチームメンバーが学習に関連して以下の活動に参加し、必要に応じて組織することを条件に、年次の Reforge メンバーシップ料金を払い戻します。

- 1 年間に少なくとも 1 つのプログラム、できればコホートに登録する
- 同じコホート / プログラムに登録する GitLab のチームメンバーをもう 1 人見つける
- もう一人の GitLab チームメンバーとコホート / プログラムをフォローする勉強会を組織する
  - 勉強会はすべての Reforge トピックについて、GitLab での適用性に特に焦点を当てて議論することが期待されます
  - 勉強会は Reforge 勉強会でもよい
- 勉強会の GitLab チームメンバーがプロセス変更を提案し、アナリティクスのリクエストを作成する

## 一般的なプロダクトマネジメントの学習コンテンツ

このコンテンツはプロダクトマネージャーの 5 つの主要なコンピテンシーに分かれています。
...
- [Just Enough Research](https://vimeo.com/129039134) (59 min ビデオ)
...
- [GitLab での Continuous interviewing](/handbook/product/product-processes/continuous-interviewing/)
...
- [Talking to Humans](https://www.amazon.co.uk/Talking-Humans-Success-understanding-customers-ebook/dp/B00NSUEUL4) ([代替の無料 PDF](https://s3.amazonaws.com/TalkingtoHumans/Talking+to+Humans.pdf))
...
- [GitLab Jobs to be Done (JTBD) 概要](/handbook/product/ux/jobs-to-be-done/)
- [Clayton Christensen - Understanding the Job](https://www.youtube.com/watch?v=sfGtw2C95Ms) (5 min ビデオ)
...
- [Bob Moesta & Chris Spiek - Uncovering the Jobs to be Done](https://businessofsoftware.org/talks/bob-moesta-and-chris-spiek-uncovering-the-jobs-to-be-done/) (57 min ビデオ)
- [Tony Ulwick - Customer Centered Innovation](https://businessofsoftware.org/talks/customer-centered-innovation/) (57 min ビデオ)
...
- [Intercom on Jobs-to-be-Done](https://www.intercom.com/resources/books/intercom-jobs-to-be-done) (無料 eBook ダウンロード)
...
- [Melissa Perri - Lean Product Management](https://vimeo.com/122742946) (42 min ビデオ)
- [GitLab Remote Design Sprint ガイドライン](/handbook/product/ux/design-sprint/)
- [How to Run Amazing Remote Design Sprints!](https://www.youtube.com/watch?v=IFHfsRNTGCM) (60 min ビデオ)
...
- [Matching Price to Value: 3 Lessons in Monetization from Menlo Ventures](https://www.youtube.com/watch?v=hGUEDKaTFXw) (30 min ビデオ)
...
- [Intercom: The Growth Handbook](https://www.intercom.com/resources/books/growth-handbook) (無料 eBook ダウンロード)
...
- GitLab における [イテレーション](/handbook/values/#iteration) とは?
- [Minimal Valuable Change](/handbook/product/product-principles#the-minimal-valuable-change-mvc) とは?
- [Product Processes: Iteration Strategies](/handbook/product/product-processes/#iteration-strategies)
- [Sid と Leif によるイテレーションについてのビデオ](https://www.youtube.com/watch?v=tPTweQlBS54) (24 min ビデオ)
- [Product Leadership がイテレーションから学んだ事例について議論](https://www.youtube.com/watch?v=tPTweQlBS54) (19 min ビデオ)
- [Des Traynor: Start with a cupcake](https://www.intercom.com/blog/start-with-a-cupcake/)

#### より深く

- イテレーションオフィスアワー GitLab チームミーティングに参加: [カレンダー](https://calendar.google.com/calendar/embed?src=gitlab.com_6ekbk8ffqnkus3qpj9o26rqejg%40group.calendar.google.com&ctz=America%2FLos_Angeles)
- [Iteration プレイリスト](https://www.youtube.com/playlist?list=PL05JrBw4t0KqJOf21O9cbAMxtpUpdLFoZ) のビデオを視聴
...
- [Des Traynor: Product Strategy Revisited](https://businessofsoftware.org/2014/12/product-strategy-saying-part-2-des-traynor-bos-usa-2014/) (54 min ビデオ)

#### オンラインコース

お気に入りのリソースをここに貢献してください
...
- [John Doerr: Why the secret to success is setting the right goals](https://www.youtube.com/watch?v=L4N1q4RNi9I) (5 min ビデオ)
...
- [Ally for OKRs - Overview for Product](https://www.youtube.com/watch?v=hP9yk_PSj2k&feature=youtu.be) (10 min ビデオ)

#### より深く

- [Financial Modeling for Product Managers](https://tpgblog.com/2015/05/04/product-financial-modeling/) (60 min ビデオ)
...
- [Connor Murphy on how his team uses a combination of GitLab, Loom, Notion, and Figma to collaborate async between PM, Design, and Engineering](https://www.loom.com/share/17677053ff7d4eeba643eaf194c0b700) (5 min ビデオ)
...
- [Rosemary King: Stakeholders, let 'em in](https://www.mindtheproduct.com/stakeholders-building-an-open-door-culture/) (20 min ビデオ)

#### オンラインコース

- [Managing Project Stakeholders](https://www.linkedin.com/learning/managing-project-stakeholders-2) (LinkedIn Learning コース)
...
- GitLab の新しい Group Manager のために、新しい Group Manager を Product チームの (直接的なレポートチェーンに属さない) Director 以上の Senior リーダーとマッチングする buddy プログラムがあります。これは新しいマネージャーが GitLab のマネジメントプロセスを理解し、判断せずに困難な状況について話し合うサウンディングボードを見つけ、一般的にマネジメント手法を学ぶのに役立つオプションのプログラムです。これは新しいマネージャー (通常は初めてのマネージャー) を対象としていますが、GitLab で初めてマネージャーになるが、別の場所でマネージャーをした経験がある人にも開かれています。
...
- [The New Manager Death Spiral](https://www.youtube.com/watch?v=pAbU3WJ-NBw) (30 min ビデオ)
...
- [First Round Essentials: Management](https://books.firstround.com/management/) (無料 eBook ダウンロード)

### 🤝 リーダーシップと影響力

#### クイックリードとビデオ

- [Start with why -- how great leaders inspire action](https://www.youtube.com/watch?v=u4ZoJKF_VuA) (18 min ビデオ)
- [Leadership Biz Cafe Podcast](https://tanveernaseer.com/lbc/)

#### より深く

- [LinkedIn Learning: Executive Leadership](https://www.linkedin.com/learning/executive-leadership-24384695/take-action-to-lead) (合計 1h 19m)
- [LinkedIn Learning: Being a Good Mentor](https://www.linkedin.com/learning/being-a-good-mentor) (合計 1 時間)
...
- Kubernetes for Product Managers
  - [スライド](https://docs.google.com/presentation/d/1rUlyq25xrULVdCYqW_TF-1L0fP1hpzqDxA7ciupc9is/edit#slide=id.p)
  - [ビデオ: Part 1](https://youtu.be/WboRFl5Ebdk)
  - [ビデオ: Part 2](https://youtu.be/9aC1EZF_zy4)
  - [ビデオ: Part 3](https://youtu.be/uye3PhRhXr4)
...
## プロダクトマネジメントの思想的リーダーシップ

### ブログ、ビデオ、ポッドキャストなど

製品開発の世界には素晴らしいコンテンツと進行中のトレンドが多数あります。ブログ、ビデオチャンネル、その他の継続的なコンテンツストリームを購読することは、ベストプラクティスやチームとの製品イノベーションについてインスピレーションを得る素晴らしい方法です。始める場所についてのいくつかの推奨事項を以下に示します。
...
- [Product School](https://www.youtube.com/channel/UC6hlQ0x6kPbAGjYkoz53cvA/featured) (YouTube チャンネル)
- [Women In Product](https://www.youtube.com/channel/UC6z_ibVMdKbKFfgb3mxwx9g/videos?view=0&sort=p) (YouTube チャンネル)

### 思想的リーダーとインフルエンサー

知識を得続ける最良の方法の 1 つは、人々をフォローすることです! アイデアやベストプラクティスをオープンに共有している人がたくさんいます。インスピレーションを受ける人々をフォローし、アイデアを交換することをお勧めします。始める場所についてのいくつかの推奨事項を以下に示します。
...
## Product L & D Hub への貢献方法

Product L & D Hub を堅牢で関連性のあるものに保つのは、チームの努力です。役に立つリソースを見つけたら貢献することをお勧めします。Product L & D Hub に古くなった、または同意できないリソースがあれば、それも私たちに知らせることを推奨します。

Product L & D ハブには 2 つのコンポーネントがあります。
