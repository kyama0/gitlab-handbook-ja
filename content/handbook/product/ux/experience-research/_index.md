...
#### 原則 1: 広範なカバレッジよりも戦略的フォーカス

私たちは、**差別化、成長、リテンション**を推進する戦略的なビジネス領域にリサーチ能力の 100% を割り当てます。つまり、以下の縦軸からの一部のイニシアチブやチームのみをサポートします。
...
#### 原則 2: 確認研究よりも革新的なインサイト

私たちは、高い確信を持ってすでに疑っていることを確認する調査よりも、ゲームチェンジングな機会を明らかにし得るリサーチを優先します。

私たちのリサーチは仮説主導であり、以下を優先します。

- **高リスク・低確信の仮説**: 間違っていた場合に大きなコストがかかるが、正しい場合に大きな機会を解き放つ可能性のある問い
- **差別化のギャップ**: 競合が解決していない方法でユーザーが苦労している場所を理解する
- **未充足のユーザーニーズ**: ユーザーが言葉にできないが、解決のためにお金を払うであろう問題を発見する

私たちの働き方:

- 私たちはプロダクト、エンジニアリング、デザイン、データ、カスタマーサクセス、マーケティングのチームと連携して、知識ギャップを特定し、検証します
- 私たちはエッジケースではなく、コアジャーニーにおける実際のユーザー行動とニーズ、機会を観察・注視します

#### 原則 3: 単発の調査よりも持続可能なインテリジェンス

私たちは、継続的なインサイトを最小限の労力で提供し、より速い意思決定を可能にする計装を構築します。

私たちの計装戦略:

- 私たちはクロスファンクショナルパートナーと協力して、追跡すべき[クリティカルなユーザー体験](/handbook/product/ux/tracking-critical-experiences/)を特定します
- 私たちはコアの UX 品質指標について、戦略的インサイトの介入のためにオープンかつ頻繁に特定・報告し、深掘りを行います
- 私たちは指標が定義された閾値を下回ったときに、カウンターパートと協力して改善を優先順位付けします
...
- 戦略的なビジネス領域に紐づかない
- 高確信・低リスクな前提や当然の要件を確認しようとする
- 既存データや簡単なユーザビリティテストで答えられる
- ユーザーのごく一部に影響するエッジケースに対処する

代わりに、以下を提供します。

- セルフサービスのリサーチ手法に関するガイダンス。詳しくは [こちらのセクション](### How to Work with UX Research) を参照してください。
- 分析パートナーによるデータ分析サポート
- 今後の戦略的リサーチサイクルへの組み込み

### 成功指標

戦略がうまくいっていると分かるのは、以下のときです。

- ブランドからプロダクトまでのビジネスステークホルダーが、戦略的な意思決定について私たちの意見を積極的に求めるとき
- 私たちのインサイトが、コア KPI と UX 指標の測定可能な改善に直接貢献するとき
- 私たちのリサーチを通じて発見した**具体的な競争優位**を指し示せるとき

### 四半期ごとにイテレーションする

四半期ごとに、私たちは以下を評価します。

- リソース配分: 私たちは本当に戦略的領域に努力を集中しているか？
- インパクト測定: どの調査が最大のビジネスインパクトをもたらしたか？
- 原則の洗練: これらの原則は、ビジネスの変化に基づいて更新が必要か？
...
- [UX リサーチで AI を使う方法](/handbook/product/ux/how-we-work/ai-usage/)
