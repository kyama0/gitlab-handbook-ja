...
upstream_path: /handbook/product/ux/experience-research/defining-goals-objectives-and-hypotheses/
...
リサーチ質問を特定して初めて、その質問に答えるための最適な方法（例えば、[どのリサーチ手法を使うか](/handbook/product/ux/experience-research/choosing-a-research-methodology/)）を選択できます。
...
- 自問してみてください。
  ...
  - [以前のリサーチ](/handbook/product/ux/experience-research/finding-existing-research/#how-to-find-existing-research) は存在しますか？
    - 以前のリサーチは何を教えてくれましたか？
