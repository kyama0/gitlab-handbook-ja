...
1. **モデレートあり** - モデレートありのパイロットでは、本質的に適格な回答者に対して 1 対 1 のインタビューを実施し、各アンケート設問が彼らに何を尋ねているかについて自分の解釈を声に出しながら考えるよう指示しながらアンケートに答えてもらいます。モデレートありのアプローチの良い点は、フォローアップの質問を尋ねるためにその場にいられることです（例: 「その質問はどう尋ねるとより良いと思いますか?」）。この選択肢は計画、スケジューリング、実行により多くの時間がかかりますが、さらなる洞察と明確化を得られます。
