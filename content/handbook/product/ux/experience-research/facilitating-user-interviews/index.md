...
インタビューのほとんどはユーザーが話す内容で構成されるべきです。あなたは聴く側であるべきです。自分が多く話していると気づいたら、それを意識をユーザーに戻し、話してもらうサインと捉えてください。能動的に聴くことはユーザーが話し続けることを促し、頷きやアイコンタクト、短い肯定的な発言（「なるほど」「そうですね」「うんうん…」）でフォローしていることを示すことで、これをサポートできます。
