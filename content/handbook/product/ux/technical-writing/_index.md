...
指定されたテクニカルライターは、アサインされた [グループ](/handbook/product/categories/) の go-to パーソンです。
他のチームメンバーと協力して、新しいドキュメントを計画し、既存のドキュメントを編集し、
ドキュメントへの提案された変更をレビューし、UI のマイクロコピーへの変更を提案し、
ドキュメントが必要なあらゆる状況で subject matter experts (SME) と一般的に協業します。
...
指定されたマネージャーは、アサインされたセクションの go-to パーソンです。リーダーシップグループでテクニカルライティングを代表し、
チームの連絡先として機能します。
