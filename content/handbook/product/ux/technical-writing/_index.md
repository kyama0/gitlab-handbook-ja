...
GitLab ドキュメントは、ユーザー、管理者、意思決定者が GitLab の機能について学び、自身の [DevOps ニーズ](https://about.gitlab.com/stages-devops-lifecycle/) に応えるために GitLab を最適に実装・利用できるよう作成されています。
...
指定されたテクニカルライターは、アサインされた[グループ](/handbook/product/categories/) の窓口となります。窓口として、他のチームメンバーと協力して新しいドキュメントを計画したり、既存のドキュメントを編集したり、ドキュメントへの変更提案をレビューしたり、UI のマイクロコピーへの変更を提案したり、ドキュメントが必要なあらゆる場面で内容専門家（SME）と連携します。
...
指定されたマネージャーは、アサインされたセクションの窓口となります。窓口として、リーダーシップグループでテクニカルライティングを代表し、チームへの連絡先として機能します。
...
- 依頼された場合、または[ドキュメントエンジニア](/job-description-library/product/ux-fullstack-engineer/) がオンラインでない場合に、ドキュメントエンジニアのオペレーションタスクを支援する。たとえば、Pages の設定、デプロイ、スケジュールパイプライン、レビューアプリの支援。
...
アサインされたライターは作業を行う必要はありません。キューをチェックする際は:
...
テクニカルライターはオンボーディング中、シャドーグループにアサインされ、その後トレイニーとして貢献を開始します。ベテランテクニカルライターがプロセスを通じてオンボーディング中のテクニカルライターをコーチングします。
