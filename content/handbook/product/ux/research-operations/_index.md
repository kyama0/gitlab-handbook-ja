...
* **参加者に知らせる - 透明性を保つ。** 参加者が悪影響を受ける場合、忙しいことを伝え、心からの謝罪を表現し、彼らとのタイミング期待をリセットします。
...
リサーチオペレーションスペシャリストは、GitLab でのリサーチの成功に不可欠なユニークな責務を持つため、彼らが不在のときはリクルーティングの取り組みが遅くなります。これは、すべての関係者に一連の問題をもたらします。
