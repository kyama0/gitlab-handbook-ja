...
translator: claude
stale: false
lastmod: "2026-04-23T19:44:10+10:00"
---
...
**既存プロトタイプのフォーク。** 同僚があなたのユースケースに合うプロトタイプを構築している場合、ゼロから始めるのではなく、彼らのプロジェクトをフォークして適応できます。
...
- [UX における AI 利用](/handbook/product/ux/how-we-work/ai-usage/) - UX 部門での AI ツール利用のガイドライン
