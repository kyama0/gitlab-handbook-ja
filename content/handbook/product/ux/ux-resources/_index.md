...
lastmod: 2026-06-20T12:27:06+01:00
...
[UX Research Library](https://uxr-library.com) には、GitLab の UX リサーチャーが実施したすべてのリサーチが含まれています。AI チャットを通じてインサイトを見つけたい場合は、左ナビの Research Agent を確認してください。（GitLab FTE 内部リンク）
...
[UX フォーラム](/handbook/product/ux/ux-forum/) は、UX チームメンバーが自分の作業を共有し、議論するための定例ミーティングです。
...
UX 部門の全員とすべてのプロダクトマネージャーは、新しい Figjam ボードを作成できる Figma アカウントを取得できます。Figma アカウントを持たないチームメンバーからフィードバックを得るために Figjam ボードを共有したい場合は、共有ダイアログから匿名リンクを送信できます。

#### AI ツール

いつ AI を使うか、ベストプラクティス、避けるべきこと、AI をヘルパーとして使いながらユーザーを中心に保つ方法について学ぶには、[AI usage](/handbook/upstream-studios/how-we-work/ai-usage/)を参照してください。
...
- [デザイン判断のためのデータ](/handbook/product/ux/ux-resources/designers-guide-to-data) - デザインの意思決定を裏付けるデータを見つけるためのツール
- [ユーザーエクスペリエンスチームのための実験](/handbook/product/ux/ux-resources/experimentation/) - 実験を計画、デザイン、評価する方法
