...
- 実験の場合、ユーザーストーリーや JTBD ではなく、実験のライトアップ（リンクを追加）から作業します。ただし、私たちが実験している機能の JTBD には引き続き精通している必要があります。
...
- 実験が複数のメトリクスに影響を与えると予想する場合は、実験のライトアップで事前にすべてをリストアップしてください。
最初のメトリクスに加えて trailing メトリクスにも影響を与えたい場合は、実験のライトアップでそれを非常に明確にしてください。
...
- まだ実験を行ったことがないチームの場合、Growth にガイダンスを求めてください。[プロダクトデザイナー](/handbook/company/team/?department=growth-ux-team) に連絡することが最初のステップです。彼らは助けてくれるか、データ分析、実験開始の技術的課題、結果の誤解の回避、実験が一度に多くのことをテストしすぎないようにする支援ができる人につないでくれます。
