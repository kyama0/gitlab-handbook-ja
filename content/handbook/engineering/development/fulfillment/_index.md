...
- ハンドブックの [プロダクトデザインセクション](/handbook/product/ux/) で説明されている [プロダクトデザイナーワークフロー](/handbook/upstream-studios/product-design/workflow/) と [UX リサーチャーワークフロー](/handbook/upstream-studios/experience-research/) に従います。
...
- プロダクトデザイナーは、サポートしているプロジェクトのために [UX MR レビュー](/handbook/upstream-studios/product-design/workflow/mr-reviews/) にアサインされるべきです。
...
1. ユーザー体験への変更には [UX レビュー](/handbook/upstream-studios/product-design/workflow/mr-reviews/) が必要
...
| [Fulfillment 週次アップデート](https://gitlab.com/gitlab-org/fulfillment-meta/-/issues?sort=created_date&state=all&label_name[]=weekly+update)                     | 週次       | 非同期 | Fulfillment PM、EM、UXM                                |
...
| [Fulfillment PM / EM / UXM 同期](https://docs.google.com/document/d/1UBfHiGK6BgJY76sFJ1qqlsRbtYhbBZETpaA4ftX_BBc/edit)                                    | 週次       | 同期  | Fulfillment PM、EM、UXM                                |
| OKR チェックイン                                                                                            | 週次       | 非同期 | Fulfillment PM、EM、UXM                                |
| [月次セルフマネージドリリース](/handbook/engineering/releases/#self-managed-releases)                                                   | 月次      | 非同期 | Delivery Engineering                                            |
| [月次リリース投稿](https://docs.gitlab.com/development/documentation/release_notes/)                                                                         | 月次      | 非同期 | Product および Marketing 機能                                 |
...
| ロードマッププランニング                                                                                      | 月次      | 同期  | Fulfillment PM、EM、UXM                                |
...
| OKR プランニング                                                                                             | 四半期    | 非同期 | Fulfillment PM、EM、UXM、スタッフエンジニア               |
