...
1. スケジュールされた操作が実行され、以下を行います。
    1. 以下の条件で Issue を選択します。
        ...
        1. マイルストーン:
            1. Issue にマイルストーンがある。
            1. Issue のマイルストールタイトル = [`next_milestone`](https://gitlab.com/gitlab-org/quality/triage-ops/-/blob/de25e11d0c006551eaece0dcb95c5b5bf8216b90/lib/milestone_helper.rb#L13-15)。
    1. アクション:
