...
- [gemnasium アナライザーでの PHP Composer セグメンテーション違反](https://gitlab.com/gitlab-org/gitlab/-/issues/383299)
...
新しいバージョンのアップストリームスキャナーを含むアナライザーをリリースする前に、そのライセンスが変更されていないか、[私たちのポリシー](/handbook/engineering/open-source/)と互換性があることを確認する必要があります。
