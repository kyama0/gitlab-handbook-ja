...
## パートナー API の高レイテンシ {#partner-api-high-latency}
...
## レート制限の頻繁なヒット {#rate-limits-hit-frequently}
...
## パートナー API へのネットワークエラー {#network-errors-to-partner-apis}
...
## 手動トークン検証 {#manual-token-verification}
