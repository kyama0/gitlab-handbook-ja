---
title: "レトロスペクティブサマリー"
upstream_path: /handbook/engineering/development/sec/security-factory/code-scanning/retrospectives_summary/
...
1. 脆弱性の処理に関するポリシーが不明確である。これを改善するため、必要な手順を詳述した[ランブック](/handbook/engineering/development/sec/security-factory/code-scanning/runbooks)を作成する。
