...
GitLab の Static Analysis グループは、お客様のソフトウェアリポジトリ向けに [Static Application Security Testing（SAST）](https://about.gitlab.com/direction/application_security_testing/static-analysis/sast/) 機能カテゴリを開発する責任を担っています。
...
私たちは AST ステージの[計画](/handbook/engineering/development/sec/security-factory/planning)プロセスに従っています。
...
|---|:---:|:---:|:---:|:---:|:---:|
| 脆弱性の却下／確認 | 72h | 72h | 72h | 1 か月 | 1 か月 |
