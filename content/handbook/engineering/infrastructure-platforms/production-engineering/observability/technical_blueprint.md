...
私たちは一緒に取り組むことでより速くなれます。GitLab の他のチームとの協力を改善することで、他チームの仕事も私たちの仕事も容易になり、新しい問題や追加の問題に集中できます。
...
- Self-Managed カスタマーが私たちの知識を活用できるツールセットを作成する
- Self-Managed カスタマー向けのキャパシティプランニングツールを作成する
...
この技術アーキテクチャブループリントは、GitLab の可観測性インフラストラクチャをチームの原則と戦略的目標に沿った統合セルフサービスプラットフォームに変革するためのロードマップを提供します。提案されたアーキテクチャは現在の課題に対処しながら、すべてのデプロイメントモデル（SaaS、Dedicated、Self-Managed）にわたる将来のスケールと複雑さの要件に GitLab が対応できるよう位置づけます。
...
- サードパーティサービスをカバードエクスペリエンスとユーザージャーニーを通じて顧客向け機能に相関させることを可能にする
