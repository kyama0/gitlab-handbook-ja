...
私たちはステージグループの SLO 改善を提唱し、達成のためのサポートを提供します。GitLab.com で機能カテゴリーがどのように機能しているかについてのデータをステージグループに提供することで、機能カテゴリーの信頼性、可用性、パフォーマンスを効率的に改善するための適切な判断ができるようにします。
