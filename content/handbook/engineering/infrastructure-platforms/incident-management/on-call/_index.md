...
すべてのタイムゾーンにわたるカバレッジを提供するには、地域ごとに最低4人を目標にする必要があります。これにより、4 週間に 1 回のオンコールパターン（4 週間ごとに 1 週間担当する形）が可能になります。
...
- SecOps のオンコールローテーションは 24 時間シフトを7日間実施します。
...
- セキュリティマネージャーのオンコールローテーションは 12 時間シフトを7日間実施します。
