...
6. 全ての Severity 1 および Severity 2 インシデントについて、[非同期インシデントレビューを開始](/handbook/engineering/infrastructure-platforms/incident-review/#review-initiator)し、根本原因を所有するチームの Engineering Manager に[Feature Change Lock プロセス](/handbook/engineering/#feature-change-locks)を開始する必要があることを通知します。
...
4. 必要に応じて、[InfraDev エスカレーションプロセス](/handbook/engineering/workflow/development-processes/infra-dev-escalation/process/)を使用し、インシデント対応者が開発チームを関与させられるよう支援します。
