...
**公開 RCA は DRI が担当します。** これは別のチームへの独立した引き継ぎではありません。インシデントレビューを担当する同じ個人またはチームが、[SLO](#timeline-that-we-expect-for-reviews-to-be-completed)内に公開版を提供する責任を負います。これには、Support や特定の Technical Account Manager との調整が含まれる場合があります。
