...
チームが現在取り組んでいる内容の最新のビューについては、Q2 計画 Issue を参照してください: https://gitlab.com/gitlab-org/quality/analytics/team/-/work_items/573

### 次 FY27-Q3/Q4

**フォーカス: データ/ダッシュボードの使用をスケールアウトします。パイプラインテレメトリを改善し、エンジニアリングチームが CI パフォーマンスを改善できるようにする製品機能を構築します** (FY27-Q1 〜 FY27-Q2)

- Factory が多用される RSpec テストの可観測性、ガードレール、および修復
- MR プロセスの可視性: reviewer roulette、承認のリセット、およびレビュータイムライン
- スケーラブルな CI ジョブテレメトリレポートの構築を支援します（製品に組み込み、ランナー経由）
