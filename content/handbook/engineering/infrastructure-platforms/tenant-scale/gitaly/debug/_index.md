...
このドキュメントは **Gitaly エンジニア**向けに作成されており、GitLab の本番環境のレイアウトを把握し、本番環境の問題を効果的にデバッグする能力を身につけることを目的としています。SaaS に重点を置いていますが、多くのスキルは Self-Managed インスタンスのデバッグにも応用できます。
