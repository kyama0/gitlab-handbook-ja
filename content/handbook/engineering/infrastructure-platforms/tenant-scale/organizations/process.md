...
## エンジニアリング顧客/サポートローテーションプロセス {#engineering-customer-support-rotation-process}

{{< alert type="note" >}}
**注意**: このプロセスは現在、チームの Groups & Projects 側に固有のものであり、Organizations はまだ開発中です。プロダクトが一般リリースされた際には、Organizations 向けにも同様のものを展開する予定です。
{{< /alert >}}
