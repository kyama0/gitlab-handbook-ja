...
master、安定ブランチ、タグのビルド障害は [Distribution](/handbook/engineering/infrastructure-platforms/gitlab-delivery/distribution/) チームの Slack チャンネルに送信されます。開発者は、通常の他のブランチと同様に、機能ブランチからトリガーされたパイプラインの障害通知をメールで受け取ります。
