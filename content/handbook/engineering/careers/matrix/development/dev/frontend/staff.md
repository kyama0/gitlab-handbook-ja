---
title: "Dev キャリアフレームワーク: Staff フロントエンドエンジニア"
upstream_path: /handbook/engineering/careers/matrix/development/dev/frontend/staff/
...
- フロントエンドプログラミング言語と GitLab のデフォルトフロントエンドフレームワークに対するエキスパートレベルの知識を持つ
- 大規模なアーキテクチャ変更を特定し推進できる
- サードパーティライブラリを分析し、改善をコントリビューションとして還元できる
...
<!-- include omitted: includes/engineering-careers/development-staff-values-competency.md (no localized version under content/ja/) -->
