---
title: "Support キャリアフレームワーク: Intermediate Support Engineer"
upstream_path: "/handbook/engineering/careers/matrix/support/intermediate/"
...
**GitLab における Intermediate Support Engineer は、以下のコンピテンシーを発揮することが期待されます:**
...
- ペアリングの実施、学習モジュールの修了、プロダクトおよびトラブルシューティング知識の蓄積を通じて、個人の成長マインドセットを示す。
...
- 顧客のクエリに対して、英語での明確な技術的回答を作成・提供できる。
- 優れたコミュニケーション技術を活用して顧客の状況を把握し、顧客の期待を管理し、高品質なチケット解決策を作成して、一貫して優れた顧客体験を提供する。
- トラブルシューティングに証拠に基づくアプローチを取る。仮説を立て、利用可能なデータを基に検証または反証する。
- 誤った動作がどこにログされる可能性があるかを把握し、標準的なツールを効率的に使用してアプリケーションの動作を観察する。
