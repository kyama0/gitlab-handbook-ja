...
| タイプ | ステータス | プラットフォーム | URL | オーナー/DRI | プロジェクト | アクセス |
|------|--------|----------|-----|-----------|---------|--------|
| 永続 | アクティブ | セルフマネージド | [release.gitlab.net](https://release.gitlab.net) | インフラチーム | N/A | SRE |
...
[Release の詳細](/handbook/engineering/infrastructure-platforms/environments/#release)
