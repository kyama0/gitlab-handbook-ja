...
- エンベディングを生成する前にコードファイルを論理チャンクに解析するための新しい**コードパーサー**ライブラリを使用します。
  ...
  - 詳細な設計と実装については、[One Parser 提案](https://gitlab.com/groups/gitlab-org/-/epics/16210)を参照してください。
...
- [Duo Chat ツール](https://gitlab.com/gitlab-com/content-sites/handbook/-/blob/main/content/handbook/engineering/architecture/design-documents/prompts_migration/index.md#duo-chat-tools)
