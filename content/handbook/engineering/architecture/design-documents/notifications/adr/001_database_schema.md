...
このドメイン（通知）とは直接関係ありませんが、このアーキテクチャ設計の提案は[AI Catalog グループ](/handbook/engineering/ai/agent-foundations/ai-catalog/)によって[マージリクエスト 194032](https://gitlab.com/gitlab-org/gitlab/-/merge_requests/194032)で探求されました。
