...
- 複雑性が増します。すべてのクラスター全体のデータは、おそらく別の [データアクセス層](../index.md#1-data-access-layer) に移動されます。
...
- クラスター全体のデータにアクセス、共有、更新する際のスケーラビリティの [課題](../index.md#1-data-access-layer) 発見リスクがあります。
