...
### 3.1. Organization 間を移動できる単一のパーソナル Namespace {#31-one-personal-namespace-that-can-move-between-organizations}
...
### 3.2. デフォルト Organization に残る単一のパーソナル Namespace {#32-one-personal-namespace-stays-in-default-organization}
...
### 3.3. 各 Organization に 1 つのパーソナル Namespace {#33-one-personal-namespace-per-organization}
...
### 3.4. パーソナル Namespace の廃止 {#34-discontinue-personal-namespaces}
