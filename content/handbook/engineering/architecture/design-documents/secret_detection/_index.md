...
### フェーズ1 - Ruby pushcheck pre-receive統合 {#phase-1---ruby-pushcheck-pre-receive-integration}
...
### フェーズ2 - スタンドアロンシークレット検出サービス {#phase-2---standalone-secret-detection-service}
