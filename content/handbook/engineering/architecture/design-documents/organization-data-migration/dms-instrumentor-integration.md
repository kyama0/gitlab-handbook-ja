...
translator: claude
stale: false
lastmod: "2026-02-20T10:06:06+05:30"
---
...
[Cellsアーキテクチャ](../cells/_index.md)では、ユーザーと[Organizations](../cells/goals.md#organizations)を[Legacy Cell](../cells/goals.md#legacy-cell)（GCP上のPatroniクラスター/レプリカをソースとする）からAWS上のCellsへ移行する必要があります。私たちには以下の要件を満たす自動化されたデータベースレプリケーション機構が必要です。

1. 標準のCellデプロイワークフローを通じてプロビジョニング（[Cell Deployment Process](../cells/_index.md#deployment-process)および[Instrumentor Stages](../cells/infrastructure/deployments.md)を参照）
...
- 既存のCellプロビジョニングワークフローと統合しない（[Cell Deployment Process](../cells/_index.md#deployment-process)を参照）
...
- [Cellsインフラ](../cells/infrastructure/_index.md)
