...
namespace の slug（registry handle）はこれらのフェーズに従い、ハード削除時に永久に廃止されます。ソフト削除期間内の再取得を含む slug 固有のセマンティクスについては、[ADR-015: Slug Policy (internal)](https://internal.gitlab.com/handbook/engineering/architecture/design-documents/artifact_registry/decisions/015_slug_policy/#slug-lifecycle) を参照してください。
