...
このセクションには、AI Coding グループによって構築され、恒久的なオーナーシップが決まるまで私たちのスチュワードシップ下にある機能が含まれています。これらはアクティブな本番機能であり、非推奨ではありませんが、現在の AI Coding ファンクショナルチームのいずれにも明確には対応していません。
