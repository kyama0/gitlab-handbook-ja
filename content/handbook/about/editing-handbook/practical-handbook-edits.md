...
## コマンドラインを始める前に {#before-you-begin-in-command-line}
...
## ファイルを探してアクションを実行する {#find-files-and-perform-an-action}
...
## ファイル内の文字列を置換する {#replace-strings-in-a-file}
...
## コンテンツを検索して置換する方法 {#how-to-find-and-replace-content}
...
## すべての（一致する）ファイルで文字列を検索して置換する {#find-and-replace-a-string-in-all-matching-files}
...
## 末尾の空白を削除する {#remove-trailing-whitespaces}
...
### 末尾の空白を一括で削除する {#bulk-remove-trailing-whitespaces}
...
### マージリクエストで末尾の空白を削除する {#remove-trailing-whitespaces-in-a-merge-request}
