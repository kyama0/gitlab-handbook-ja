---
title: "Noah Ing の README"
upstream_path: /handbook/sales/readmes/noah-ing/
...
- 初めて GitLab を使った時から、GitLab で働くことはキャリアを通じての目標でした
- GitLab に入る前は、5 年間 DevOps エンジニアとして主に AWS と GCP を用いたクラウドインフラに従事していました
- セールスチームに正式に所属するのは初めての経験ですが、とても気に入っています。パフォーミングアーツへの深い関心と相性が良いと感じています
- ヒップホップ、ジャズ、ファンクミュージックに情熱的な関心を持っています。Khruangbin がお気に入りのバンドです
- カナダのトロント生まれ・育ちです
...
- 行動を優先します。イテレーションして失敗から学ぶことを厭いません
- 視覚的な学習者で、ポイントを伝えるのに視覚的な手がかりを好みます
- 参加するすべてのミーティングでメモを取ります。忘れやすいので、これがついていく方法です
- ミーティングではアジェンダを用意し、軽い雑談やジョークも交えるのが好きです
- システムやプロセスにこだわります。最も単純なタスクに対しても良い習慣とルーチンを構築します
...
- 他者にもユーモアセンスがあり、たまには笑ってくれると想定しています
- 常にポジティブな意図を前提とします。ネガティブに受け取れる場合は、通常本人に確認します
- 他者は自分が考えていることを透明に伝えてくれると想定しています
- 誰もがミーティング前にデューデリジェンスを行うと想定しています
- 業務時間中は誰もがお互いの時間を尊重すると想定しています
...
1. Slack
1. メール
1. GitLab Issue（`@noah.ing` でメンションされたもの）
