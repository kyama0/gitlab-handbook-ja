...
lastmod: "2026-09-24T11:02:46-04:00"
...
| ページ | 何が見つかるか |
| ---- | ---------------- |
| [How-Tos ページ](/handbook/sales/sales-development/#how-tos-for-the-inbound-and-outbound-processes) | リードとアカウントの検索、インバウンド/アウトバウンドパイプラインの実行、SAO の作成、そしてすべての主要な日常プロセス。 |
| [RoE、FAQ、KPI ページ](/handbook/sales/sales-development/#frequently-asked-questions-faq) | キャリア進行、エンゲージメントルール、一般的な役割への期待、商談クレジット、ランプ期間、リードルーティング、報酬。 |
...
| チャネル | Slack ハンドル |
| ------- | ------------ |
| **メインチャネル — (Global VP — Dorina Pulluqi)** | [`#sales_dev_global`](https://gitlab.slack.com/messages/C2V1KLY0Z) |
| **アナウンス — (Tanuki Tech および Enablement — Chris Wang)** | [`#sales_dev_fyi`](https://app.slack.com/client/T02592416/C011P828JRL) |
| **SDR AMER および EMEA (Manager — Jonathan Rivat)** | [`#sdr_amer_emea_inbound`](https://gitlab.enterprise.slack.com/archives/C077J5ANZ0T) |
...
| **BDR FINS & LATAM AMER (Manager — Rosie O'Brien)** | [`#bdr_amer_fo`](https://gitlab.enterprise.slack.com/archives/C04QL1YSXGW) |
...
| 名前 | 説明 |
| ---- | ----------- |
| [Sales Development Issues](https://gitlab.com/gitlab-com/marketing/sales-development/-/issues) | プロジェクトの全 Issue リスト。 |
| [Sales Dev Ops Issue Board](https://gitlab.com/gitlab-com/marketing/sales-development/-/boards/5569691) | 運用プロジェクトのメインカンバンボード。 |
| [FM Collaboration Board](https://gitlab.com/gitlab-com/marketing/sales-development/-/boards/5665082) | Field Marketing チームとのコミュニケーションボード。 |
| [PTO Requests Board](https://gitlab.com/gitlab-com/marketing/sales-development/-/boards/7220707) | PTO リクエストの提出と管理。 |
| [Sales Systems Issues](https://gitlab.com/gitlab-com/sales-team/field-operations/systems/-/issues) | Sales Systems Issue リスト。 |
| [Marketing Operations Issues](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/issues) | Marketing Operations チームスペース。 |

### 私たちのダッシュボード {#our-dashboards}

- [1:1 Account and Lead Level Dashboard Coaching Guidance](/handbook/sales/sales-development/#11-account-and-lead-level-dashboard-coaching-guidance)
- [Pipeline Dashboard Coaching Guidance](/handbook/sales/sales-development/#pipeline-dashboard-coaching-guidance)

#### チームメンバー向けの Salesforce および Tableau ダッシュボード {#salesforce-and-tableau-dashboards-for-team-members}

| 名前/リンク | 説明 |
| --------- | ----------- |
| [1:1 Dashboards — Accounts: AMER COMM](https://gitlab.my.salesforce.com/01ZPL000001I5n3) | AMER COMM セグメントのアカウント。 |
| [1:1 Dashboards — Accounts: AMER ENTG/FO](https://gitlab.my.salesforce.com/01ZPL000001I6Ub) | AMER エンタープライズおよび First Order セグメントのアカウント。 |
| [1:1 Dashboards — Accounts: APJ ENTG/COMM](https://gitlab.my.salesforce.com/01ZPL000001I5qH) | APJ コマーシャルおよびエンタープライズセグメントのアカウント。 |
| [1:1 Dashboards — Accounts: EMEA ENTG/FO](https://gitlab.my.salesforce.com/01ZPL000001I77J) | EMEA エンタープライズおよび First Order セグメントのアカウント。 |
...
| [Tableau Self-Managed Instances Database](https://10az.online.tableau.com/#/site/gitlab/views/FreetoPaidCockpitSSAOfficial/FreeSelf-ManagedInstances?%3Aiid=1) | Self-Managed Free Instances の内訳。 |
| [Tableau Inbound Lead Database](https://10az.online.tableau.com/#/site/gitlab/views/InboundInterestFeedSSAOfficial/InboundInterestFeed-ProspectLevel?:iid=1) | インバウンドと既存リードの内訳。 |
| [Tableau Prospecting 360 — Master](https://10az.online.tableau.com/#/site/gitlab/views/DraftProspect360V1SAFEFinal/Prospect360LandingPage?:iid=2) | 調査用の複数データポイントの結合ビュー。 |
| [Prospecting 360 — Pursuit or FO Accounts](https://10az.online.tableau.com/#/site/gitlab/views/DraftProspect360V1SAFEFinal/Prospect360LandingPage/581358d3-3472-4006-b973-c4db683df21c/dc1a9440-5587-4720-ae06-007bc65299f1) | 過去 30 日以内にエンゲージしたリードがあり、オープン opp がないアカウント。 |
| [Prospecting 360 — Surging & On Fire Accounts](https://10az.online.tableau.com/#/site/gitlab/views/DraftProspect360V1SAFEFinal/Prospect360LandingPage/c06f518d-df0e-4db0-8b98-f5e1a8a45ed3/da2db280-9f02-4a4e-9748-dcef783af2db) | Qualified で Surging および On Fire の新規またはエンゲージしたリードのあるアカウント。 |
| [Prospecting 360 — Qualifying by 6Sense](https://10az.online.tableau.com/#/site/gitlab/views/DraftProspect360V1SAFEFinal/Prospect360LandingPage/b2fb7cbe-ef20-4e9c-a2ac-eb238b0021a9/UseCase3Qualifiedby6Sense?:iid=7) | Qualified パイプライン上に重ねた 6Sense インテントで優先順位付けされたアカウント。 |
| [Prospecting 360 — AWA'd last 30 days](https://10az.online.tableau.com/#/site/gitlab/views/DraftProspect360V1SAFEFinal/Prospect360LandingPage/c58f4573-263b-4ea4-8818-8f1890d3aef8/AccountswithActivelyWorkingStartDateinLast30Days) | 過去 30 日以内に Actively Working とマークされたアカウント。 |
| [Inbound Interest Feed (Company Level)](https://10az.online.tableau.com/#/site/gitlab/views/InboundInterestFeedSSAOfficial/InboundInterestFeed-CompanyLevel?:iid=1) | 会社レベルの関心とエンゲージメントメトリクス。 |
| [Inbound Interest Feed (Lead Level)](https://10az.online.tableau.com/#/site/gitlab/views/InboundInterestFeedSSAOfficial/InboundInterestFeed-ProspectLevel?:iid=1) | リードレベルの関心とエンゲージメントメトリクス。 |

#### リーダー向けの Salesforce および Tableau ダッシュボード {#salesforce-and-tableau-dashboards-for-leaders}

| 名前/リンク | 説明 |
| --------- | ----------- |
| [Pipeline Dashboard: EMEA](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZQq000005sKjdMAE/view) | 新規リードから既存 opp までのパイプラインの俯瞰ビュー — EMEA。 |
...
| [Pipeline Dashboard: Global SDR](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZQq000005uFntMAE/view) | パイプラインの俯瞰ビュー — Global SDR チーム。 |
| [OceanFrogs APJ Leads](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZQq000006SCE5MAO/view?queryScope=userFolders) | プロスペクトできる GCC 地域の新規リードを提供し、進捗を測定するレポートを備えたダッシュボード。 |
| [Global/Regional Sales Dev Results Dashboard](https://10az.online.tableau.com/#/site/gitlab/views/SalesDevManagerDashboard_17619453269050/TargetAttainment?:iid=1) | 地域/チーム別の達成率、当四半期と前四半期。 |
| [Global/Regional Sales Dev Activities Dashboard](https://10az.online.tableau.com/#/site/gitlab/views/SalesDevManagerDashboard_17619453269050/RepActivity?:iid=2) | チームメンバー、地域、四半期別のアクティビティ内訳。 |
...
| [6Sense 6QA Automation Dashboard](https://gitlab.my.salesforce.com/01ZPL000000kAPN) | 6Sense 自動化を介して SFDC に自動インポートされたアカウント。 |
...
| 名前/リンク | 説明 |
| --------- | ----------- |
| [BDR Team Dashboard Template](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZPL000002JjZl2AK/view) | BDR チーム管理のすべての主要機能。 |
| [Base BDR Team Dashboard Template](https://gitlab.lightning.force.com/lightning/r/Dashboard/01ZPL000002MHPF/view) | Base BDR チーム管理のすべての主要機能。 |
...
| リソース | 説明 |
| -------- | ----------- |
| [GitLab LevelUp Training チャネル](https://levelup.edcast.com/home) | 追加の学習リソース。 |
| [Sales ハンドブックページ](/handbook/sales/) | セールスのメインハンドブックページ。 |
| [Go to Market ページ](/handbook/sales/field-operations/gtm-resources/) | GTM 戦略リソース。 |
| [Sales Development Org ジョブファミリー/レベル](/job-description-library/marketing/sales-development-representative/) | Sales Dev 組織内のジョブファミリーとレベル。 |
...
| [Sales Development Enablement Videos](https://www.youtube.com/playlist?list=PL05JrBw4t0KrjbznnEEiCtxUfT8-OV6X8) | イネーブルメント動画と How-To。 |
| [Lead Lifecycle Handbook Page](/handbook/marketing/marketing-operations/lead-lifecycle/) | リードステータスとライフサイクル管理。 |
| [Marketing Resource Links](https://docs.google.com/spreadsheets/d/1NK_0Lr0gA0kstkzHwtWx8m4n-UwOWWpK3Dbn4SjLu8I/edit?usp=sharing) | ホワイトペーパー、e ブック、ウェブキャスト、アナリストレポート。 |
| [GitLab Buyer Personas](/handbook/marketing/product-and-technical-marketing/product-and-solution-marketing/roles-personas/buyer-persona/) | バイヤーペルソナのリファレンス。 |
| [Command of the Message](/handbook/sales/command-of-the-message/) | CoM トレーニングと GitLab 価値フレームワーク。 |
| [Flash Field newsletter](/handbook/sales/field-communications/field-flash-newsletter/) | 週次セールスニュースレター。 |
| [GitLab Values](/handbook/values/) | 私たちが毎日実践しようとしている指針となる原則。 |

---

## インバウンドおよびアウトバウンドプロセスの How-To {#how-tos-for-the-inbound-and-outbound-processes}
...
#### アウトバウンド SLA と KPI {#outbound-slas-and-kpis}
...
| ビュー | 説明 |
| ---- | ----------- |
| FY26 B1 — My Leads, Action Needed | `MQL` リードステータスのリード、または `High Priority` としてマークされたリード。2 時間 SLA が適用されます。**High Priority Reason**、**Last Event Notes**、**Last Interesting Moment** の各フィールドでより多くのコンテキストを確認してください。 |
...
| FY26 B3 — Change Owner AWA's (Clone) | あなたがアカウントを `Actively Working` BDR Prospecting Status に移動したときに `Accepted`、`MQL`、`Qualifying` ステータスだったため、まだあなたの名前に移動されていないリード。このビューを使用してリードを自分の所有に移動します |
| FY26 B4 — My HT Leads W/ Phone | `phone` データポイントを持つ High Touch シーケンスのリード。コールブリッツや、Outreach の通話タスクが日次 KPI を下回る場合に使用。 |
| FY26 B5 — My Qualifying Leads | `Qualifying` ステータスでアクティブな双方向の会話にあるリード。各リードはアクティブシーケンス、Outreach で設定されたアクティブタスク、または未来のミーティングがスケジュールされている必要があります（未来の Last Activity Date で表示）。 |
| FY26 B6 — 6QA Imported Leads | 関連アカウントが 6Sense によって自動的に `Showing Intent` ステータスに移動された後、BDR が `6QA Acceptance Status` データポイントを使用して承認した後、ZoomInfo 経由で自動インポートされた Raw および Inquiry ステータスのリード。 |
...
| ビュー | 説明 |
| ---- | ----------- |
| FY26 B1 — My Contacts, Action Needed | `MQL` ステータスのコンタクト、または `High Priority` としてマークされたコンタクト。2 時間 SLA が適用されます。**High Priority Reason**、**Last Event Notes**、**Last Interesting Moment** の各フィールドでより多くのコンテキストを確認してください。アカウントを担当する予定なら、`Actively Working` BDR Prospecting Status に移動してください。 |
...
| ビュー | 説明 |
| ---- | ----------- |
| B1 — My BDR Assigned Accounts (Clone) | `BDR Assigned` フィールドにあなたがリストされているアカウント。テリトリー全体で `BDR Account Strategy` と `BDR Prospecting Status` を一括更新するために使用します。AE のテリトリーコードについては Manager に尋ねてください |
| B2 — My AWA (Clone) | `BDR Prospecting Status = Actively Working` のあなたの名前のアカウント。現在のアウトバウンドパイプラインをレビューおよび管理するために使用します。 |
...
- 同じ人物または会社からの類似リードがすでに作業されているか？その場合、`Lead Status` と `Created Date` は何か？
- マッチしたアカウントが存在するか？その場合、`Type`（Customer または Prospect？）と `BDR Prospecting Status`（`Actively Working` または `Worked in FY`）は何か？
...
- `Account Type` が Customer でなく、かつマッチしたアカウントにオープン中の Opportunity がある場合 → `Lead Status` を `Recycle` に、`Recycle Reason` を `Evaluating` に設定します。Lead Lifecycle ルールに従ってリサイクルキューに残します。
...
**2 つのリードのマージ — [動画のウォークスルー](https://www.youtube.com/watch?v=Q_EyDQdaLZw&ab_channel=GitLabUnfiltered)**
...
| Initial Source | **最古の**リード（最も早い Created Date）の値を保持。 |
| First Engagement Date | **最も早い**値を保持。 |
| Last Login Date | **最も新しい**値を保持。 |
| Company / Address フィールド | あなたの調査に基づいて最も正確かつ完全なセットを保持。 |
| Email | 両方のリードに異なるメールアドレスがある場合、マージの前にセカンダリメールを保存し、マージされたレコードに **Supplemental Email** として追加します。 |
| Owner | 意図的でない限り再割り当てしないでください — アクティブな担当者からリードを誤って取り上げていないか確認してください。 |

**リードとコンタクトのマージ — [動画のウォークスルー](https://www.youtube.com/watch?v=qHrCyKiNwDQ&ab_channel=GitLabUnfiltered)**
...
2. "Create Opportunity" チェックボックスの**チェックを外します** — そうしないと、重複した Opportunity が自動的に作成されます。
...
| Opp が誤ったデータで Stage 1 に移動 | あなたのマネージャー → 彼らが Director または Sales Dev Operations（Ramona または Sam）に連絡します。Sales Dev では他の誰も Stage 1+ の案件を編集できません。 |
| テリトリー割り当てが不明確 | 候補となる各テリトリーの AE。 |
| opp の SAO クレジット要求 | Sales Dev Ops または担当の Sales Dev Director。 |
...
3. 削除は Marketo を介して毎日**午前 12:05 PDT に自動的に**実行されます。緊急の削除については `#mktgops` で支援を要請 — 控えめに使用してください。

> ⚠️ このプロセスで削除されたリードは**回復できません**。100% 確信がない場合は、このキャンペーンにリードを追加しないでください。
...
2. Last Event Notes で指定された個人を参照および／または CC するように、最初のメールステップをカスタマイズします。SAE/AE がインプットを提供する時間が必要な場合は、アクティブ化する前に最初のステップを適宜遅延させます。
...
**シーケンスの翻訳** — 上記のガバナンスプロセスを完了したシーケンスのみを翻訳します。[Localization Issue Tracker](https://gitlab.com/gitlab-com/localization/issue-tracker/-/issues) で英語のシーケンスリンク、ターゲット言語、ゴーライブ日（少なくとも 2 週間先）、ペルソナ/モーションのコンテキストを含む Issue を開きます。Outreach で英語のシーケンスをクローンし、ステップを翻訳されたコンテンツに置き換え、ステップの順序、リンク、トラッキング、トークンを保持します。

| 言語 | Sales Dev DRI | Localization Support | 備考 |
| -------- | ------------- | -------------------- | ----- |
| AMER スペイン語 | Kenia Rodriguez | ✅ | — |
| AMER ポルトガル語 | Leo Viera | ✅ | — |
| EMEA スペイン語 | Amalio Cordero | ✅ | — |
| EMEA ポルトガル語 | Tati Fernandez | ❌ | — |
| オランダ語 | Nikki Middeljans | ❌ | — |
| フランス語 | JB Boulay | ✅ | 絵文字なし。「Hello [Last Name]」を使用 |
| ドイツ語 | Sarah Bouchtaoui | ✅ | 非常にフォーマル。絵文字なし |
...
## First Order (FO) アウトバウンドプロセス {#first-order-fo-outbound-process}
...
| **BDR Account Research** | 自由テキスト。シグナル、タイミング、価値ドライバーを文書化。[BDR Account Research テンプレート](https://docs.google.com/document/d/1EN2U8wrUdti4MTxCNceoOlltAmtUt4pqN1GxwRTCnK4/edit?tab=t.0)を使用してください。 |
...
| **6QA Acceptance Status** | `Accepted` または `Disputed` — 6QA によって AW に自動移動されたアカウントについて**当日中に**設定する必要があります。 |
...
コンバージョン比（AWA アカウント → シーケンス化された見込み客 → 会話 → FO SAO）を把握し、[パイプラインダッシュボード](/handbook/sales/sales-development/#salesforce-and-tableau-dashboards-for-leaders) を使ってキャリブレートします。

**真の First Order アカウントの検証 — 以下の 3 つの条件すべてが真でなければなりません:**
...
Domestic Region 内で `Domestic Parent Account` にリンクされた `Former Customer` アカウントのすべての opp を確認します。Closed-Lost opp の `Close Date` が過去 180 日以内であってはなりません。

**条件 3 — オープンな opp がない**

**Traction Hierarchies** タブで、同じ `Domestic Parent Account` にリンクされたアカウントの `Number of open opportunities` 列を確認します。

→ 3 つの条件すべてがパス → アカウントは First Order として認定されます。
...
[BDR Account Research テンプレート](https://docs.google.com/document/d/1EN2U8wrUdti4MTxCNceoOlltAmtUt4pqN1GxwRTCnK4/edit?tab=t.0) を使用して調査結果を文書化します。調査は[Claude Sales Dev User Guide](/handbook/sales/sales-development/#claude-sales-dev-bdrsdr-user-guide) を使用して部分的に自動化できます。

### Claude Sales Dev BDR/SDR ユーザーガイド {#claude-sales-dev-bdrsdr-user-guide}
...
この統合の主なユースケースは [Business Development Prospecting Project](https://claude.ai/project/92974b9b-f70e-4d74-9288-20c443617e9c) です。まずそこでアカウント調査プロンプトを実行し、次に自然なステップとして ZoomInfo を使用します。コンタクトのエンリッチ、インテントシグナルの表面化、アウトバウンドの準備などです。利用可能な機能の完全なリファレンスについては、[ZoomInfo MCP ドキュメント](https://docs.zoominfo.com/docs/zi-api-mcp-overview) を参照してください。
...
- **マルチスレッディングプラン:** AWA アカウントあたり 5〜10 見込み客、少なくとも 2 つのペルソナにまたがり、3 人の新規見込み客を含む。
...
**既存顧客アカウント内の成長:** 追加のビジネスユニットを特定するために AE と戦略的にパートナーを組みます。更新日を会話を拡大するための興味深いイベントとして活用します。
...
**Free から Paid へのアップグレード:** 既存の無料 Core/CE ユーザーは GitLab の有料バージョンへのアップグレードのターゲットにできます。コマーシャルライセンスなしでの高い使用量は、利用可能な最も強力な FO トリガーの 1 つです — これらのアカウントを優先します。[Self-Managed Instances Dashboard](/handbook/sales/sales-development/#salesforce-and-tableau-dashboards-for-team-members) を使用して特定します。

**ランキングと優先順位付け:**

| ランク | プロファイル | 戦略 |
| ---- | ------- | -------- |
| **Rank 1 — EwP** | 高い 6Sense インテントスコア | AE との緊密な戦略的パートナーシップで BDR がハイタッチ。 |
| **Rank 2** | 階層に Core/CE ユーザーがいる ICP Domestic Parent Account、Total CARR/LAM が利用可能、中または低い 6Sense インテント、現在の FQ で小規模な更新 | 標準 BDR アウトバウンドケイデンス。 |
...
### SDR インバウンド RoE {#sdr-inbound-roe}

> インバウンドリードを実行する前に、上記の[ISR 基準](/handbook/sales/sales-development/#isr-inbound-roe)を満たすかを確認します。満たす場合は、実行しないでください — ISR キューに保留します。
...
### ISR インバウンド RoE {#isr-inbound-roe}
...
リードは、以下の**すべて**が真の場合に ISR チームにルーティングされます:
...
- `Account Demographics: Sales Segment` が `SMB` でない
- `Matched Account BDR Prospecting Status` が `Actively Working` または `Queued` でない
- `Person Address: Country` = `CA` または `US`
- `Matched Account Owner Role` が `AE_FO_AMER` で始まる、または `Matched Account Owner Role` が空白（アカウントオーナーが割り当てられていない）

→ すべての条件を満たす → ISR チームにルーティング。ISR がまだ割り当てられていない場合は、**ISR キュー**に保留します。SDR または BDR にルーティングしないでください。ここで停止します。

→ いずれかの条件を満たさない → 適用する [SDR インバウンド RoE](/handbook/sales/sales-development/#sdr-inbound-roe) または [標準 BDR RoE](/handbook/sales/sales-development/#standard-bdr-roe) を続行します。
...
→ いいえ → リードが [ISR 基準](/handbook/sales/sales-development/#isr-inbound-roe) を満たすかを確認。はいの場合 → ISR キューに保留。ここで停止。いいえの場合 → SDR チームがこのリードを実行。ここで停止。
...
→ はい → [更新の Sales RoE](https://internal.gitlab.com/handbook/sales/go-to-market/rules-of-engagement/#crediting--splits) とアライメント。SDR/BDR は更新 opp でクレジットを受け取りません。例外が必要だと考える場合は Sales Ops に連絡してください。ここで停止。
...
SFDC のアカウントレベルで確認するか、[このレポート](https://gitlab.my.salesforce.com/00O8X000008RfvU)を使用 — 会社名とメールドメインでフィルタし、過去 30 日のアクティビティを探します。
...
→ デューデリジェンスが実行され、情報を以前に明らかにできなかった場合、かつアカウントが AWA でなく、過去 30 日以内に関連する SDR アクティビティがない場合 → SDR または BDR とそのチームが SAO クレジットを受け取ります。
...
→ テリトリー情報が矛盾している → 各テリトリーの AE Manager をチャタリングし、進める前に Sales Support と所有権を解決してもらいます。
...
認定基準は、Sales Accepted Opportunity (SAO) としてセールスに渡される前に、リードが満たさなければならない最小限のしきい値を定義します。完全な基準: [Inbound and Outbound](/handbook/sales/field-operations/gtm-resources/#opportunities)。
...
- **MM+ Valuable Trials – Auto-MQL & routing**
 ...
 すべての **MM+ "valuable" trials**（ビジネスメール + トライアル開始、SaaS および self-managed）は、**Marketo スコアリングを介して auto-MQL** するよう構成されており、追加で週あたり 160〜180 件の FO MM+ MQL を生成し、それらは FY27 リード/コンタクトルーティングルールに基づいて Traction 経由で Sales Dev (BDR/SDR/ISR) にルーティングされます。[Scoring Change: Auto-MQL all MM+ Trials](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/11062)、[Scoring Change: Valuable MM+ ICP SaaS Trials update to auto-MQL](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/10947)、[MM+ Trials – Route to SDR](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/11097)、[Marketo MQL & Lead Scoring ドキュメント](/handbook/marketing/marketing-operations/marketo/#mql-and-lead-scoring) を参照。

- **MM+ Trial English Auto-Sequence Pilot (Sequence 1495)**

 MM+ trial の実験の一部として、**English pilot コホート（AMER/EMEA、優先言語なし）からの MM+ valuable trial リード**は、以前は単一の SDR にルーティングされていましたが、現在は **SDR に代わって Outreach シーケンス 1495 に自動シーケンス化** され、よりクローズ指向のメッセージングをテストし、今後の ISR モーションに情報を提供します。[Create automation for English pilot trials to automatically be sequenced](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/11520)（上記の MM+ trial auto-MQL ワークアイテムに関連）を参照。

- **FO MM+ Valuable Free SaaS Signups – XDR Outreach Sequence**

 **FO MM+ valuable free SaaS signup** イニシアチブは、認定された無料グループ namespace のサインアップ (MM+ FO) を Marketo/SFDC にロードし、それらを XDR が所有する Outreach シーケンスに**追加し始めます**。これにより、オプトインされた product-qualified の無料ユーザーがナーチャーだけでなく構造化されたフォローアップを受け取れるようにし、トリガー、キャンペーン、ナーチャー除外のための支援ワークアイテムも備えます。[Begin to add FO MM+ Valuable Free SaaS Signups to XDR Outreach Sequence](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/11274)、[Build Email for MM+ Valuable Free Users Signup](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/11277)、[Marketo & SFDC Campaign Creation – FO MM+ Valuable Free Users](https://gitlab.com/gitlab-com/marketing/marketing-operations/-/work_items/11278) を参照。
...
RelevanceAI は、GitLab の Sales Development 向け AI ワークフォースプラットフォームです。Salesforce と Outreach にわたって、リサーチ、優先順位付け、重複排除、見込み評価中のフォローアップ、シーケンスへの登録、アカウント情報の収集・分析を連携させます。Salesforce が引き続き正式な記録システムです。エージェントは関連する CRM データや補完データを読み取り、SDR と BDR が確認できるよう、指定された Relevance フィールドに結果を書き込みます。エージェントの出力はアクションを支援するもので、担当者の判断に代わるものではありません。

#### 現在のエージェント一覧 {#current-agent-roster}

| エージェント | 対象の営業活動 | 機能 | 現在の状態 |
|-------|--------|--------------|---------------|
| Mona | インバウンド SDR | インバウンド MQL の情報補完、優先順位付け、要約を行い、補助ワークフローを調整 | すべてのインバウンド MQL で稼働中 |
| Doope | インバウンド SDR および BDR のデータ品質 | レコードへの対応やシーケンス登録の前に、Lead と Contact の重複の可能性を検出 | MQL ワークフローおよび毎日の BDR 重複排除ワークフローで稼働中 |
| EMA | インバウンド SDR | 対象となる購買意欲の低いトライアルリードに合わせた最初のメールを作成・送信し、承認済みシーケンスに登録 | 承認済みの低意欲トライアルのユースケースのみで稼働中 |
| Quali | SDR および BDR の見込み評価 | Qualifying ステータスのリードを監査し、フォローアップ、リサイクル、連絡途絶、完了した作業を特定 | 見込み評価中のリード全体で稼働中、継続的にイテレーションを実施 |
| Atlas | アウトバウンド BDR | アカウントをリサーチし、優先度をスコア化し、コンタクトを推奨して、訴求の切り口を提示 | BDR チーム全体で稼働中、利用とワークフローの拡大を継続 |
| Prose | アウトバウンド BDR | Atlas のリサーチから、Outreach で確認するための見込み客ごとのメールコンテンツを下書き | 展開・構築中、BDR による確認が引き続き必須 |
| Ghosty | SDR/BDR の見込み評価中のフォローアップ | Ghosted by Prospect に分類された見込み客への再アプローチを支援 | 開発・検証中、完全に自動化されているものとして扱わないでください |

この一覧と状態は、Relevance プログラムの報告資料と運用ノートで管理されています。ユースケースが試験運用から本番運用に移るにつれて、名前や自動化の範囲が変わる場合があります。

#### Mona: インバウンド MQL のトリアージ {#mona-inbound-mql-triage}

Mona は、インバウンドリードが MQL ステータスになり、SDR にアサインされると実行されます。繰り返し発生する事前作業の代わりに、リードレコードにアクションにつながる要約を提供します。Mona は次のことができます:

- Salesforce、キャンペーンとエンゲージメントの履歴、企業リサーチ、公開ウェブのリサーチ、利用可能な補完データを組み合わせます。
- 本人確認の信頼度、企業の適合性、ペルソナ、購買シグナル、電話番号の有無、過去の活動、ルーティングの状況を評価します。
- 見込み評価済みのウェブチャットの内容をリードのリサーチに取り込みます。
- Relevance Priority と営業活動のコンテキストを割り当てます。
- Relevance Summary、完全な Relevance Research、Relevance Next Action、Relevance Last Updated のタイムスタンプを Salesforce に書き込みます。
- 重複検出には Doope、対象となる初回アプローチの実行には EMA を使用します。

まず、Relevance Priority と Relevance Next Action が表示される SDR の Z-lead ビューまたは BDR の B-lead ビューを確認します。リードレコードを開いて Relevance Summary を確認し、見込み客に連絡する前に Relevance Research を使って、本人情報、企業の状況、購買意欲のシグナル、重複の検出結果、ルーティングの推奨内容を検証してください。

Mona はルーティングに関する懸念を特定したり、別の所有者を推奨したりする場合がありますが、通常のルーティングプロセスや担当者の判断に代わるものではありません。ルーティングの推奨に従って行動する前に、Salesforce の所有者、テリトリー、地域、アカウント階層、対応言語、商談の状況を確認してください。

#### Doope: 重複検出 {#doope-duplicate-detection}

Doope は、Mona のインバウンド MQL ワークフロー内と、より広範な BDR のデータ品質ワークフローで使用されます。メールアドレス、氏名、企業、アカウント情報などのシグナルを使って、一致する Salesforce の Lead と Contact レコードを確認します。検索対象から元のレコードを除外し、一致なし、一致する可能性のあるレコードが 1 件、または確認が必要な複数のレコードのいずれかを示す結果を返します。

Doope は重複の可能性をフラグ付けしますが、Salesforce のレコードを自動でマージすることはありません。フラグが付いたレコードをシーケンスに登録する、または対応する前に、次を行ってください:

- 一致するレコードが同一人物および現在の購買状況を表していることを確認します。
- 現在の所有者、アカウント、商談の状況、最近の活動を確認します。
- 一致するレコードが複数見つかった場合は、シーケンスへの登録を保留し、通常の Salesforce および RevOps のプロセスを通じて関係を整理します。
- 一致するレコードが 1 件あることを、重複の決定的な証拠として扱わないでください。

#### EMA: 購買意欲の低いトライアルのシーケンス登録 {#ema-low-intent-trial-sequencing}

EMA は、承認済みの低意欲トライアルのワークフローに対応する Mona のサブエージェントです。リード、トライアル、Mona のリサーチのコンテキストを使って、対象に合わせた最初のメールを作成し、アサインされた SDR に代わって初回アプローチのメールを送信し、対象リードを承認済みの Outreach シーケンスに登録します。その後のステップは、設定された Outreach ワークフローに従います。

現在の EMA の対象は、条件を満たす購買意欲の低い Trial リードで、主に、PTP スコアが 0–3 の非 PTP トライアル、または PTP スコアのない非 PTP トライアルです。スコアが 4–5 の PTP トライアル、Conference または Virtual Event リード、Contact Form リード、Qualified Web Chat リードは、現在の EMA ワークフローの対象ではありません。他の AI 支援シーケンスは Outreach AI や別のワークフローを使用している場合があり、EMA だと決めつけないでください。

EMA が管理するリードについては、次に従ってください:

- EMA がリードを登録した後に、最初のメールを重複して手動送信しないでください。
- シーケンスを監視し、通常の SDR ワークフローを通じて見込み客の返信に対応します。
- 返信を受け取ったときに、テリトリーと所有者を確認します。特に、自動シーケンス登録によって通常の登録前チェックが省略された場合は確認してください。
- 誤ったパーソナライズ、古いトライアル日付、宛先の間違い、シーケンス登録の失敗は、`#wg-relevance-ai-xdr-ext` または[エージェントフィードバックフォーム](https://gitlab.com/gitlab-com/eta/ent-ai/ext-vendors/relevance/workspace/-/issues/new?issuable_template=agent-feedback)で報告してください。

#### Quali: 見込み評価段階のフォローアップ {#quali-qualifying-stage-follow-through}

Quali は、Qualifying に移行したリードを監視します。見込み客とのやり取りが始まった後の状況把握の抜けを埋め、担当者の明確なアクションがないまま有効なリードが停滞することを防ぐのが目的です。Quali は、アサインされた担当者の現地時間に合わせて毎日監査を行い、Salesforce の活動と見込み客の返信を確認し、リードレコードにレビュー結果を書き込みます。また、Slack を通じて担当者への通知と、マネージャー／ディレクター向けの集計を送信します。

現在のレビュー結果には次があります:

- **Immediate Action:** 見込み客から返信があった、または時間的制約のある別のアクションが必要です。
- **Needs Recycle:** リードの関心が薄れているか、有効な見込み評価キューに属する状態ではなくなっています。
- **Ghosted by Prospect:** 以前やり取りのあった見込み客から 3–29 日間返信がありません。自動的なリサイクルではなく、ナーチャリングと継続対応の状態として扱ってください。
- **Done by SDR:** 担当者が返信に対応済み、またはミーティングが予約済みです。

返信がない状態が 30 日以上続くと、現在のリサイクルロジックでは Needs Recycle - No response に分類される場合があります。

担当者は Immediate Action を最優先として扱い、Quali が示す理由を確認し、Salesforce の活動とステータスを最新に保ってください。Needs Recycle の場合は、リサイクルする前に理由を確認します。Ghosted By Prospect の場合は、承認済みの継続対応を続けるか、適切なときに承認済みの再アプローチのワークフローを手動で開始します。重複して連絡しないでください。Done by SDR の場合は、活動やミーティングが完了していることを確認し、情報整理が必要でなければ追加のアクションは行いません。

Relevance Qualifying Review または Relevance Qualifying Notes は編集しないでください。これらのフィールドは Relevance が入力・更新します。返信、将来のタスクの作成、ステータス変更、リサイクルプロセスに従った処理など、リードレコード上でアクションを行い、次回の監査に実際の状態が反映されるようにしてください。

#### Atlas: アウトバウンドのアカウントリサーチ {#atlas-outbound-account-research}

Atlas は、BDR のアカウントプランニングとプロスペクティングを支援します。アカウントが積極的に対応するワークフローに入ったとき、またはアカウントレコードの Request Relevance Research チェックボックスを使用したときに実行されます。稼働中のトリガーは BDR Prospecting Status フィールドを監視し、現在の 90 日間の保護期間内に Atlas のリサーチが行われたアカウントの再実行を避けます。通常、リサーチ結果は約 10 分以内に反映されますが、未処理分を処理するロジックにより、処理時間がさらに長くなる場合があります。

Atlas は、アカウント階層、顧客と商談の履歴、エンゲージメント活動、6sense のインテント、企業とウェブのリサーチ、採用とテクノロジーのシグナル、補完データ、コンタクトの発見、関連する GitLab の顧客事例を組み合わせます。アカウントリサーチを Salesforce に書き戻し、次のものを作成します:

- すばやく優先順位を付けるための短い概要。
- アカウントを詳しく確認するための完全なリサーチ概要。
- 利用可能なシグナルに基づく優先度または購買傾向スコア。
- ペルソナと根拠を付けた推奨見込み客。
- 経済的な意思決定者、技術評価者、チャンピオンなど、異なるペルソナに合わせた訴求の切り口。

BDR は最初に短い概要を確認し、その後、完全な概要、アカウント階層、推奨コンタクト、スコア、購買意欲のシグナル、訴求の切り口を検証してください。リサーチが First Order、Community Edition、Customer Upgrade など、アカウントの営業活動に合っていることを確認します。Atlas はアカウント戦略とコンタクト選定の参考に使用してください。BDR の判断に代わるものではありません。

Atlas が推奨した見込み客であることだけで、シーケンスに登録すべきだと判断しないでください。所有者、既存の活動、アカウントの状況、コンタクトの質、その人物がまったく新しい対象なのか、すでに対応中なのかを確認してください。

#### Prose と今後のアウトバウンド自動化 {#prose-and-future-outbound-automation}

Prose は、Atlas が推奨した見込み客向けのメール作成機能として計画されています。現在の設計では、Atlas のリサーチから見込み客ごとの下書きを作成し、BDR が確認できるよう Outreach に配置します。Prose を完全に自律的な送信機能として説明しないでください。BDR は、送信前に下書きの確認、編集、削除、却下ができなければなりません。

#### Salesforce のフィールドと日常のワークフロー {#salesforce-fields-and-daily-workflow}

インバウンドリードの主要なフィールドは次のとおりです:

- **Relevance Priority:** トリアージに使う、表示された優先度またはリードの分類。
- **Relevance Summary:** 主要なシグナルと注意点の簡潔な表示。
- **Relevance Research:** 詳細なリサーチ、根拠、本人情報と企業の状況、重複の検出結果。
- **Relevance Next Action:** 担当者に推奨される最初のステップ。
- **Relevance Last Updated:** 出力が最新かどうかを判断するためのタイムスタンプ。
- **Relevance Qualifying Review と Relevance Qualifying Notes:** 見込み評価段階のフォローアップ用に Quali が管理するフィールド。担当者は編集しないでください。

アカウントの場合、Atlas は積極的に対応する状態、または Request Relevance Research チェックボックスを使用し、アカウントリサーチの出力と最終実行情報を Salesforce に書き戻します。Outreach 対応のワークフローでは、Relevance が生成したコンテンツは、Salesforce ではなく、承認済みの Outreach フィールドや下書きに書き込まれる場合があります。

実際のワークフローは次のとおりです:

1. 関連する Salesforce ビューまたは Slack 通知から始めます。
2. 短い優先度フィールドまたはレビューフィールドを使って、最初に対応すべきものを判断します。
3. レコードを開き、根拠となるリサーチ、活動、所有者、タイミングを検証します。
4. Salesforce または Outreach で、人が行うべき適切なアクションを実行します。
5. 自動送信と重複する送信や、エージェントが管理するレビューフィールドの編集は行わないでください。
6. 繰り返し発生する問題や重大な問題は、調査に十分なコンテキストを添えて、`#wg-relevance-ai-xdr-ext` または[エージェントフィードバックフォーム](https://gitlab.com/gitlab-com/eta/ent-ai/ext-vendors/relevance/workspace/-/issues/new?issuable_template=agent-feedback)で報告します。

#### フィードバックとガバナンス {#feedback-and-governance}

不正確なリサーチ、誤ったルーティング、重複のフラグ、フォローアップの漏れ、Quali の誤分類、古いパーソナライズ情報、シーケンスの失敗、わかりにくい出力など、エージェントに関するすべてのフィードバックは、`#wg-relevance-ai-xdr-ext` または[エージェントフィードバックフォーム](https://gitlab.com/gitlab-com/eta/ent-ai/ext-vendors/relevance/workspace/-/issues/new?issuable_template=agent-feedback)で報告してください。次を含めます:

- Salesforce の Lead、Contact、または Account のリンク。
- 関係するエージェントとフィールド。
- 生成された出力。
- 期待される動作。
- 関連する活動、所有者、タイミング、言語、テリトリーのコンテキスト。

議論には `#wg-relevance-ai-xdr-ext` を使用し、問題の追跡が必要な場合は[エージェントフィードバックフォーム](https://gitlab.com/gitlab-com/eta/ent-ai/ext-vendors/relevance/workspace/-/issues/new?issuable_template=agent-feedback)を使用してください。
...
→ Accepted の場合 → ZoomInfo ワークフローが自動的にトリガーされ、関連する意思決定者を B6 リードビューに追加します。

6QA アカウントが First Order でない場合、BDR Prospecting Status はまず `SDR Hold` に 14 日間設定されます。14 日以内に opportunity が作成されない場合、BDR の所有権で `Actively Working / Showing Intent` に自動遷移します。
...
| ツール | 目的 |
| ---- | ------- |
| [Qualified](https://www.qualified.com/) | ウェブサイトチャット — 主にインバウンド SDR 向け。BDR は AWA アカウントからの既知のリードとチャットを開始できます。 |
| [Gong](https://internal.gitlab.com/handbook/sales/sales-tools/gong/) | 通話録音と会話インテリジェンス。Sales Dev のメンバーはコラボレーターライセンスを持っています。招待を作成する際に `Gong Meeting` オプションを使用し、レコーダーアクセスを持つ AE を追加します — Gong は AE のライセンスを介して録音します。 |
| [Crayon](https://app.crayon.co/intel/gitlab/battlecards/) | Product Marketing チームが管理する競合インテリジェンスとバトルカード。 |
...
SAO レポート: [SDRs](https://gitlab.my.salesforce.com/00O8X000008QeFh?sdtd=1) · [BDRs](https://gitlab.my.salesforce.com/00O8X000008QdwB)
...
_**昇進検討の場合、Hybrid/Growth PubSec BDR の Stage 1 Net ARR 達成率は 200% でキャップされ、チームメンバーが他のクォータ構成要素でも期待を満たしていることを確実にします。_
...
→ 月 1: 80% 達成 + [Our Three Pillars](/handbook/sales/sales-development/#our-three-pillars) の遵守

→ 月 2: 90% 達成 + [Our Three Pillars](/handbook/sales/sales-development/#our-three-pillars) の遵守

→ 月 3 以降: 100% 達成 + [Our Three Pillars](/handbook/sales/sales-development/#our-three-pillars) の遵守
...
| 柱 | 主な期待 |
| ------ | ---------------- |
| **1. 日次アクティビティメトリクスの維持** | 2 時間 MQL SLA と毎日の 6QA Acceptance を遵守 · 1 日 50 件以上のデジタルタッチポイント（個別化された LinkedIn/メール）· Golden Call 時間中に 100 通話（または 50 通話以上かつ 7 件のポジティブな接続）· 週 3 件以上の発見ミーティング · 期日と同日にシーケンスステップを実行 · アウトバウンドワークフロー全体で SFDC データの整合性を維持 · AE と各 IQM に出席 · SFDC で正確で最新のノートを文書化 |
...
**16 日以降に参加:**
月 0 = 0% · 月 1 = 25% · 月 2 = 50% · 月 3 = 75% · 月 4 = 100%
...
**Q:** 私の Salesforce バージョンが非常に基本的です。
**A:** Sales バージョンを使用していることを確認してください。右上隅 → 青いドロップダウンボタン → "Sales" を選択。

**Q:** 私はすべてのツールへのアクセスを受け取っておらず、1 週間経っています。
**A:** マネージャーに通知し、Onboarding Role Entitlements Issue にコメントしてもらいます。

**Q:** SFDC ZoomInfo Lead View に表示されているよりも多くのリードを ZoomInfo からアップロードしました。
**A:** これらのリードはおそらくすでに SFDC にコンタクトとして存在します。Leads ビューではなく、ZoomInfo Contacts ビューに表示されます。

**Q:** この人が MQL としてスコアされた理由がわかりません。
**A:** SFDC レコードの **Last Interesting Moment** を確認し、次にリードページの Marketo Sales Insight ウィジェットの Scoring タブを確認します。行動スコアなしでデモグラフィックポイントのみが割り当てられている場合は、Marketing Ops に Slack で連絡し、新しいアクションが取られていないことを認識させます。

**Q:** 見込み客から個人データ主体のリクエストを受け取りました。
**A:** [Personal Data Subject Request フォーム](https://support.gitlab.io/personal-data-request/) にリダイレクトします。

**Q:** なぜ BDR は SFDC で Account Owner ではなくなったのですか？
**A:** すべての見込み客とアカウント（PubSec を除く）にわたって Sales Dev と Sales の可視性を向上させるためです。**BDR Assigned** フィールドを使用してアカウントをフィルタリングします。

**Q:** 見込み客は私たちのウェブサイトから購入するつもりだと言いました。彼らがそうしたかどうかをどうやってわかりますか？
...
**Q:** アカウントが Actively Working でなくなった後に見込み客が BDR に直接戻ってきた場合はどうしますか？
**A:** 彼らがメールを送る、LinkedIn で返信する、または BDR に直接電話する場合、BDR はリードがキュー所有権にあることを確認し、アカウントを Actively Working に戻してリードを彼らの所有権に移せるようにする必要があります。
...
**A:** リードレコードの **Impartner Partner Account** フィールドを確認します。入力されている場合、リードは Partner Queue に割り当てられています — アウトリーチを進めないでください。
...
Manager Attention Needed ボードを、チームが BDR プロセスにどうアライメントしているか、どこで助けが必要かを理解するための主要ツールとして使用してください。[このドキュメント](https://docs.google.com/document/d/18k1_jDHVgNzy2SzcPZ7GAOdJ6zb9i37Z4-V1-dEFKiU/edit#)は、最初の月の主要な参照リソースです。新しいチームメンバーをオンボーディングする際は、新人オンボーディングドキュメント([こちら](https://docs.google.com/document/d/1ymdIfeGhFzFLJkz0_1qZhzVlLMaTpNaiTowfdbVJEao/edit?tab=t.0))と新人向けの[オンボーディングチェックリスト](https://docs.google.com/spreadsheets/d/14YdcHbQizanNRf-emYOdow6UP_Z246pIHo_KIWrrzyU/edit?gid=1023692240#gid=1023692240)を参照して、次のステップを構造化できます。
...
### 1:1 アカウントとリードレベルのダッシュボードコーチングガイダンス {#11-account-and-lead-level-dashboard-coaching-guidance}

以下の表は、SFDC と Tableau の 1:1 ダッシュボードをどう知覚し実行するかを構造化するのに役立ちます。これらは[アウトバウンド SLA](/handbook/sales/sales-development/#outbound-slas-and-kpis) と[こちらの動画](https://drive.google.com/file/d/1mOUGPVqhogmT0-mmqyhtiVKs4wmdHEZ_/view?usp=sharing)、[こちらの動画](https://drive.google.com/file/d/1L3a6-vpG562rY0u4Yve4d_y1148MIvNG/view?usp=sharing)に接続します。この[5 分の動画](https://drive.google.com/file/d/1dx57o5nu9xeHsvHUOC2XYryjxYmfdHvv/view?usp=sharing)はこれらのダッシュボードの目的を説明し、この[3 分の動画](https://drive.google.com/file/d/1Sf6vFSXb8iNaSGLGv-TtasuPS3xfz-Ni/view?usp=drive_link)は実用的なユースケースを順を追って説明します。
...
| Prospect 360 | Prospect 360 Dashboard | SFDC、6Sense、Qualified、Marketo のデータを 1 つのビューに統合した[ダッシュボード](https://internal.gitlab.com/handbook/enterprise-data/data-governance/data-catalog/customer-intelligence/#prospect-360)。[イネーブルメント動画はこちら。](https://www.youtube.com/watch?v=iYnSiISeXYQ) | アカウントアクティビティ、エンゲージメント履歴、リードインタラクションの全体的なビュー — アカウントレベルのプロスペクティングの素晴らしい開始点。 |

### Pipeline Dashboard コーチングガイダンス {#pipeline-dashboard-coaching-guidance}
...
| リソース | 目的 |
| -------- | ------- |
| [Leadership Handbook](/handbook/leadership/) | GitLab のピープルマネージャーのためのツールとリソース |
| [Compensation Review Cycle](/handbook/total-rewards/compensation/compensation-review-cycle/) | Compa Review の実施方法 |
| [Sales Dev Manager Onboarding Checklist](https://docs.google.com/spreadsheets/d/1cnKc757SWenlJRoa_zqPhFyekp4mq56oSMFXPSDW-CU/edit#gid=0) | コピーを作成して完了し、ツールとプロセスの知識を確認 |
| [360 Feedback](/handbook/people-group/360-feedback/) | クロスファンクショナルフィードバックサイクルのスケジュールとガイダンス |
...
| リソース | 目的 |
| -------- | ------- |
| [チームページに自分または他の人を追加する](/handbook/about/editing-handbook/#add-yourself-to-the-team-page) | チームページのプレースホルダーを更新する新人向け動画。 |
| Salesforce でマネージャーまたは SDR の役割を更新 | [個別アクセスリクエスト](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request)または[一括アクセスリクエスト](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Bulk_Access_Request)を提出。 |
| Slack ユーザーグループメンバーを作成または更新 | [個別](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) または[一括アクセスリクエスト](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Bulk_Access_Request) を提出。'Account Creation' の下に `Slack User Group: @[GroupName]` を入れます。 |
| Sales Development Gmail エイリアスに誰かを追加 | [個別](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Individual_Bulk_Access_Request) または[一括アクセスリクエスト](https://gitlab.com/gitlab-com/team-member-epics/access-requests/-/issues/new?issuable_template=Bulk_Access_Request) を提出。 |
| [ハンドブックを編集する](/handbook/about/editing-handbook/) | ハンドブック編集ガイド。すべての新人はオンボーディングの一部としてこれを完了する必要があります。 |
| [ハンドブックに新しいページを追加する](https://www.youtube.com/watch?v=9NcJG9Bv6sQ) | 新しいハンドブックページを作成するための動画ウォークスルー。 |
| [MR 作成時の失敗したパイプラインを解決](https://www.youtube.com/watch?v=WlgH-6cX1k8&feature=youtu.be) | 失敗した MR パイプラインを特定して修正する方法。 |
| [Sales Development Onboarding Job Specific Task Section](https://gitlab.com/gitlab-com/people-group/employment-templates/-/blob/main/.gitlab/issue_templates/onboarding_tasks/department_sales_development.md) | 役割に基づいて新しい SDR オンボーディング Issue に自動追加。 |

### Sales Development オンボーディング {#sales-development-onboarding}
...
3. 2 週目: Sales Enablement Team が SQS のカレンダー招待と、Google Classroom の[Sales Quick Start learning path](/handbook/sales/onboarding/sales-learning-path/)へのアクセスを送信。
4. SQS 参加後 1 週間以内: 13 週間の CoM Fast Start プログラムへのアクセス。
5. 最初の数週間: Sales Development Technical Development トレーニングへのアクセス。最初の 180 日以内に完了する必要があります — SDR の[進行](/handbook/sales/sales-development/#graduating-from-sales-development-onboarding) に直接結びついています。

#### Sales Development オンボーディングの卒業 {#graduating-from-sales-development-onboarding}
...
- 新人の初日の開始にウェルカムコールをスケジュール: オンボーディングの優先事項、カレンダー招待の洪水を管理する方法、ツールアクティブ化メール、[SDR オンボーディング](/handbook/sales/sales-development/#sales-development-onboarding)から期待されることをカバー。
