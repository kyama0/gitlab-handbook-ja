...
キャリア開発とは、学習、仕事、余暇、変化を統合する非線形で生涯にわたる成長プロセスです。それは、専門知識の深化、新しいチームへの横方向の成長、ジョブファミリーを通じた直線的な成長など、あらゆる方向で起こります。
...
下のチャートは、RSOE チーム内の役割と、各役割の責任と要件を概説する関連ジョブファミリーへのリンクを示しています:
...
GitLab の RSOE チーム内のこれらのジョブファミリーは、横方向の移動と上方向の成長の両方をサポートする多様なキャリア開発の機会を従業員に提供し、個々のスキルと志望に合わせたカスタマイズされたキャリアパスを可能にします。

**覚えておいてください！** RSOE チーム内の機会に加えて、GitLab は Go-to-Market (GTM) チーム、Product、Data、Support、Systems などの他の部門にもさまざまな役割を提供しています！これらの領域は、プロダクトマネジメント、データ分析、カスタマーサポート、システム管理など、ビジネスのさまざまな側面を探求する機会を従業員に提供します。これらの道を探求することで、従業員は経験を広げ、スキルセットを多様化し、GitLab 内でのキャリア志望に最適なフィットを見つけることができます。

会話を始める準備はできましたか？[Career Conversation Meeting テンプレート](https://docs.google.com/document/d/1Fqxoxl0LgCrjUD3_FR6FiufPqBM3R-dbbVs39JAOUrc/edit?tab=t.0)を使用して、あなたとマネージャーが連携できるようにしてください。

リーダーシップチームは、あなたを応援し、次の大きな移動に向けて導くためにここにいます！彼らは役立つフィードバックを提供し、成長の機会を見つけ、リソースへと案内してくれます。しかし、本当の魔法は？それはあなた次第です！自分のキャリアパスを所有することは、イニシアチブを取り、目標を設定し、新しいスキルを探求することを意味します。マネージャーはあなたをサポートするためにここにいますが、成功への道を照らすのはあなたの熱意と意欲です。だから、大きな夢を見て、行動を起こし、実現させましょう！

## RSOE マネージャー向けのキャリア開発リソース

マネージャーとして、あなたはチームメンバーがキャリアで[成長し、進歩する](/handbook/people-group/learning-and-development/career-development/#manager-responsibilities)のを助ける重要な役割を果たします。彼らが自分の強みと改善すべき領域を特定するために必要な[ガイダンス、サポート、リソースを提供](/handbook/people-group/learning-and-development/career-development/#recomendations-for-managers-to-support-the-learning-of-team-members)し、チーム内外での役割を進めるために必要なスキルと経験を開発できるようにすることが、あなたの責任です。あなたはまた、メンターシップ、ネットワーキングの機会を提供し、彼らのキャリア志望を組織の目標と整合させるアドボケートとしての役割も果たします。最終的に、彼らの開発へのあなたのコミットメントは、彼らの成功、チーム全体のパフォーマンス、そして GitLab にとって鍵となります！[RSOE Career Development Best Practices Guide](https://docs.google.com/document/d/13gvILCumR6-kPeOo3WZNn5114vlZ2DAYDQBjoTGNfX0/edit?tab=t.0)を見て始めましょう！
