...
* 獲得 - Valuable signup
  * 内部チームメンバーはこの指標を[こちら](https://internal.gitlab.com/handbook/marketing/growth/growth/#valuable-signup-metric)で確認できます
* アクティベーション - Team activation
  * 内部チームメンバーはこの指標を[こちら](https://internal.gitlab.com/handbook/marketing/growth/growth/#team-activation-metric)で確認できます
...
1. Slack でアプリ *Time Off by Deel* を開く
1. *Home* タブにいることを確認し、ドロップダウンメニューから *Calendar Sync* を選択
1. *Additional calendars to include?* セクションの下で *Add calendar* をクリック
1. このカレンダー ID をコピー & ペースト: `c_5e5a9e4df8718fb25c518f165ca78fbccd42a7b6e1437a3caa6650e8e8dffbea@group.calendar.google.com`
