...
- Outreach Chrome 拡張機能をダウンロードしてインストールします。
- カレンダーとメールを接続します。
- LinkedIn Sales Navigator アカウントを接続します（該当する場合）。
...
- すべてのメールステップでメール追跡が有効になっていることを確認します
- Interval Type = Schedule Days
- シーケンスにすべてのタグが付いており、コレクションの一部であることを確認します
