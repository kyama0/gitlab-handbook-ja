...
upstream_path: /handbook/marketing/brand-and-product-marketing/product-and-solution-marketing/release-updates/
...
将来のリリース（重要な機能にフラグが立てられたもの）は、[Product の今後のリリースページ](/upcoming-releases/)に掲載されています。[有料プロダクトティアの今後の機能（ティア別リスト）](https://about.gitlab.com/direction/paid_tiers/)もご覧いただけます。
...
[SKO Product Keynote video](https://gitlab.edcast.com/insights/keynote-product) と 2021-02 に発表された [the deck presented](https://docs.google.com/presentation/d/1NunKRuZBnDcZi0k_N5-NQBvdy5X5ZaV4a1Qf7w126qs/edit?usp=sharing) は GitLab 内部限定です。
