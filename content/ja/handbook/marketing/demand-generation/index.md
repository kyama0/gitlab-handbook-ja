...
- **補助・活動指標:** SAO、アトリビューションされたパイプライン、送信メール数
...
レポーティング・ダッシュボード分析の詳細、および目標に対して結果を最適化・推進するための機会の深掘りについては、[デマンドジェネレーション・レポーティング ハンドブックページ](/handbook/marketing/demand-generation/reporting/)をご覧ください。
