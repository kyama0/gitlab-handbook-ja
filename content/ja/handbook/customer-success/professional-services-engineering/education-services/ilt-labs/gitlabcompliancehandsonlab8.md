...
1. ユーザー権限を表示するには、**Manage > Members** に移動します。

1. このセクションのさまざまなユーザーとロールを確認します。あなたのユーザーがプロジェクトのオーナーであり、すべてのレポートの全詳細を表示できることを確認します。
...
1. 最近成功したパイプラインを選択します。

1. `dependency-scanning` ジョブを選択します。

1. 右サイドバーで **Job artifacts** の下にある **Browse** を選択します。

1. ここに表示されるレポートを確認します。これらのレポートをダウンロードして詳細を表示できます。
