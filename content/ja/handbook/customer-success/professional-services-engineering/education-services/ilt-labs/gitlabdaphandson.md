...
| DAP でコードを作成してセキュリティを確保する | [ラボリンク](/handbook/customer-success/professional-services-engineering/education-services/ilt-labs/gitlabdaphandsonlab5) |

## クイックリンク

このハンズオンガイドを確認する際に役立つクイックリンクを以下に示します。

* [GitLab Duo Agent Platform コースページ](https://university.gitlab.com/pages/dap-training)
