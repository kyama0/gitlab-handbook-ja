...
これらが発生した場合、MR の作成者は、必要なすべての承認を得ており、リポジトリへのマージ権限を持っていれば、自分の MR をマージしても構いません。これは GitLab の [bias for action](../../../../values/_index.md#operate-with-a-bias-for-action) のバリューにも沿うものです。
