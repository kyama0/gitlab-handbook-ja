...
**クイックリンク:** | [Iteration 0 の基本](../iteration-0-fundamentals/index.md) | [Delivery Kits](https://gitlab.com/gitlab-org/professional-services-automation/delivery-kits)
...
3. **前提データの収集**
   ...
   - [Iteration 0 の基本](../iteration-0-fundamentals/index.md) をレビュー
   - [discovery のベストプラクティス](../discovery/index.md) を考慮
...
- [ ] [Iteration Cadences](../iteration-scheduling/index.md) の確認
