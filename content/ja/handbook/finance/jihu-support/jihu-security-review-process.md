...
1. [コードベースの関連部分](/handbook/product/categories/#devops-stages)のスタブルカウンターパートにピングし、レビューを依頼する
    - 変更が小さいまたは簡単にレビューできる場合、トリアージ担当の AppSec エンジニアが自らレビューを行い、可視性のためにスタブルカウンターパートを `@-メンション` することもできる
1. スタブルカウンターパートが不在または未割り当ての場合、トリアージローテーション担当の AppSec エンジニアがレビューを実施できる
