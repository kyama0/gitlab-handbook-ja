...
- [インクルーシブ出張・オフサイト計画ガイド](https://docs.google.com/document/d/19gEA7sYmDZt7I6hIy2VTPvqrCC4IVJH2xvPJfraebEM/edit?usp=sharing) - すべての参加者の安全、インクルージョン、帰属意識を確保するための詳細な考慮事項
- [PSS - イベントセキュリティアドバイザリープレゼンテーション](https://docs.google.com/presentation/d/1kuTqZ5YjF1fFMYvRArDQC-ub-SFjeE8SF1lOJm9KzGk/edit?usp=sharing) - イベントセキュリティのビジュアルガイド
...
海外に出張するGitLabチームメンバーのための情報セキュリティの考慮事項については、[Internal Handbook](https://internal.gitlab.com/handbook/security/corporate/travel)を参照してください。
...
- *メール:* philadelphia@internationalsos.com
- *モバイルアプリ:* [ISOSアシスタンスアプリ](https://www.internationalsos.com/subscriber/assistance-app)をダウンロード
...
1. [ISOSアシスタンスアプリ](https://www.internationalsos.com/subscriber/assistance-app)をダウンロード
1. GitLabのメールアドレスで登録（GitLabの認証情報ではなく、固有のパスワードを使用）
1. 「ヘルプが必要」ボタンを押して最寄りの緊急センターに接続

> 注意: これはGitLabのアプリケーションではなく、ISOSが管理しています。

- [ISOSモバイルアプリユーザーガイド](https://drive.google.com/file/d/1CYryCnznGjIaRh3WcdzG-wiuYVxRahUZ/view?usp=sharing)
- [ISOSモバイルアプリダウンロード情報](https://drive.google.com/file/d/1C2k9b8TRth3O4QzZH2YqayZOhpTd4fJl/view?usp=sharing)

*オンラインポータルとメンバーシップカード*

- デジタルメンバーシップカードは[こちら](https://myportal.internationalsos.com/WebPortal/MyOrganisation)からアクセス
- 緊急連絡先情報が記載されたカードを印刷または写真を保存しておいてください

*直接連絡*

- 電話: [+1 215 942 8226](tel:+12159428226)
- メール: [philadelphia@internationalsos.com](mailto:philadelphia@internationalsos.com)

#### 出張傷害保険のカバレッジ

GitLabのBusiness Travel Accident Policyは、国内外の出張中のチームメンバーに包括的な保護を提供しています。[ポリシードキュメントを見る](https://drive.google.com/file/d/1pMeC-mTfzuRhlwjQA2lvzonn6X0ax15N/view?usp=sharing)。
...
制限と除外については[ポリシーの詳細](https://drive.google.com/file/d/1pMeC-mTfzuRhlwjQA2lvzonn6X0ax15N/view?usp=sharing)を参照してください

##### ポリシーの使用方法

*出張中に医療支援が必要な場合*

1. アプリ、電話、またはメールを使用してすぐにInternational SOSに連絡する
1. ISOSが適切な医療ケアを手配します
1. ISOSが医療機関に直接支払いを行います
1. ISOSがあなたの代わりにAIGに保険請求を提出します
...
- VPN - 信頼できないネットワークから接続する場合は、[MITM攻撃](https://en.wikipedia.org/wiki/Man-in-the-middle_attack)などを避けるためVPN接続を使用してください。
- 公共の場でのデバイス - 公共の場でデバイスを使用する場合、画面の制限データが他者に見られる可能性があります。プライバシーを確保する特殊なフィルムで画面を保護してください。[サンプルはこちら](https://www.amazon.com/s?k=privacy+screen+filter)。
- 混雑した場所での会話 - 制限されたデータについて話す場合は、安全な場所にいることと、誰にも聞かれないことを確認してください。
- 1Passwordのトラベルモード - リスクの高い国への出張や、デバイスを安全でない場所に置かなければならない場合は、デバイスが侵害された場合にボルトが安全であることを確保するために1Passwordの[トラベルモード](https://support.1password.com/travel-mode/)を使用してください。
