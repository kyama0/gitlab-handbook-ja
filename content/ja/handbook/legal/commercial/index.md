---
title: "コマーシャル法務"
description: "コマーシャル法務ハンドブック情報のランディングページ"
upstream_path: "/handbook/legal/commercial/"
...
GitLab リーガルコマーシャルチームは、GitLab におけるすべての契約事項を担当しています。これには、調達、収益、チャネル、テクニカル、アライアンスが含まれます。コマーシャルチームは、販売、テクニカル、およびビジネスのステークホルダーと協力し、GitLab の契約基準に沿った、最も効率的なタイムラインで契約締結を実現します。

## GitLab リーガルコマーシャルとの連携方法
...
## GitLab リーガルコマーシャルのプロセスとリソース

### 契約スタイルガイド

- テンプレートの作成および/または更新を行う際は、[GitLab リーガル契約スタイルガイド](https://docs.google.com/document/d/1Gl3QYLL-A4SiAIfPZ8SI6bKnE1UpUek4MHDSOt1YIrM/edit#)を使用してください。*注意: このリソースは GitLab リーガルチームメンバーのみと共有されています。*
