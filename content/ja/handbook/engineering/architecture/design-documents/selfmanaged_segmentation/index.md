...
[Omnibus-Adjacent Kubernetes (OAK)](../omnibus_adjacent_kubernetes/_index.md) は、GitLab インスタンスによる排他的な使用を意図した _単一テナント、単一アプリケーション_ の Kubernetes クラスターです。
...
OAK の最終的な設計は[独自のデザインドキュメント](../omnibus_adjacent_kubernetes/_index.md)で詳しく説明されます。
