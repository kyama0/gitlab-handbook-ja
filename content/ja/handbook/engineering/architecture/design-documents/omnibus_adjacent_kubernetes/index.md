...
OAK は [セグメンテーション提案](../selfmanaged_segmentation/index.md) のための足がかりとして機能し、Early Self-Managed のお客様が Omnibus の運用上のシンプルさを維持しながら、クラウドネイティブコンポーネントを必要とする高度な機能を採用できるようにします。
...
- [GitLab セグメンテーション提案](../selfmanaged_segmentation/index.md)
