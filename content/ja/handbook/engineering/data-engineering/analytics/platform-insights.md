...
* マイルストーン開始日: マイルストールの目標と関連するエピックおよび Issue が確定・優先順位付けされるべきです。計画された全作業は[マイルストーンボード](https://gitlab.com/groups/gitlab-org/-/boards/7850744)で確認できます。前のマイルストーンの Issue は新しいマイルストーンまたはバックログに移動されます。
