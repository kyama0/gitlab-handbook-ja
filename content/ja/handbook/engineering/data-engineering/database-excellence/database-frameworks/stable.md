...
データベースに関するサポートが必要な場合は、以下の表でお客様のエリアを担当するステーブルカウンターパートをご確認ください。担当者が記載されていない場合は、[#g_database](https://gitlab.slack.com/archives/CNZ8E900G) Slack チャンネルまで直接お問い合わせください。
