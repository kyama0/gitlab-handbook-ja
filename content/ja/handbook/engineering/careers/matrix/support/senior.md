---
title: "Support キャリアフレームワーク: Senior Support Engineer"
upstream_path: "/handbook/engineering/careers/matrix/support/senior/"
...
**GitLab における Senior Support Engineer は、以下のコンピテンシーを発揮することが期待されます:**
...
- 困難な問題について他のメンバーを支援する。
- 他のチームと連携して問題を解決する。
- デバッグ技術と GitLab の内部構造についてチームメンバーをメンタリングする。
...
- 複雑な問題をデバッグして解決できる、かつその意欲がある。
- 新たに浮上している問題に気づき、エスカレーションする。
- 複雑さのためにブリーチが生じる可能性のある Issue に積極的に関与する。
- ドキュメントの改善に貢献する。
- 顧客に影響するバグを修正する。
