...
このマイルストーム中に ci_pipelines の作業を開始できるかもしれません。パーティション化の取り組みを開始する前に、テーブルの主キーを交換する必要があります。元々は ci_builds の外部キーのバックフィルが完了するまで PK の交換を待つ予定でした。データベースチームに相談した後、完了前に交換を進める計画です。
