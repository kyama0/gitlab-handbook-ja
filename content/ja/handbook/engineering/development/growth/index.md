...
| ロール | 人 |
|------|--------|
| プロダクトディレクター | [原文 (英語)](https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members) を参照 |
| エンジニアリングディレクター | [原文 (英語)](https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members) を参照 |
| エンジニアリングマネージャー | [原文 (英語)](https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members) を参照 |
| UX デザインマネージャー | [原文 (英語)](https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members) を参照 |

### プロダクトとデザイン

| ロール | 人 |
|------|--------|
| プロダクトマネージャー | [原文 (英語)](https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members) を参照 |
| プロダクトデザイナー | [原文 (英語)](https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members) を参照 |
...
<p class="my-3 text-sm text-gray-600 italic">チームメンバー情報は <a href="https://handbook.gitlab.com/handbook/engineering/development/growth/#all-team-members" rel="external noopener">原文 (英語)</a> を参照してください。</p>
