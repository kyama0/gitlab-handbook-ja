...
Provision チームは CustomersDot トライアル作業に関して Growth チームとコラボレーションしています。Growth チームはトライアル固有の機能（資格、期間、UX、追跡）に焦点を当て、Provision チームはコアプロビジョニング、課金、サブスクリプションインフラストラクチャの所有権を維持します。詳細なコラボレーションガイドラインについては、[Growth チームの CustomersDot トライアルコラボレーションフレームワーク](/handbook/engineering/development/growth/customersdot-collaboration/) を参照してください。Growth エンジニアがトライアル作業のために CustomersDot に貢献する必要がある場合は、そこに記載されている意思決定フレームワークに従う必要があります。質問やコラボレーションリクエストについては、[#s_fulfillment](https://gitlab.slack.com/channels/s_fulfillment) または [#s_growth](https://gitlab.slack.com/channels/s_growth) Slack チャンネルに連絡してください。
...
- [Growth チーム CustomersDot コラボレーションフレームワーク](/handbook/engineering/development/growth/customersdot-collaboration/) - トライアル作業に関する Growth-Provision コラボレーションの意思決定フレームワーク
